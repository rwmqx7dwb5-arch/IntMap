#!/usr/bin/env node
/* ============================================================================
 *  build-hist-kuni.mjs — data/hist-kuni.js  (#R669)
 * ----------------------------------------------------------------------------
 ...
 *  52 of the classical 68 provinces (53 until #R730 removed 近江国 for having no stated
...
/* ══ ⚠ (#R669) THE COORDINATE IS ONE POINT, AND ONE POINT DOES NOT NAME EVERY REGION ═══════════
...
/* ══ ⚠⚠⚠ (#R730) THE SPAN OF THESE FIFTEEN IS THE SPAN OF THEIR FIFTY-THREE NEIGHBOURS ══════════
...
/* ══ (#R730) `--dates` — RE-READ THE SYSTEM'S SPAN, AND TOUCH NOTHING ELSE ══════════════════════
