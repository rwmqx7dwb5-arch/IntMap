#!/usr/bin/env node
/* ============================================================================
 *  build-hist-kuni.mjs — data/hist-kuni.js  (#R667)
 * ----------------------------------------------------------------------------
...
/* the ring/polygon assembler is js/ohm-rings.js — one owner, evaluated, never copied (#R667) */
const OHMR = (function () {
...
/* ══ ⚠ (#R667) THE COORDINATE IS ONE POINT, AND ONE POINT DOES NOT NAME EVERY REGION ═══════════
