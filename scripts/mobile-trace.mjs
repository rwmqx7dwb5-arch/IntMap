 ...
 *  app's own touch handlers or MapLibre's — so the two hottest paths #R498 found (a
...
/* (#R498) a finger drag of about the same size as PAN, at about 60 Hz, and a two-finger spread */
const TPAN = { dx: 150, dy: 110, steps: 36, ms: 16 };
const TPINCH = { from: 60, to: 220, steps: 36, ms: 16 };
/* (#R498) …and the gesture the alerts report is actually about: a SMALL pan, at city zoom */
...
async function traceOnce(engine, rep) {
  ...
  /* ⚠ (#R498) 12,063 ms busy / 34.2 fps FOR THE ALERTS PHASE IS A NUMBER ABOUT A WHOLE-WORLD PAN.
...
/* ⚠ (#R498) THE TWO NUMBERS A CAMERA COMMAND CANNOT PRODUCE GET THEIR OWN TABLE, because they are
