/* ============================================================================
 *  IntMap · the world's nuclear facilities, discovered — data/npp.json   (#R578)
 * ----------------------------------------------------------------------------
 ...
 *  exists, and the count cross-check lives in tests/r578-npp-checks.test.mjs.
 * ==========================================================================*/
...
/* ── 2b. the language each facility's own country is governed in ────────────
   ...
   tests/r578-npp-checks.test.mjs can check a label code against the country it
...
/* ── 5. one site, one record ──────────────────────────────────────────────────
   ...
   is the same window tests/r578-npp-checks.test.mjs measures.
...
/* The census the naming block and tests/r578-npp-checks.test.mjs ⑦ are read
...
/* The census tests/r578-npp-checks.test.mjs ⑩ is read against: of the sites
