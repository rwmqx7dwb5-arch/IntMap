#!/usr/bin/env node
// ============================================================================
//  IntMap · scripts/probe-radiation-sources.mjs — what the radiation upstreams actually return (#R578)
// ----------------------------------------------------------------------------
...
//  tests/r578-radiation-sources.test.mjs runs the same parsers against captured fixtures instead.
//
