#!/usr/bin/env node
/* ============================================================================
 *  IntMap · build-who-don — WHO Disease Outbreak News, as a bundled event corpus  (#R566)
 * ----------------------------------------------------------------------------
...
/* ══ ⚠⚠⚠ THE EVENT NAME, AND WHY IT IS NOT SIMPLY `EmergencyEvent.Title` ═══════════════════════════
   ...
   tests/r566.spec.js ③ is what found it. That is #R534's shape exactly (a field's PRESENCE read as
...
function summarise(c) {
  ...
  /* ⚠ THE CHECK THAT #R566's OWN FIRST VERSION FAILED: a name that is a bare year is not a name. */
