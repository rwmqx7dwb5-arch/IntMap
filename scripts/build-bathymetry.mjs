...
export const GOVERNANCE = (() => {
  /* ⚠ THE LICENCE IS NOT STATED HERE, AND IS THEREFORE NOT STATED. The terrarium dataset's own
     terms are on the AWS Open Data registry page, which this builder never reads; writing one in
     from memory is the thing [[intmap-data-must-not-claim-an-author-it-lacks]] names. */
  const rec = {
