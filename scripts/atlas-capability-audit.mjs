...
/* ⚠ (#R802) THE CAPABILITIES WHOSE CATALOGUE ENTRY STILL SAYS NOTHING ABOUT THEM — check ㉓'s floor.
   OBSERVATION: measured 2026-09-18 by ㉓ itself against js/atlas-catalog-text.js, after #R802 filled
...
export function auditWith({ caps, docs, atlas, controls, capSrc, execSrc, stateSrc, resultsSrc, toolsSrc, schemas }) {
  ...
  /* ㉓ (#R802) A CAPABILITY IS FINDABLE BY THE WORDS OF ITS OWN SUBJECT, IN ENGLISH AND IN JAPANESE.
        ...
        ⚠ THE LEDGER BELOW IS A FLOOR, NOT AN ALLOWANCE. Observation: on 2026-09-18, with #R802's
