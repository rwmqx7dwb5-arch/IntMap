...
const BENIGN = new Set([
  /* (#R384) 'World' — 地球のウィジェット（世界）と、ニュースの節（国際）。fr『Monde』/ zh『世界』/ ko『세계』は**どちらの意味でも読める**ので、1 行で務まる。 ⚠ 同じ組の 'Business' / 'Latest' / 'Updated' / 'events' はここに入れていない——あれは一行では務まらないので、英語のほうを変えた。 */
  'World',
