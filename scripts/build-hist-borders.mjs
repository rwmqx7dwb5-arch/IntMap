#!/usr/bin/env node
/* ============================================================================
 *  IntMap · data/hist-borders.js — day-exact borders below CShapes   (#R518, widened #R690)
 * ----------------------------------------------------------------------------
 ...
 *  thirty-six years 1850–1885, where the app had no polygons at all. #R690 widened it below 1850.
 *
...
/* ⚠ THE TOLERANCE IS A BUDGET, AND THE BUDGET IS data/cshapes.js. OHM's ways are drawn far finer
   ...
   ⚠ (#R690) RE-SWEPT ON THE WIDENED DOWNLOAD, and the number was KEPT rather than inherited:
...
function check() {
  ...
  ok(d && d.window && d.window[0] < 1850,
     'the record no longer reaches below 1850 — taking it there is what #R690 exists for');
