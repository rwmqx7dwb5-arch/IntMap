...
/* ⚠ (#R575) THE TOTAL CEILING MOVED BY THE MEASURED AMOUNT — 4,695 -> 4,700 (+5 s) — for
   ...
   saving (#R510's shape). */
const TOTAL_BUDGET_S = 4711;            /* 78.5 min — 4,705 (#R576) + 6 (#R580: tests/r580.spec.js, measured) */
