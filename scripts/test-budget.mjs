...
/* ⚠ (#R575) THE TOTAL CEILING MOVED BY THE MEASURED AMOUNT — 4,695 -> 4,700 (+5 s) — for
   ...
   saving (#R510's shape). */
const TOTAL_BUDGET_S = 4706;            /* 78.4 min — 4,700 (#R575) + 6 (#R576: tests/r576.spec.js, measured) */
