...
/* ⚠ (#R570) THE TOTAL CEILING MOVED BY THE MEASURED AMOUNT — 4,695 -> 4,700 (+5 s) — for
   tests/r570.spec.js, the pandemic simulator's browser half. The arithmetic moved to
   ...
   saving (#R510's shape). */
const TOTAL_BUDGET_S = 4700;            /* 78.3 min — 4,695 (#R564) + 5 (#R570: tests/r570.spec.js) */
