...
const BUDGET_S = 40;                    /* core: 0.7 min — measured 40 s over 6 files (#R388); UNMOVED by #R410 */
...
const TOTAL_BUDGET_S = 4595;            /* 76.6 min — 4,536 (#R405) + 67 (#R410's two specs) − 8 (security + internal-qa re-measured) */
