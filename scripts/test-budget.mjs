...
/* ⚠ (#R575) THE TOTAL CEILING MOVED BY THE MEASURED AMOUNT — 4,695 -> 4,700 (+5 s) — for
   ...
   saving (#R510's shape). */
const TOTAL_BUDGET_S = 4716;            /* 78.6 min — 4,705 (#R576) + 11 (#R582: tests/r582.spec.js) */
...
const HISTORY = [
  ['#R582', 4716, "\u26a0\u26a0 THE TOTAL CEILING MOVED BY THE MEASURED AMOUNT \u2014 4,705 -> 4,716 (+11 s) \u2014 AND "
    ...
    + "tests/r582.spec.js at 11 gives 36 against BUDGET_S = 38. \u26a0 THE 11 s IS THE SPEC'S OWN MEASUREMENT, "
    ...
    + "IS THE ONE CLASS OF DEFECT THIS ROUND CANNOT REACH FROM NODE. tests/r582-checks.test.mjs (22 checks) "
