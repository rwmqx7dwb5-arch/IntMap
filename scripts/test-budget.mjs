...
/* ⚠ (#R575) THE TOTAL CEILING MOVED BY THE MEASURED AMOUNT — 4,695 -> 4,700 (+5 s) — for
   ...
   saving (#R510's shape). */
const TOTAL_BUDGET_S = 4722;            /* 78.7 min — 4716 (#R588) + 6 (#R600: tests/r600.spec.js, measured) */
