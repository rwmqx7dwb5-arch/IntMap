...
**120 measured spec files / 81.8 min** of serial browser time against a ceiling of 81.8 min; and
...
**deep** tier — **114 spec files** — is the whole suite minus core
...
tier: `npm run test:deep`, **114 spec files** against core's 6 (plus, on a PR, whatever that PR added or
