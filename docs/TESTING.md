...
**100 measured spec files / 77.2 min** of serial browser time against a ceiling of 77.2 min; and
`npm run test:checks` runs **276 Node test files** with no browser at all (counted from
