...
**159 Node test files** with no browser at all (counted from `package.json` on 2026-08-23; the
...
`tests/r315-checks.test.mjs` feeds each one a fixture with the defect deliberately present and
