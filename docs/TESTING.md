...
`npm run test:checks` runs **211 Node test files** with no browser at all (counted from
...
tier: `npm run test:deep`, **82 spec files** against core's 6, because #R204/#R207 turned the split
