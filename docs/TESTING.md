...
**92 measured spec files / 76.6 min** of serial browser time against a ceiling of 76.6 min; and
`npm run test:checks` runs **222 Node test files** with no browser at all (counted from
