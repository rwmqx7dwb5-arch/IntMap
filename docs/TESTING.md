...
### What Atlas can SEE, as distinct from what it can reach (`tests/r577-checks.test.mjs`)

Twenty questions above ask whether a capability is *reachable*. #R577 measured a different thing and
