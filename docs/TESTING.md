...
**109 measured spec files / 78.5 min** of serial browser time against a ceiling of 78.5 min; and
...
**deep** tier — **102 spec files** — is the whole suite minus core
...
tier: `npm run test:deep`, **102 spec files** against core's 7, because #R204/#R207 turned the split
