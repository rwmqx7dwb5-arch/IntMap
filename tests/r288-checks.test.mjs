...
test('#R288 ⑥ the temperature ramp is 23 measured stops in °C, on the SDK’s temperature family', () => {
  ...
  /* ⚠ (#R438) the literal carries more families after this one (pressure, precipitation, dew
     ...
     said the dew-point layer was untouched describes a state that ended in #R438. */
