...
test('R159 #2 redundant "その他の収集記事" source pile removed; never-zero fallback kept', () => {
  ...
  /* ⚠ (#R347) THE NEVER-ZERO FALLBACK IS GONE FROM THE ANALYSE PATH, AND THE COMPLAINT IT ANSWERED
     ...
     #R347 forbids that and makes the opposite true instead: js/atlas-answer-audit.js fails an answer
