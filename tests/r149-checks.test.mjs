...
test('R149 #10 mapping-quality commission: reply places get pinned + honest self-audit', () => {
  ...
  /* ⚠ (#R347) THE TRAILER IS GONE AND THE PROPERTY IT STOOD FOR IS NOT. #R149's requirement was
     ...
     #R347 replaced the whole answer with a structure, so the places are a FIELD of it — still one
