...
test('R149 #10 mapping-quality commission: reply places get pinned + honest self-audit', () => {
  ...
  /* ⚠ (#R348) THE TRAILER IS GONE AND THE PROPERTY IT STOOD FOR IS NOT. #R149's requirement was
     ...
     #R348 replaced the whole answer with a structure, so the places are a FIELD of it — still one
