...
test('R168 #8 index.html shrank and no module body came back inline', () => {
  ...
  /* ⚠ (#R193) 8,200 → 8,600, and the reason is worth stating because raising a tripwire to make
     ...
     ⚠ (#R462) 8,020 → 8,050, and the measurement is written down because raising a tripwire to make
     ...
     DEV-NOTES #R462 rather than carried here, which is the same shape the #R372 note uses; the first
