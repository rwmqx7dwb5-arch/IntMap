...
test('R168 #8 index.html shrank and no module body came back inline', () => {
  ...
  /* ⚠ (#R193) 8,200 → 8,600, and the reason is worth stating because raising a tripwire to make
     ...
     ⚠ (#R382) 8,000 → 8,020, and the measurement is written down because raising a tripwire to make
     one's own change pass is exactly the move this file exists to catch. #R382 put the News tab on
