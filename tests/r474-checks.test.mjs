/* ============================================================================
 *  #R474 — a registry size that was typed, in a tier that never stood in front of a push
 * ----------------------------------------------------------------------------
...
test('R474 ①: R406 ① compares the built registry against the declared one, not against a number', () => {
  ...
  assert.deepEqual(pinnedRegistrySizes(R('tests/r318-atlas.spec.js')), [],
    'the typed registry size is back in the spec #R474 derived');
...
test('R474 ②: no test pins the capability registry to an integer, and this check catches one', () => {
