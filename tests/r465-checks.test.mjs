/* ============================================================================
 *  IntMap · R465 — the gate said 100 %, production said «Display name»
 * ----------------------------------------------------------------------------
...
/* every English string #R459/#R465 put behind a reader-facing attribute through the inline table */
const SHIPPED = [
...
test('R465 ① every attribute string this family ships resolves in fr / ko / zh, and is not the English word', () => {
  const bad = [];
...
test('R465 ② every writer of the account sheet goes through a callee the instruments can prove', () => {
...
test('R465 ③ the lazy-wrapper blind spot is written down where the instruments are described', () => {
