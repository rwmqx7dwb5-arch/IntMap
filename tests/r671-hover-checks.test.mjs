/* ============================================================================
 *  #R671 — 「ホバーが重い」: the shared point-in-polygon read every vertex of every shape, every time
 * ----------------------------------------------------------------------------
...
/* ── the naive full walk: what the predicate did before #R671, written here and NOT imported ──── */
...
test('④ the same sweep over real polygons reads a small fraction of the vertices it used to', async () => {
  ...
  console.log('    #R671 vertex reads over ' + pts.length + ' points × ' + geoms.length + ' polygons: '
