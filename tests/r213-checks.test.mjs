...
test('R213 ⑧: revenue carries its own currency, and the ranking says what it converted with', () => {
  ...
  /* ══ ⚠⚠⚠ (#R566) THIS ASKED FOR A SPELLING AND HAS BEEN CHANGED TO ASK FOR THE FACT ═══════════
     It pinned the `_ui` literal member for member, so it went RED when #R566 handed `centroidOf`,
