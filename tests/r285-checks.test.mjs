...
/* (#R315) the action catalogue lives in its own module now — see plannerPromptSize() below */
...
function plannerPromptSize() {
  ...
  /* (#R315) SYS takes the capability selection now — `SYS(sel)`, where a null selection means the
  ...
  /* ⚠ (#R315) THE CATALOGUE HAS TO COME BACK IN, OR THIS CHECK STOPS MEASURING THE THING IT NAMES.
