 ...
 *  tests/r819-gis-worker-checks proved both of them against a real thread — and NOTHING IN js/ EVER
...
/* The product's protocol, in a thread node can actually make. Same door as
   tests/r819-gis-worker-checks and tests/r759-gis-worker-checks, for the reason those files give:
