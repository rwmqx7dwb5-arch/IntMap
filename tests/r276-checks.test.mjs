...
test('R276 ⑪ every Open-Meteo request goes through IntMapWx', () => {
  const files = ['js/weather.js', 'js/wx-ecmwf.js', 'js/wx-wind.js', 'js/map-ui.js', 'js/map-readout.js',
    ...
    /* (#R448) Atlas's shared loader moved out of the console (that file is under a shrink-only line
  ...
  /* ⚠ (#R448) THE PROPERTY IS 「ATLAS'S SHARED LOADER ROUTES OPEN-METEO THROUGH THE GUARD」, and the
