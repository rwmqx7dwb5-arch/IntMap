/* ============================================================================
 *  IntMap · #R603 — the frame a polity is shown in must contain that polity
 * ----------------------------------------------------------------------------
...
test('R603 ① the camera goes to the box the PACK states, not to the extent of what is drawn', () => {
...
test('R603 ② every polity’s frame holds that polity’s districts', () => {
...
test('R603 ③ …and the frame is not the whole planet', () => {
  if (!index) return assert.fail('data/elections/index.json is missing');
