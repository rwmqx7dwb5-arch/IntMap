...
test('R322 ⑨ the command census is off unless it is asked for', async () => {
  ...
  /* ⚠ (#R568) THE DOOR, ASKED OF THE MODULE INSTEAD OF OF ITS SPELLING. This line used to be
     `/cmdlog\|perf/.test(CENSUSC)` — one regexp literal pinned. #R568 SPLIT that literal, because
