/* ============================================================================
 *  r721-histfidelity-checks — the historical map as a CLAIM, not as a shape
 * ----------------------------------------------------------------------------
 *  #R721 found 68 shipped rows drawn from a date nobody stated — 48 ritsuryō provinces and the
