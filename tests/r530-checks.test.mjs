...
test('① data/hist-admin1.js evaluates and carries the shape js/time-admin1.js reads', () => {
  ...
  for (const f of DATA.feats) {
    /* (#R668) THE ROW GREW A COLUMN AND THIS ASSERTION PINNED ITS LENGTH. Column 10 is the
       ...
       it is used (tests/r668-checks.test.mjs ⑨). */
...
test('⑬ nine languages, in the order IntMapLang actually uses', () => {
  ...
  const args = call[1];
  /* ⚠ (#R668) THIS PINNED THE WORDING, AND THE WORDING IS NOT THE FACT. The nine regular expressions
