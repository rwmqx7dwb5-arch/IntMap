...
const MODULES = {
  ...
  aiCore:           { file: 'js/ai-core.js', k: 'IM_AI', exports: ['_aiLangLine', '_aiLangName', 'aiDev', 'aiEsc', 'aiFetchUsage', 'aiGate', 'aiLimitMsg', 'aiLoginMsg', 'aiParseJSON', 'aiReady', 'aiRenderSettings', 'aiReport', 'aiSaveSettings', 'aiSetBtnBusy', 'aiSyncFeatureButtons', 'aiToast', 'aiToday', 'aiUsesLeft', 'aiVisionReady', 'aiWaitMapIdle', 'askAI', 'askAIEnvelope', 'askAIJSON', 'askAIJSONEnvelope'] },   /* (#R348) askAIEnvelope had been DEFINED since #R132 and never returned, so the only way to read one call's own meta was a global a concurrent call overwrites */
