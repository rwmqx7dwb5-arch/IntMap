...
window.IntMapLang.define('ru', { ui: {
      ...
      tabNews:"Новости", tabCompanies:"Компании", tabStats:"Страны", 
      ...
      lblTheme:"Оформление", optAuto:"Как в системе", optLight:"Светлая", optDark:"Тёмная", 
      ...
      lblLabelLang:"Подписи мест", labelLangUi:"Как язык приложения", labelLangLocal:"Местный язык (родной алфавит)", labelLangUiLocal:"Язык приложения, снизу местное название", labelLangEn:"Всегда английский",
      ...
      aisKeyLabel:"Морской трафик (ключ AISstream)", aisKeyHint:"Необязательно. Суда показываются и без ключа — из общего потока. Собственный бесплатный ключ aisstream.io транслирует весь мир прямо в этот браузер, чуть свежее. Хранится только в этом браузере.",
      aiSecTitle:"ИИ-функции", aiSecHint:"Встроенный ИИ — бесплатно после входа (до 10 раз в день). Ключ API не нужен.",
      blueberryBtn:"Поддержать", borders:"Границы стран", coastline:"Береговые линии", countries:"Страны (инфо)", placeNames:"Названия мест", geoLabels:"Названия вод и рельефа", adminBounds:"Границы регионов", roadsLayer:"Дороги", railLayer:"Железные дороги", favLayers:"Избранное",
      measureMenuBtn:"Измерить", measureDistBtn:"📏 Расстояние / площадь", drawBtn:"✏️ Рисовать", vol3dBtn:"🧊 3-D объём", radiusBtn:"⭕ Радиус", objectsBtn:"🗂 Объекты", mScreenshot:"Снимок карты", shareMenuBtn:"Поделиться", shareLinkBtn:"Поделиться / ссылка", screenshotBtn:"Снимок карты (скрывает элементы управления, оставляет легенды)", layersBtn:"Слои ▾", importGeoFile:"Импорт данных карты", gisWorkbench:"Данные и анализ",
      lblDataSources:"Источники данных", lblScience:"Наука и логика", viewScience:"Как считает каждая модель ↗", viewSourcesPage:"Открыть страницу источников данных ↗", lblNewsCountries:"Страны новостей", newsCountriesHint:"Оставьте пустым для новостей со всего мира.",
      lyrGrpGeo:"Стратегическая география", lyrGrpOthers:"Бета", lyrGrpOthersReal:"Прочее",
      ...
      tlMachine:"Chronos", 
      aiTranslateTitles:"Перевести заголовки", 
      ...
      radiusHint:"Нажмите на карту, чтобы поставить круг. Можно несколько кругов.", removeAll:"Очистить всё", color:"Цвет",
      statPop:"Население", statGdp:"ВВП (номинал)", statGdpPc:"ВВП на душу", statGdpPPP:"ВВП (ППС)", statGdpPcPPP:"ВВП на душу (ППС)", statArea:"Площадь", statDensity:"Плотность населения", statRegion:"Регион", statCapital:"Столица", statCurrency:"Валюта", statLang:"Языки", statHDI:"ИЧР", statDem:"Индекс демократии", statMil:"Военные расходы", statLife:"Ожид. продолжительность жизни", statInet:"Интернет-пользователи",
      ...
      lyrEEZ:"Морская ИЭЗ / 12 миль", lyrShips:"Суда в реальном времени", lyrPlanes:"Самолёты в реальном времени", lyrSats:"Спутники в реальном времени", lyrThermal:"Тепловые аномалии (пожары)", planesZoomHint:"Приблизьте, чтобы загрузить самолёты", planesAreaHint:"Приблизьте — самолёты загружены для центральной части вида", poiLabels:"Объекты, предприятия и учреждения", shipsZoomHint:"Приблизьте, чтобы загрузить суда", aisNoKey:"Суда сейчас недоступны — общий поток не ответил.", aisOutsideCoverage:"Общий поток не охватывает этот морской район — судов не видно из-за покрытия данных, а не потому, что их здесь нет. Укажите свой ключ aisstream.io в настройках, чтобы видеть весь мир.", trafficFilter:"Фильтр", lyrTime:"Дата слоя",
      commAdd:"+ Новый пост", commTitle:"Заголовок", commBody:"Поделитесь наблюдением, вопросом или теорией...", commPost:"Опубликовать", commCancel:"Отмена", commEmpty:"Пока нет постов. Нажмите \"+ Новый пост\", чтобы начать обсуждение.", commLocate:"Показать на карте", commDelete:"Удалить", commReply:"Ответить", commWrite:"Написать комментарий...", commPostNew:"Новый пост", commPlacedAt:"Размещено в", commSortHot:"Популярное", commSortNew:"Новое", commSortTop:"Лучшее", commSearchPh:"Поиск постов…", commInView:"В поле зрения", commCat:"Категория", commCatAll:"Все", commEdit:"Изменить", commEdited:"изменено", commEditPost:"Редактировать пост", commSaveEdit:"Сохранить изменения", commNoMatch:"Нет постов по вашим фильтрам.",
      ...
      aiProvider:"Провайдер ИИ", aiNoKey:"Сначала добавьте ключ API ИИ в Настройки → Функции ИИ.", aiNoVision:"Эта модель не читает изображения. Выберите GPT-4o, Claude 3.5 Sonnet или Gemini 1.5 Pro.", aiThinking:"ИИ анализирует…", aiError:"Сбой запроса к ИИ", aiCopy:"Копировать", aiCopied:"Скопировано ✓", aiClose:"Закрыть", aiRetry:"Повторить",
      aiTransBusy:"Перевод…", aiTransDone:"Переведено заголовков: {n}", aiTransNone:"Заголовки уже на вашем языке.", aiTranslate:"Перевести", aiShowOriginal:"Оригинал", aiTransNoText:"Нет текста статьи для перевода — попробуйте веб-вид.",
      aiSumBtn:"Сводка по этой области (ИИ)", popInArea:"Население в этой области", popCalcing:"Расчёт населения…", popFail:"Не удалось получить население — попробуйте ещё раз.", newsInArea:"Новости в этой области", elevProfile:"Профиль высот", finalizeMeas:"Оставить на карте", aiSumTitle:"Сводка по области", aiSumSub:"Меток новостей в выбранной области: {n}", aiSumNoArea:"Сначала нарисуйте область или поставьте круг.", aiSumNoNews:"В этой области нет меток новостей.", 
