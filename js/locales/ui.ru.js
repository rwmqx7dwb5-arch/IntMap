...
window.IntMapLang.define('ru', { ui: {
      ...
      lyrEEZ:"Морская ИЭЗ / 12 миль", lyrShips:"Суда в реальном времени", lyrPlanes:"Самолёты в реальном времени", lyrSats:"Спутники в реальном времени", lyrThermal:"Тепловые аномалии (пожары)", planesZoomHint:"Приблизьте, чтобы загрузить самолёты", planesAreaHint:"Приблизьте — самолёты загружены для центральной части вида", poiLabels:"Объекты, предприятия и учреждения", shipsZoomHint:"Приблизьте, чтобы загрузить суда", aisNoKey:"Суда сейчас недоступны — общий поток не ответил.", trafficFilter:"Фильтр", lyrTime:"Дата слоя",
