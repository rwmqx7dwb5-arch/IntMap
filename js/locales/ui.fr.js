...
,
     ...
     lyrContours:"Courbes de niveau",
      ...
      gisWorkbench:"Données et analyse",
...
,
  ...
  "National elections": "Élections législatives",
  "Country or territory": "Pays ou territoire",
  "Seats": "Sièges",
  "Share of the vote": "Part des voix",
  "district": "circonscription",
  "list": "liste",
  "Parties with no seat": "Partis sans siège",
  "No result is recorded for this district.": "Aucun résultat n’est consigné pour cette circonscription.",
  "The record does not carry a vote count for this district.": "Le registre ne comporte pas de décompte des voix pour cette circonscription.",
  "Colour = the party that won the district. The bars are the whole chamber, including the seats this map does not draw.": "La couleur indique le parti qui a remporté la circonscription. Les barres représentent l’ensemble de la chambre, y compris les sièges que cette carte ne dessine pas.",
  "No constituency boundaries have been published for this election, so the map stays empty. The chamber below is the recorded result.": "Aucun découpage des circonscriptions n’a été publié pour cette élection : la carte reste donc vide. La chambre ci-dessous est le résultat consigné.",
  ...
  "source records": "enregistrements source",
  "are a place in its own right": "sont un lieu à part entière",
  "Records that GeoNames marks as a section of another place, or as historical, abandoned or destroyed, are not counted as a place": "Les enregistrements que GeoNames signale comme partie d'un autre lieu, ou comme historiques, abandonnés ou détruits, ne comptent pas comme un lieu",
  "a field of the source record, copied": "copié d'un champ de l'enregistrement source",
  "Record type": "Type d'enregistrement",
  "a grid sampled at this row coordinate": "échantillonné sur une grille à cette coordonnée",
  "measured here from the published geometry": "mesuré ici à partir de la géométrie publiée",
  "requested from the endpoint for this row": "demandé au service pour cette ligne",
  "looked up through the country this row is in": "obtenu via le pays de cette ligne",
  ...
  "active cases · red = infectious, orange = infected but not yet infectious": "cas actifs · rouge = contagieux, orange = infectés mais pas encore contagieux",
  ...
  "Infected, not yet infectious": "Infectés, pas encore contagieux",
  "Infectious now": "Contagieux actuellement",
  "Initial cases": "Cas initiaux",
  "Initial immunity": "Immunité initiale",
  "International spread is weighted by population, distance and airport capacity. The land-border table did not load.": "La propagation internationale est pondérée par la population, la distance et la capacité aéroportuaire. La table des frontières terrestres n’a pas pu être chargée.",
  "International spread is weighted by population, distance and land borders. The airport table did not load.": "La propagation internationale est pondérée par la population, la distance et les frontières terrestres. La table des aéroports n’a pas pu être chargée.",
  "Latent (d)": "Latence (j)",
  "Lifelong immunity": "Immunité à vie",
  "Loading the border and airport tables — the outbreak starts once the world is fixed.": "Chargement des tables des frontières et des aéroports — l’épidémie démarrera une fois le monde fixé.",
  "No response": "Aucune mesure",
  "Nobody is immune, and no vaccine or treatment exists yet.": "Personne n’est immunisé et il n’existe encore ni vaccin ni traitement.",
  "Novel pathogen": "Agent pathogène inédit",
  "Protected by vaccine now": "Actuellement protégés par le vaccin",
  ...
  "Today's world": "Le monde d’aujourd’hui",
  "Travel": "Déplacements",
  "Uses the vaccines and treatments this disease really has in 2026, plus an ASSUMED level of starting immunity — one figure applied to every country and age.": "Utilise les vaccins et les traitements dont cette maladie dispose réellement en 2026, plus un niveau SUPPOSÉ d’immunité initiale — un seul chiffre appliqué à chaque pays et à chaque âge.",
  ...
  "World Heritage (UNESCO)": "Patrimoine mondial (UNESCO)",
  "World Heritage — every UNESCO property": "Patrimoine mondial — tous les biens de l’UNESCO",
  "Could not load the World Heritage list": "Impossible de charger la Liste du patrimoine mondial",
  "Inscribed {y}": "Inscrit en {y}",
  "UNESCO page": "Page de l’UNESCO",
  "On the List in Danger": "Sur la Liste en péril",
  "On the List in Danger since {y}": "Sur la Liste en péril depuis {y}",
  "On the List of World Heritage in Danger": "Sur la Liste du patrimoine mondial en péril",
  "On the List of World Heritage in Danger since {y}": "Sur la Liste du patrimoine mondial en péril depuis {y}",
  "{s} inscribed properties, drawn as {p} component parts. {d} are on the List in Danger.": "{s} biens inscrits, dessinés en {p} éléments constitutifs. {d} figurent sur la Liste en péril.",
  "UNESCO publishes no coordinate for {n} of them, so they are not on the map.": "L’UNESCO ne publie aucune coordonnée pour {n} d’entre eux ; ils ne figurent donc pas sur la carte.",
  "UNESCO publishes the List in English, French, Spanish, Russian, Arabic, Chinese and Japanese only, so the names here are in English.": "L’UNESCO ne publie la Liste qu’en anglais, français, espagnol, russe, arabe, chinois et japonais ; les noms sont donc affichés en anglais.",
  "Say what to narrow the World Heritage layer to: a category, or the List in Danger.": "Précisez comment restreindre la couche du patrimoine mondial : une catégorie ou la Liste en péril.",
  "Categories are: {c}": "Les catégories sont : {c}",
  "{n} World Heritage points shown": "{n} points du patrimoine mondial affichés",
  "Name a World Heritage property.": "Indiquez un bien du patrimoine mondial.",
  ...
  "Moderate deposition": "Dépôt modéré",
  "Light deposition": "Dépôt faible",
  "Sr-90: mandatory resettlement (UA)": "Sr-90 : relogement inconditionnel (obligatoire) — loi ukrainienne",
  "Sr-90: guaranteed voluntary resettlement (UA)": "Sr-90 : relogement volontaire garanti — loi ukrainienne",
  "Sr-90: enhanced radioecological control (UA)": "Sr-90 : contrôle radioécologique renforcé — loi ukrainienne",
  "Final ground deposition — statutory zones": "Dépôt au sol final — zones légales",
  "Final ground deposition — density only (this nuclide has no statutory zoning)": "Dépôt au sol final — densité seule (ce nucléide n’a pas de zonage légal)",
  "too few particles reached this cell to quote a value": "trop peu de particules ont atteint cette cellule pour avancer une valeur",
  "first year": "première année",
  "external dose from this deposit is minor — Sr-90/Y-90 are beta emitters, and the hazard is ingestion, not ground shine": "la dose externe due à ce dépôt est faible — le Sr-90 et l’Y-90 sont des émetteurs bêta, et le risque vient de l’ingestion, non du rayonnement du sol",
  ...
  "Measured radiation": "Rayonnement mesuré",   /* map-ui.js (#R585) */
  "Measured radiation — ambient gamma dose rate": "Rayonnement mesuré — débit de dose gamma ambiant",   /* beta-overlays.js radiation-layer.js (#R585) */
  "stations": "stations",   /* radiation-layer.js (#R585) */
  "unavailable: ": "indisponible : ",   /* atlas-controls.js (#R585) */
  "Loading history…": "Chargement de l’historique…",   /* radiation-layer.js (#R585) */
  "No history published for this station.": "Aucun historique n’est publié pour cette station.",   /* radiation-layer.js (#R585) */
  "Could not reach the networks.": "Impossible de joindre les réseaux.",   /* radiation-layer.js (#R585) */
  "Radiation measurements are unavailable right now.": "Les mesures de rayonnement sont indisponibles pour le moment.",   /* beta-overlays.js (#R585) */
  "{n} stations within {k} km": "{n} stations dans un rayon de {k} km",   /* atlas-controls.js (#R585) */
  "No monitoring station within {k} km publishes an open-licensed reading. That is a gap in coverage, not a statement about the radiation there.": "Aucune station de surveillance à moins de {k} km ne publie de mesure sous licence ouverte. C’est une lacune de couverture, et non une affirmation sur le niveau de rayonnement à cet endroit.",   /* atlas-controls.js (#R585) */
  "Measured radiation on — {n} stations from {m} networks": "Rayonnement mesuré activé — {n} stations issues de {m} réseaux",   /* atlas-controls.js (#R585) */
  "Measured radiation layer off.": "Calque du rayonnement mesuré désactivé.",   /* atlas-controls.js (#R585) */
  "Give a coordinate to measure around.": "Indiquez une coordonnée autour de laquelle mesurer.",   /* atlas-controls.js (#R585) */
  "50–200 nSv/h is normal natural background almost everywhere. Rain alone can lift a station up to three times higher for a few hours, and most of these readings are published unvalidated — so one high station is not evidence of a release.": "50–200 nSv/h correspond au fond naturel normal presque partout. La pluie à elle seule peut multiplier par trois la valeur d’une station pendant quelques heures, et la plupart de ces mesures sont publiées sans validation — une seule station élevée n’est donc pas la preuve d’un rejet.",   /* radiation-layer.js (#R585) */
  "{n} more stations publish a period average, not a current reading — set the clock to their year to see them.": "{n} autres stations publient une moyenne de période, et non une mesure actuelle — réglez l’horloge sur leur année pour les afficher.",   /* radiation-layer.js (#R585) */
  "below this detector’s stated range": "sous la plage de mesure déclarée de ce détecteur",   /* radiation-layer.js (#R585) */
  "published average for a period — not a current reading": "moyenne publiée pour une période — ce n’est pas une mesure actuelle",   /* radiation-layer.js (#R585) */
  "still loading one network…": "un réseau est encore en cours de chargement…",   /* radiation-layer.js (#R585) */
  ...
  "Sources and assumptions": "Sources et hypothèses",   /* playground.js (#R678) */
  "Disease parameters": "Paramètres de la maladie",   /* playground.js (#R678) */
  "How fast it spreads": "Vitesse de propagation",   /* playground.js (#R678) */
  "How deadly it is": "Létalité",   /* playground.js (#R678) */
  "How long immunity lasts": "Durée de l’immunité",   /* playground.js (#R678) */
  "Vaccine": "Vaccin",   /* playground.js (#R678) */
  "Treatment": "Traitement",   /* playground.js (#R678) */
  "Starting immunity": "Immunité initiale",   /* playground.js (#R678) */
  "No named source in this table": "Aucune source nommée dans cette table",   /* playground.js (#R678) */
  "The world this run uses": "Le monde utilisé par cette simulation",   /* playground.js (#R678) */
  "Land borders and capitals": "Frontières terrestres et capitales",   /* playground.js (#R678) */
  "Airport capacity": "Capacité aéroportuaire",   /* playground.js (#R678) */
  "Airline route network": "Réseau de lignes aériennes",   /* playground.js (#R678) */
  "June 2014 snapshot, no longer updated": "instantané de juin 2014, plus mis à jour",   /* playground.js (#R678) */
  "How many travellers arrive in each country": "Nombre de voyageurs qui arrivent dans chaque pays",   /* playground.js (#R678) */
  "Medical capacity, emergency response, vaccine delivery": "Capacité médicale, réponse d’urgence, distribution des vaccins",   /* playground.js (#R678) */
  "Where the case dots are drawn": "Où sont dessinés les points de cas",   /* playground.js (#R678) */
  "Assumptions, not measurements": "Des hypothèses, pas des mesures",   /* playground.js (#R678) */
  "Route counts stand in for passenger flows": "Le nombre de lignes tient lieu de flux de passagers",   /* playground.js (#R678) */
  "No open, current bilateral passenger matrix exists. Part of each origin's air weight comes from the 2014 route network and the rest from a distance model, which is also how a country with no direct flight is still reachable.": "Il n’existe aucune matrice bilatérale de passagers ouverte et à jour. Une partie du poids aérien de chaque origine provient du réseau de lignes de 2014 et le reste d’un modèle de distance, ce qui explique aussi qu’un pays sans vol direct reste atteignable.",   /* playground.js (#R678) */
  "Case dots sit on cities, not on a population surface": "Les points de cas se posent sur les villes, pas sur une surface de population",   /* playground.js (#R678) */
  "Dots are shared out between a country's places in proportion to how many people live in each. A city gazetteer knows where towns are, not where the countryside is.": "Les points sont répartis entre les localités d’un pays au prorata du nombre d’habitants de chacune. Un répertoire de villes sait où sont les villes, pas où sont les campagnes.",   /* playground.js (#R678) */
  "Measles starts from WHO/UNICEF first-dose coverage per country. That is childhood coverage read as whole-population immunity: this model has no age structure.": "La rougeole part de la couverture par première dose de l’OMS/UNICEF, pays par pays. Il s’agit d’une couverture infantile lue comme l’immunité de toute la population : ce modèle n’a pas de structure par âge.",   /* playground.js (#R678) */
  "One assumed figure for every country and every age. Nobody publishes per-country protection against infection, so this is the coarsest shape a one-compartment immunity can take — not an estimate anyone made.": "Un seul chiffre supposé pour tous les pays et tous les âges. Personne ne publie la protection contre l’infection pays par pays : c’est donc la forme la plus grossière que puisse prendre une immunité à un seul compartiment — et non l’estimation de quiconque.",   /* playground.js (#R678) */
  "Severity is applied to every infection": "La gravité est appliquée à toutes les infections",   /* playground.js (#R678) */
  "Presets whose severity is a CFR have a smaller denominator than an IFR does, and this model has no detection layer to tell them apart. The setting shows which metric a preset uses so it can be lowered.": "Les préréglages dont la gravité est un taux de létalité des cas (CFR) ont un dénominateur plus petit qu’un taux de létalité de l’infection (IFR), et ce modèle n’a aucune couche de détection pour les distinguer. Le réglage indique quelle mesure utilise chaque préréglage, afin de pouvoir l’abaisser.",   /* playground.js (#R678) */
  "Medical capacity": "Capacité médicale",   /* playground.js (#R678) */
  "Emergency response": "Réponse d’urgence",   /* playground.js (#R678) */
  "Vaccine delivery": "Distribution des vaccins",   /* playground.js (#R678) */
  "estimated from GDP per head — this country is not in the WHO or World Bank table": "estimé à partir du PIB par habitant — ce pays ne figure pas dans la table de l’OMS ni de la Banque mondiale",   /* playground.js (#R678) */
  "loaded": "chargé",   /* playground.js (#R678) */
  "loaded for some countries": "chargé pour certains pays",   /* playground.js (#R678) */
  "did not load": "n’a pas pu être chargé",   /* playground.js (#R678) */
  "still loading": "chargement en cours",   /* playground.js (#R678) */
  "International spread is weighted by land borders, by how many travellers each country actually receives, and by the airline route network as it stood in 2014 — the newest one that is openly published. Route counts are not seats or passenger numbers.": "La propagation internationale est pondérée par les frontières terrestres, par le nombre de voyageurs que chaque pays reçoit réellement et par le réseau de lignes aériennes tel qu’il était en 2014 — le plus récent publié en libre accès. Le nombre de lignes n’est ni un nombre de sièges ni un nombre de passagers.",   /* playground.js (#R678) */
  "International spread is weighted by land borders, airport capacity and the airline route network as it stood in 2014. The observed traveller volumes did not load.": "La propagation internationale est pondérée par les frontières terrestres, la capacité aéroportuaire et le réseau de lignes aériennes tel qu’il était en 2014. Les volumes de voyageurs observés n’ont pas pu être chargés.",   /* playground.js (#R678) */
  ...
  "Source boundary precision: approximate": "Précision des frontières selon la source : approximative",
  "Source boundary precision: moderately precise": "Précision des frontières selon la source : moyenne",
  "Source boundary precision: determined by international law": "Précision des frontières selon la source : définies par le droit international",
  "Source dates: ": "Dates de la source : ",
  "[?] marks a historical name whose start date is unknown.": "[?] indique un nom historique dont la date de début d’utilisation est inconnue.",
  /* ── js/atlas-progress.js (#R723) — THE WORK TRACE. Une ligne par action en cours pendant la
     réponse d’Atlas : ce sont des libellés d’ACTION, pas des noms de catégories. Registre nominal,
     celui que « Réflexion » / « Lecture de l’image » / « Vérification » posent déjà plus haut. */
  "Writing the answer": "Rédaction de la réponse",
  "Drawing on the map": "Tracé sur la carte",
  "Switching layers": "Changement de calques",
  "Moving the view": "Déplacement de la vue",
  "Opening a panel": "Ouverture d’un panneau",
  "Looking up data": "Consultation des données",
  "Researching": "Recherche en cours",
  "Changing a setting": "Modification d’un réglage",
  "Running a simulation": "Exécution d’une simulation",
  "Working out a route": "Calcul d’un itinéraire",
  "Setting the clock": "Réglage de l’horloge",
  "Checking the app": "Vérification de l’application",
  "Adjusting the interface": "Ajustement de l’interface",
  "Asking you": "Question pour vous",
  "Matching the photo": "Comparaison de la photo",
  ...
  "A setting is not a value this step can use": "Un paramètre n’a pas une valeur utilisable par cette étape",
  "A setting this step needs has not been filled in": "Un paramètre requis par cette étape n’est pas renseigné",
  "Add a condition": "Ajouter une condition",
  "An earlier step failed, so this one was never run": "Une étape précédente a échoué, celle-ci n’a donc pas été exécutée",
  "Analysis step": "Étape d’analyse",
  "Choose a dataset for input": "Choisissez un jeu de données en entrée",
  "Choose an input dataset first": "Choisissez d’abord un jeu de données en entrée",
  "Could not open the data panel": "Impossible d’ouvrir le panneau de données",
  "Data and analysis": "Données et analyse",
  "datasets": "jeux de données",
  "Datasets": "Jeux de données",
  "Delete this dataset?": "Supprimer ce jeu de données ?",
  "Deleted": "Supprimé",
  "Deleting this also deletes what was made from it": "Le supprimer efface aussi ce qui en a été tiré",
  "Draw again": "Retracer",
  "Draw on the map": "Tracer sur la carte",
  "Drawn on the map": "Tracé sur la carte",
  "empty": "vides",
  "expected": "attendues",
  "feature": "entité",
  "From and to, both ends included": "De et à, bornes comprises",
  "Give the project a name first": "Donnez d’abord un nom au projet",
  "given": "indiquées",
  "has": "a",
  "Imported": "Importé",
  "Input": "Entrée",
  ...
  "Made": "Créé",
  "needs": "nécessite",
  "no choices declared": "aucun choix déclaré",
  "no geometry": "sans géométrie",
  "No saved projects yet": "Aucun projet enregistré pour l’instant",
  "No steps are registered": "Aucune étape n’est enregistrée",
  "Nothing here yet. Drop a file on the map, or run a step below.": "Rien ici pour l’instant. Déposez un fichier sur la carte, ou exécutez une étape ci-dessous.",
  "Origin not stated": "Origine non indiquée",
  "Produces": "Produit",
  "Project": "Projet",
  "Project name": "Nom du projet",
  "Project opened": "Projet ouvert",
  "Project saved": "Projet enregistré",
  "Reading the saved projects…": "Lecture des projets enregistrés…",
  "Rebuilt": "Recalculé",
  ...
  "Showing": "Affichées",
  "That analysis step is not registered": "Cette étape d’analyse n’est pas enregistrée",
  "That column is not in the input dataset": "Cette colonne n’existe pas dans le jeu de données d’entrée",
  "That comparison is not one this filter knows": "Cette comparaison est inconnue de ce filtre",
  "That dataset is not registered any more": "Ce jeu de données n’est plus enregistré",
  ...
  "The input dataset is gone": "Le jeu de données d’entrée a disparu",
  "The layer is removed from the import list on the map, not from here": "La couche se retire depuis la liste des imports sur la carte, pas d’ici",
  "The map is not ready to take a layer yet": "La carte n’est pas encore prête à recevoir une couche",
  "The project module has not loaded, so nothing can be saved or reopened": "Le module de projet n’est pas chargé : rien ne peut être enregistré ni rouvert",
  "The result could not be registered as a dataset": "Le résultat n’a pas pu être enregistré comme jeu de données",
  "the same geometry as the input": "la même géométrie que l’entrée",
  "The second input holds no polygon to clip with": "La deuxième entrée ne contient aucun polygone pour le découpage",
  "The step could not be run": "L’étape n’a pas pu être exécutée",
  "The step stopped part way through": "L’étape s’est arrêtée en cours de route",
  "The store could not be read": "Le stockage n’a pas pu être lu",
  "The store could not be written to": "Le stockage n’a pas pu être écrit",
  "There is no dataset to run this on yet": "Il n’y a pas encore de jeu de données pour cette étape",
  "This browser is not letting the page store anything, so projects cannot be saved": "Ce navigateur n’autorise aucun stockage, les projets ne peuvent donc pas être enregistrés",
  "This dataset came from a file, not from a step, so it has no settings to change": "Ce jeu de données provient d’un fichier et non d’une étape : il n’a aucun paramètre modifiable",
  "This dataset carries no attribute columns": "Ce jeu de données ne porte aucune colonne d’attributs",
  "This step needs a different geometry": "Cette étape demande une autre géométrie",
  "This step takes a different number of inputs": "Cette étape prend un autre nombre d’entrées",
  "This step takes no settings": "Cette étape n’a aucun paramètre",
  "Type:": "Type :",
  "Upstream draws this shape without giving it a name": "La source trace cette forme sans lui donner de nom",
  "Upstream states nothing further about this shape — not what it is, and not how precisely its boundary is drawn.": "La source ne dit rien de plus sur cette forme — ni ce qu’elle est, ni avec quelle précision sa limite est tracée.",
  "Where this came from": "D’où cela provient",
