...
window.IntMapLang.define('es', { ui: {
      ...
      lyrEEZ:"ZEE marítima / 12 mn", lyrShips:"Tráfico marítimo en vivo", lyrPlanes:"Tráfico aéreo en vivo", lyrSats:"Satélites en vivo", lyrThermal:"Anomalías térmicas (incendios)", planesZoomHint:"Acerca para cargar aviones en vivo", planesAreaHint:"Acerca — los aviones cubren la zona central de esta vista", poiLabels:"Lugares, empresas e instalaciones", shipsZoomHint:"Acerca para cargar barcos en vivo", aisNoKey:"Los barcos en vivo no están disponibles ahora — el feed compartido no respondió.", aisOutsideCoverage:"El feed compartido no cubre esta zona marítima — no es que no haya barcos, es la cobertura de los datos. Añade tu propia clave de aisstream.io en Ajustes para ver todo el mundo.", trafficFilter:"Filtro", lyrTime:"Fecha de la capa",
