...
window.IntMapLang.define('es', { ui: {
      ...
      tlTitle:"Chronos", tlMachine:"Chronos", tlToday:"Hoy", tl10y:"−10 a", tl5y:"−5 a", tlNow:"Ahora",
      ...
      aiGeoBtn:"✨ Localizar todas las noticias (IA)", aiTransBusy:"Traduciendo…", aiTransDone:"{n} títulos traducidos", aiTransNone:"Los títulos ya están en tu idioma.", aiTranslate:"Traducir", aiShowOriginal:"Original", aiTransNoText:"No hay texto de artículo para traducir — prueba la vista web.",
...
,
      ...
      lyrGrpWeather:"Clima y medio ambiente",
      optPsychedelic:"Psicodélico",
      optMilitary:"Militar",
      optMedical:"Médico",
      optBaroque:"Barroco (europeo)",
      optTaisho:"Japón Taishō",
     ...
     lyrSST:"Temperatura de la superficie del mar",
      ...
      lblPlayground:"Zona de juego (beta)",
      playgroundBtn:"🎮 Abrir la zona de juego",
      ...
      lgdTempTitle:"Temp. aire (2 m)",
      lyrTimeMonth:"Mes",
      lyrRelief:"Elevación (relieve en color)",
      lyrSubcables:"Cables submarinos",
      lgdReliefTitle:"Elevación",
      lgdSubcablesTitle:"Cables submarinos",
      lyrMilSpend:"Gasto militar",
      lyrGDPpc:"PIB per cápita",
      lyrTFR:"Tasa de fecundidad total",
      lyrSeaLevel:"Cambio del nivel del mar",
      lgdSeaLevelTitle:"Cambio del nivel del mar",
      proSection:"Funciones premium",
      proArchive:"🔒 Archivo de viaje en el tiempo (10 años)",
      proIntel:"🔒 Fuentes primarias locales RU·CN",
      proModalTitle:"Desbloquear IntMap Pro",
      proModalSub:"Más allá del mapa en vivo: archivos históricos profundos e inteligencia de fuentes primarias.",
      ...
      atlasBtn:"Atlas — pregunta en lenguaje natural (beta) · Ctrl/⌘+K",
      lblLayerPanel:"Panel de capas",
      layerPanelClassic:"Desplegable clásico",
      layerPanelRight:"Barra lateral derecha (visual, con vistas previas)",
      ...
      wsOff:'Apagado (predeterminado)',
      wsOn:'Encendido — ventanas libres',
