...
,
  ...
  sourceUse: {
    ...
    "NASA GIBS / Worldview": "Temperature, precipitation, SST, sea-ice concentration & SST anomaly, snow, aerosol & UV-aerosol index, carbon monoxide, soil moisture, ocean chlorophyll, fires, vegetation (NDVI), land-surface & cloud-top temperature, true-color & shaded relief",
    ...
    "Diplomatic missions — OpenStreetMap (amenity=embassy / office=diplomatic, Overpass API)": "Embassies, consulates and other diplomatic missions mapped in OpenStreetMap, queried live for the current map view (ODbL). Each point prints that object’s own tags and links to it; nothing is inferred",
    ...
    "Spaceports & satellite ground stations — OpenStreetMap (aeroway=spaceport, man_made=launch_pad/satellite_dish, Overpass API)": "Launch pads, spaceports, satellite ground stations and radio telescopes mapped in OpenStreetMap, queried live for the current map view (ODbL)",
