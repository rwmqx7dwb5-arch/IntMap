...
,
  ...
  sourceUse: {
    ...
    "historical-basemaps (aourednik)": "Historical borders — the beta overlay layer, the automatic fallback for the map’s own past-year borders (nearest snapshot), and — below CShapes’ 1886 floor — the ONLY border source there is. Upstream holds just two frames under 1900 (1815 and 1880), so every year from 1850 to 1885 is drawn with the 1880 borders",
