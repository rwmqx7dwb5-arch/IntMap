...
,
  ...
  sourceUse: {
    ...
    "Smithsonian GVP": "Bundled with the app (data/volcanoes_gvp.json + data/volcano-detail.json.gz, built by scripts/build-volcanoes.mjs from the GVP WFS): the whole Holocene catalog with its join key, and behind it every eruption GVP records for the volcanoes in that catalog, with its VEI and dates, the volcano type, landform, tectonic setting and dominant rock type, the geological summary, the photograph, and the population living within 5, 10, 30 and 100 km. Everything the volcano card says about the past is read from this file, offline.",
