...
window.IntMapLang.define('en', { ui: {
      ...
      tabNews:"News", tabCompanies:"Companies", tabStats:"Countries",
      ...
      radiusHint:"Click the map to place a circle. Multiple circles allowed.",
      placeNames:"Place names", geoLabels:"Water & terrain labels", adminBounds:"State / province borders", roadsLayer:"Roads", railLayer:"Railways", countries:"Countries (info)", removeAll:"Clear all", color:"Color",
      statPop:"Population", statGdp:"GDP (nominal)", statGdpPc:"GDP per capita", statGdpPPP:"GDP (PPP)", statGdpPcPPP:"GDP per capita (PPP)", statArea:"Area", statDensity:"Pop. density", statRegion:"Region", statCapital:"Capital", statCurrency:"Currency", statLang:"Languages", statHDI:"HDI", statDem:"Democracy Idx", statMil:"Mil. spending", statLife:"Life expectancy", statInet:"Internet users",
      ...
      spType:"Type", 
      flat:"Flat", globe:"Globe", threeD:"⛰️ 3D", gridBtn:"🌐 Grid", gridLayer:"🌐 Grid & labels", lblTempUnit:"Temperature", tempBoth:"°C + °F", tempC:"°C only", tempF:"°F only", measureMenuBtn:"Measure", measureDistBtn:"📏 Distance / area", drawBtn:"✏️ Draw", vol3dBtn:"🧊 3-D volume", radiusBtn:"⭕ Radius", objectsBtn:"🗂 Objects", mScreenshot:"Map screenshot", shareMenuBtn:"Share", shareLinkBtn:"Share / copy link", layersBtn:"Layers ▾",
      ctxDropPin:"Drop a pin", ctxMeasureFrom:"Start measuring", ctxPostHere:"Post to the community", ctxDistFrom:"Distance from previous pin", ctxCopy:"Copy coordinates", ctxClearPins:"Remove all pins", ctxThisPoint:"This point", coords:"Coordinates", depth:"Depth", climate:"Climate", tlMachine:"Chronos", 
      lyrEEZ:"Maritime EEZ / 12nm", lyrShips:"Live ship traffic", lyrPlanes:"Live aircraft traffic", lyrSats:"Live satellites", lyrThermal:"Thermal anomalies (fires)", planesZoomHint:"Zoom in to load live aircraft", planesAreaHint:"Zoom in — live aircraft cover the central area of this view", poiLabels:"Places, businesses & facilities", shipsZoomHint:"Zoom in to load live ships", aisNoKey:"Live ships are unavailable right now — the shared feed did not answer.", aisOutsideCoverage:"The shared feed does not cover this sea area — no live ships appear here because of data coverage, not because the water is empty. Add your own aisstream.io key in Settings to see the whole world.", aisKeyLabel:"Live ship traffic (AISstream key)", aisKeyHint:"Optional. Live ships already work without a key, from a shared feed. Your own free key from aisstream.io streams the whole world straight to this browser, a little fresher. Stored only in this browser.",
      ...
      commAdd:"+ New post", commTitle:"Title", commBody:"Share an observation, question, or theory...", commPost:"Post", commCancel:"Cancel", commEmpty:"No posts yet. Click \"+ New post\" to start the discussion.", commLocate:"Show on map", commDelete:"Delete", commReply:"Reply", commWrite:"Write a comment...", commPostNew:"New post", commPlacedAt:"Placed at", commSortHot:"Hot", commSortNew:"New", commSortTop:"Top", commSearchPh:"Search posts…", commInView:"In view", commCat:"Category", commCatAll:"All", commEdit:"Edit", commEdited:"edited", commEditPost:"Edit post", commSaveEdit:"Save changes", commNoMatch:"No posts match your filters.", borders:"Country borders", coastline:"Coastlines & shores", compare:"Compare", compareEmpty:"Tap country rows to select and compare.", coCompareEmpty:"Tap company rows to select and compare.", compareView:"Show comparison", compareClear:"Clear", back:"Back", deletePin:"Delete",
      ...
      aiTranslateTitles:"Translate titles", aiTransBusy:"Translating…", aiTransDone:"Translated {n} titles", aiTransNone:"Titles already in your language.",
      lblNewsLang:"News languages", newsLangUi:"Current language only", newsLangMulti:"All languages (auto-translate titles)", 
