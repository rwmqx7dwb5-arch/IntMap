...
window.IntMapLang.define('en', { ui: {
      ...
      lyrEEZ:"Maritime EEZ / 12nm", lyrShips:"Live ship traffic", lyrPlanes:"Live aircraft traffic", lyrSats:"Live satellites", lyrThermal:"Thermal anomalies (fires)", planesZoomHint:"Zoom in to load live aircraft", planesAreaHint:"Zoom in — live aircraft cover the central area of this view", poiLabels:"Places, businesses & facilities", shipsZoomHint:"Zoom in to load live ships", aisNoKey:"Live ships are unavailable right now — the shared feed did not answer.", aisKeyLabel:"Live ship traffic (AISstream key)", aisKeyHint:"Optional. Live ships already work without a key, from a shared feed. Your own free key from aisstream.io streams the whole world straight to this browser, a little fresher. Stored only in this browser.",
