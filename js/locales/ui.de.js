...
window.IntMapLang.define('de', { ui: {
      ...
      tlTitle:"Chronos", tlMachine:"Chronos", tlToday:"Heute", tl10y:"−10 J", tl5y:"−5 J", tlNow:"Jetzt",
      ...
      aiGeoBtn:"✨ Alle Nachrichten per KI verorten", aiTransBusy:"Übersetzen…", aiTransDone:"{n} Titel übersetzt", aiTransNone:"Titel bereits in Ihrer Sprache.", aiTranslate:"Übersetzen", aiShowOriginal:"Original", aiTransNoText:"Kein Artikeltext zum Übersetzen — versuchen Sie die Web-Ansicht.",
...
,
      ...
      lyrGrpWeather:"Wetter & Umwelt",
      optPsychedelic:"Psychedelisch",
      optMilitary:"Militärisch",
      optMedical:"Medizinisch",
      optBaroque:"Barock (europäisch)",
     ...
     lyrSST:"Meeresoberflächentemperatur",
      ...
      lgdWindTitle:"Windgeschwindigkeit",
      lblFeedback:"Feedback & Fehlerbericht",
      sendFeedbackBtn:"⭐ Feedback senden",
      reportBugBtn:"🐞 Fehler melden",
      lblPlayground:"Spielwiese (Beta)",
      playgroundBtn:"🎮 Spielwiese öffnen",
      ...
      lgdTempTitle:"Lufttemp. (2 m)",
      lyrTimeMonth:"Monat",
      lyrRelief:"Höhe (Farbrelief)",
      lyrSubcables:"Seekabel",
      lgdReliefTitle:"Höhe",
      lgdSubcablesTitle:"Seekabel",
      lyrMilSpend:"Militärausgaben",
      lyrGDPpc:"BIP pro Kopf",
      lyrTFR:"Geburtenrate",
      lyrSeaLevel:"Meeresspiegeländerung",
      lgdSeaLevelTitle:"Meeresspiegeländerung",
      lblNavInertia:"Trägheit",
      proSection:"Premium-Funktionen",
      proArchive:"🔒 10-Jahre-Zeitreise-Archiv",
      proIntel:"🔒 RU·CN lokale Primärquellen-Intel",
      proModalTitle:"IntMap Pro freischalten",
      proModalSub:"Gehen Sie über die Live-Karte hinaus — tiefe historische Archive und Primärquellen-Informationen.",
      ...
      atlasBtn:"Atlas — in normaler Sprache fragen (Beta) · Strg/⌘+K",
      lblLayerPanel:"Ebenen-Auswahl",
      layerPanelClassic:"Klassisches Dropdown",
      layerPanelRight:"Rechte Seitenleiste (visuell, mit Vorschau)",
      ...
      wsOff:'Aus (Standard)',
      wsOn:'An — frei bewegliche Fenster',
