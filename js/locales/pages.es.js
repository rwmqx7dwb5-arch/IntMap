...
window.IntMapPageI18N.define('es', {
  ...
  sourceUse: {
    ...
    "気象警報・注意報 — 気象庁 (Japan Meteorological Agency, bulletin list r8, by municipality)": "Se lee en vivo para la capa de avisos: la lista de boletines de la JMA. El estado es el boletín más reciente de cada oficina y Japón se dibuja por municipio (class20).",
    ...
    "行政区域データ（市区町村界）— 国土交通省 国土数値情報 N03 (via smartnews-smri/japan-topography)": "Los límites municipales de Japón, del Ministerio de Territorio. La capa de avisos los enlaza por el código JIS — los cinco primeros dígitos de un código class20 de la JMA.",
    "Weather warnings, United States — NOAA National Weather Service (api.weather.gov, CAP)": "Se lee en vivo: todos los avisos vigentes del Servicio Meteorológico Nacional de EE. UU., con sus polígonos, agrupados por estado al tocar. Se solicita directamente desde el navegador.",
