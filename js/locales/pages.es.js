...
window.IntMapPageI18N.define('es', {
  ...
  sourceUse: {
    ...
    "Weather warnings, Europe — MeteoAlarm (EUMETNET), the 37 national services": "Se lee en vivo: los avisos vigentes de los servicios meteorológicos europeos tal como los publica MeteoAlarm, agrupados por región al tocar. MeteoAlarm no envía cabecera CORS y el feed de un país ronda los diez megabytes, así que el propio relé de la aplicación lo obtiene y resume en el servidor.",
