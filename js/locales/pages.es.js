...
window.IntMapPageI18N.define('es', {
  ...
  sourceUse: {
    ...
    'historical-basemaps (aourednik)': 'Fronteras históricas: la capa beta de superposición, el respaldo automático de las fronteras de años pasados del propio mapa (la instantánea más cercana) y, por debajo del límite de 1886 de CShapes, la única fuente de fronteras que existe. El repositorio de origen solo tiene dos instantáneas anteriores a 1900 (1815 y 1880), así que todos los años de 1850 a 1885 se dibujan con las fronteras de 1880.',
