...
window.IntMapLang.define('jp', { ui: {
      ...
      radiusHint:"地図をクリックで円を配置。複数配置可。",
      placeNames:"地名表示", geoLabels:"水域・地形ラベル", adminBounds:"州・県境", roadsLayer:"道路網", railLayer:"鉄道", countries:"国境・国情報", removeAll:"全削除", color:"色",
      statPop:"人口", statGdp:"GDP(名目)", statGdpPc:"一人当たりGDP", statGdpPPP:"GDP(購買力平価)", statGdpPcPPP:"一人当たりGDP(PPP)", statArea:"面積", statDensity:"人口密度", statRegion:"地域", statCapital:"首都", statCurrency:"通貨", statLang:"言語", statHDI:"HDI", statDem:"民主主義指数", statMil:"軍事費", statLife:"平均寿命", statInet:"ネット利用率",
      ...
      spType:"分類", 
      flat:"平面", globe:"地球儀", threeD:"⛰️ 3D", gridBtn:"🌐 グリッド", gridLayer:"🌐 グリッド・地名", lblTempUnit:"気温の単位", tempBoth:"°C + °F", tempC:"°Cのみ", tempF:"°Fのみ", measureMenuBtn:"計測", measureDistBtn:"📏 距離・面積", drawBtn:"✏️ 描画", vol3dBtn:"🧊 3D立体", radiusBtn:"⭕ 半径", objectsBtn:"🗂 オブジェクト", mScreenshot:"地図のスクリーンショット", shareMenuBtn:"共有", shareLinkBtn:"共有・リンク", layersBtn:"レイヤー ▾",
      ctxDropPin:"ピンを刺す", ctxMeasureFrom:"計測を開始", ctxPostHere:"コミュニティに投稿", ctxDistFrom:"直前ピンからの距離", ctxCopy:"座標をコピー", ctxClearPins:"全ピンを削除", ctxThisPoint:"この地点", coords:"座標", depth:"水深", climate:"気候区分", tlMachine:"Chronos", 
      lyrEEZ:"領海・EEZ", lyrShips:"船舶トラフィック(リアルタイム)", lyrPlanes:"航空トラフィック(リアルタイム)", lyrSats:"人工衛星(リアルタイム)", lyrThermal:"熱異常(火災)", planesZoomHint:"ズームインで航空機を表示", planesAreaHint:"ズームインで全域表示（現在は中央部のみ取得）", poiLabels:"施設・店舗・企業名", shipsZoomHint:"ズームインで船舶を表示", aisNoKey:"船舶の共有フィードが応答しませんでした。いまは表示できません。", aisOutsideCoverage:"この海域に船がいないのではなく、共有フィードがこの海域を見ていません。設定で aisstream.io のキーを入れると、全世界のライブ船舶が表示されます。", aisKeyLabel:"船舶トラフィック (AISstreamキー)", aisKeyHint:"任意です。キーが無くても共有フィードから船舶は表示されます。aisstream.io の無料キーを入れると、全球のライブ配信をこのブラウザが直接受け取り、少しだけ新しくなります。キーはこのブラウザにのみ保存されます。",
      filtCiv:"民間", filtMil:"軍用", filtAll:"全て", trafficFilter:"絞り込み", lyrTime:"レイヤー日付", thermWin24:"過去24時間", thermWin48:"過去48時間", thermWin72:"過去72時間",
      commAdd:"+ 新規投稿", commTitle:"タイトル", commBody:"考察・発見・疑問を投稿してください...", commPost:"投稿", commCancel:"キャンセル", commEmpty:"投稿はまだありません。「+ 新規投稿」をタップして議論を始めましょう。", commLocate:"地図で見る", commDelete:"削除", commReply:"返信", commWrite:"コメントを書く...", commPostNew:"新規投稿", commPlacedAt:"投稿位置", commSortHot:"話題", commSortNew:"新着", commSortTop:"人気", commSearchPh:"投稿を検索…", commInView:"表示範囲", commCat:"カテゴリ", commCatAll:"すべて", commEdit:"編集", commEdited:"編集済み", commEditPost:"投稿を編集", commSaveEdit:"変更を保存", commNoMatch:"条件に一致する投稿がありません。", borders:"国境線", coastline:"海岸線・湖岸線", compare:"比較", compareEmpty:"行をタップして国を選び比較", coCompareEmpty:"行をタップして会社を選び比較", compareView:"比較を表示", compareClear:"クリア", back:"戻る", deletePin:"削除",
      ...
      aiTranslateTitles:"タイトルを翻訳", aiTransBusy:"翻訳中…", aiTransDone:"{n}件のタイトルを翻訳しました", aiTransNone:"すでにこの言語のタイトルです。",
      lblNewsLang:"ニュースの言語", newsLangUi:"現在の言語のみ", newsLangMulti:"全言語（タイトルを自動翻訳）", 
