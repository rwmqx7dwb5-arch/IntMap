...
,
  ...
  sourceUse: {
    ...
    "NASA/JPL Horizons — interplanetary spacecraft trajectories": "太空探索中的「探测器」族群（data/spacecraft.json）：17 具载具——航海家 1、2 号，先锋 10、11 号，新视野号，帕克太阳探测器，太阳轨道载具，朱诺号，JUICE，欧罗巴快船，露西号，赛姬号，贝皮可伦坡，隼鸟 2 号，OSIRIS-APEX，韦伯太空望远镜与盖亚。以日心 J2000 黄道坐标采样位置「与」速度，采样间隔依探测器而异（航海家 90 天、帕克 3 天），并在用户端以三次 Hermite 内插衔接，因此重建出的路径是还原而非以弦线近似。⚠ Horizons 的回应不带 CORS 标头，因此在建置时取得并随程序打包；⚠ 而且轨迹不是遥测数据——先锋 10、11 号分别于 2003 与 1995 年停止回应，盖亚已于 2025 年除役，所以为它们绘制的是外推位置，面板会明白说明。超出核心档宣告的涵盖范围时，程序会表明文件并不知道，而不是静静地重复最后一点。美国政府著作，不受著作权保护。以 scripts/build-spacecraft.mjs 重新产生。",
