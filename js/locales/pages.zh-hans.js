...
,
  ...
  sourceUse: {
    ...
    "IntMap war record (scripts/wars/)": "两次世界大战图层本身：哪一天由谁控制哪个国家、在有出处指明位置的日期上各条战线走在哪里，以及各项作战——出处有给出数字时，并附上常被引用的兵力与伤亡数。内容依文献记载逐条手写，再由一套「无法佐证就拒绝写出文件」的建置流程汇整为 data/wars.json，并在保存库中全文公开。战线两侧的面从不保存：它们是由战线本身从 CShapes 的国家轮廓上切出来的，因此线与颜色不可能互相矛盾。",
