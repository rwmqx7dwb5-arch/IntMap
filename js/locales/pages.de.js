...
window.IntMapPageI18N.define('de', {
  ...
  sourceUse: {
    ...
    "気象警報・注意報 — 気象庁 (Japan Meteorological Agency, bulletin list r8, by municipality)": "Live für die Warnebene gelesen: die Meldungsliste des JMA — der Stand ist die neueste Meldung je Amt, und Japan wird auf Gemeindeebene (class20) gezeichnet.",
    ...
    "行政区域データ（市区町村界）— 国土交通省 国土数値情報 N03 (via smartnews-smri/japan-topography)": "Japans Gemeindegrenzen aus den amtlichen Landesdaten des Ministeriums für Land. Die Warnebene schlüsselt sie über den JIS-Code — die ersten fünf Ziffern eines JMA-class20-Codes.",
    "Weather warnings, United States — NOAA National Weather Service (api.weather.gov, CAP)": "Live gelesen: alle derzeit geltenden Warnungen des US-Wetterdienstes mit eigenen Polygonen, im Tap nach Bundesstaat. Direkt vom Browser abgerufen.",
