    ...
    sections: [
      ...
      },
      {
        ...
        blocks: [
          ...
          ['eq', 'w<sub>i</sub> &prop; (&Delta;z<sub>i</sub> / L<sub>i</sub>)<sup>1.1</sup> &times; C<sub>i</sub> &nbsp;&nbsp; C = 0,5&Delta; (Seite) / 0,354&Delta; (Ecke)'],
          ...
          ['eq', 'A(s) = C / &radic;S(s) &nbsp;&nbsp; mit C = Q/K &nbsp;oder&nbsp; V / &int;(ds/&radic;S), &nbsp; v = K&radic;S, K = 40'],
