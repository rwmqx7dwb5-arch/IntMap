...
window.IntMapPageI18N.define('de', {
  ...
  sourceUse: {
    ...
    'OpenStreetMap': 'Ortssuche und Umrisse von Orten/Regionen (Nominatim), der tatsächliche Lauf eines Flusses beim Klick auf seinen Namen (#R217) und die Basiskartendaten.',
    'NASA GIBS / Worldview': 'Temperatur, Niederschlag, Meeresoberflächentemperatur, Meereiskonzentration und SST-Anomalie, Schnee, Aerosol- und UV-Aerosolindex, Kohlenmonoxid, Bodenfeuchte, Chlorophyll im Meer, Brände, Vegetation (NDVI), Land- und Wolkenoberflächentemperatur, Echtfarben und Schummerung.',
    ...
    'REST Countries': 'Länderbasisdaten (Hauptstadt, Währung, Sprachen, Nachbarländer) für die Infoseite.',
    ...
    'Open-Meteo Marine': 'Stündlicher Meeresspiegel über MSL für die Gezeitenebene und — (#R216/#R218) — Geschwindigkeit und Richtung der Meeresströmung plus die Meeresoberflächentemperatur, aus denen die Ebene „Meeresströmungen“ ihre Stromlinien integriert und warm/kalt bestimmt (verglichen wird mit demselben Modell rund 110 km stromaufwärts).',
    ...
    'OpenStreetMap Overpass API': 'Atlas-Kartierung von Anlagen und POIs — Live-Abfragen benannter Anlagentypen in einem Gebiet (Öl, Kraftwerke, Flughäfen, Militär …); dazu die benannten Fluss-/Kanalwege um ein angeklicktes Flussetikett, wenn Nominatim für diesen Fluss nicht antworten kann (#R217) (ODbL).',
    ...
    'geoBoundaries': 'Verwaltungsgrenzen (ADM1) für Atlas-Regionszusammensetzungen — Ersatzquelle für Grenzen (CC BY 4.0).',
    'GDELT Project': 'Weltweite Live-Nachrichtensuche (letzte 72 Std.) hinter Atlas-Briefings und der integrierten Analyse.',
    'Market data (fxratesapi / ER-API · gold-api · CoinGecko · alternative.me)': 'Wechselkurse, Gold und Silber, Kryptopreise und Stimmungsindizes — Widgets und die Laufleiste am unteren Rand.',
    ...
    "Diplomatic missions — OpenStreetMap (amenity=embassy / office=diplomatic, Overpass API)": "Botschaften, Konsulate und andere diplomatische Vertretungen aus OpenStreetMap, live für den aktuellen Kartenausschnitt abgefragt (ODbL). Jeder Punkt zeigt die Tags des Objekts selbst und verlinkt darauf; nichts wird abgeleitet",
    ...
    "Spaceports & satellite ground stations — OpenStreetMap (aeroway=spaceport, man_made=launch_pad/satellite_dish, Overpass API)": "Startrampen, Raumfahrtbahnhöfe, Satelliten-Bodenstationen und Radioteleskope aus OpenStreetMap, live für den aktuellen Ausschnitt (ODbL)",
    ...
    'UNDP / EIU / SIPRI / World Bank': 'HDI, Demokratieindex, BIP, Militärausgaben, Demografie.',
    'AISstream.io': 'Live-AIS-Schiffsverkehr (Ihr Schlüssel).',
    'airplanes.live': 'Live-Flugverkehr (Community-ADS-B; liefert auch das Vorschaubild der Flugzeugebene).',
    ...
    'Smithsonian GVP': 'Vulkane des Holozäns.',
    'DeepStateMap': 'Frontlinie in der Ukraine (Beta-Ebene).',
    'historical-basemaps (aourednik)': 'Historische Grenzen — die Beta-Overlay-Ebene und der automatische Ersatz für die Grenzen vergangener Jahre der Karte selbst (nächstgelegene Momentaufnahme).',
    'CShapes 2.0 (Schvitz et al., ETH Zürich)': 'Jährliche Staatsgrenzen 1886–2019 für die Zeitmaschine (jede Grenzänderung auf das Jahr datiert; vereinfachte, selbst gehostete Kopie). Die Grenzen Ost-/West-/vereintes Deutschland 1945–2019 wurden aus den maßgeblichen heutigen Bundesländern neu aufgebaut (deutschlandGeoJSON, © GeoBasis-DE / BKG), damit die innerdeutsche Grenze der Wirklichkeit entspricht.',
    'Maddison Project Database 2020 (Bolt & van Zanden)': 'Maßgebliches HISTORISCHES reales BIP (konstante internationale Dollar von 2011) und Bevölkerung zurück bis 1900 für die Zeitmaschine — der Länderreiter, die Choroplethen und der Ländervergleich, wenn man vor die Untergrenze der Weltbank (1960) reist, sowie für aufgelöste Staaten (die frühere UdSSR, Jugoslawien und die Tschechoslowakei sind eigenständige Maddison-Einheiten).',
