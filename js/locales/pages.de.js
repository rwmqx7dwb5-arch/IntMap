...
window.IntMapPageI18N.define('de', {
  ...
  sourceUse: {
    ...
    'Smithsonian GVP': 'Mit der Anwendung ausgeliefert (data/volcanoes_gvp.json und data/volcano-detail.json.gz, von scripts/build-volcanoes.mjs aus dem WFS des GVP erzeugt): der gesamte Holozän-Katalog mit seinem Verknüpfungsschlüssel und dahinter jeder Ausbruch, den das GVP für die Vulkane dieses Katalogs verzeichnet, mit VEI und Datum, dazu Vulkantyp, Landform, tektonische Lage und vorherrschendes Gestein, die geologische Zusammenfassung, das Foto und die Bevölkerung im Umkreis von 5, 10, 30 und 100 km. Alles, was die Vulkankarte über die Vergangenheit sagt, wird offline aus dieser Datei gelesen.',
    'DeepStateMap': 'Frontlinie in der Ukraine (Beta-Ebene).',
    'historical-basemaps (aourednik)': 'Historische Grenzen — die Beta-Overlay-Ebene, der automatische Ersatz für die Grenzen vergangener Jahre der Karte selbst (nächstgelegene Momentaufnahme) und unterhalb der CShapes-Untergrenze von 1886 die einzige vorhandene Grenzquelle. Das Ursprungs-Repository hat vor 1900 nur zwei Momentaufnahmen (1815 und 1880), daher wird jedes Jahr von 1850 bis 1885 mit den Grenzen von 1880 gezeichnet.',
