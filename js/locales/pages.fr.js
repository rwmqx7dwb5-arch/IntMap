...
,
  ...
  sourceUse: {
    ...
    "OpenStreetMap": "Recherche de lieux et contours de lieux/régions (Nominatim), le tracé réel d'un cours d'eau lorsqu'on clique sur son nom sur la carte (#R217), et les données du fond de carte",
    ...
    "気象庁「計測震度の算出方法」 (JMA instrumental seismic intensity)": "(#R192) Le shindo JMA que le simulateur affiche est calculé selon la définition propre de la JMA plutôt que converti depuis la PGV : les filtres d'effet de période, coupe-haut à 10 Hz et coupe-bas à 0,5 Hz sont appliqués au spectre d'accélération du modèle, le niveau a₀ dépassé pendant un TOTAL de 0,3 s est résolu par la théorie des vibrations aléatoires, et I = 2·log₁₀ a₀ + 0,94. Les trois composantes sont isotropisées à V/H = 2/3 plutôt que simulées séparément, ce que le panneau indique. Cela remplace la régression sur PGV de Fujimoto & Midorikawa (2005) utilisée jusqu'à #R191.",
    "Okada (1985) · Wells & Coppersmith (1994) · Atkinson & Silva (2000)": "(#R192) La déformation de surface en forme close d'Okada pour une dislocation rectangulaire donne le déplacement cosismique du plancher océanique dont part le modèle de propagation du tsunami (vérifiée sur le cas-test publié avant usage) ; la loi d'échelle de Wells & Coppersmith pour failles inverses donne la longueur, la largeur et le glissement de la rupture à partir de la magnitude ; et le spectre source à deux fréquences coin d'Atkinson & Silva a remplacé la fréquence coin unique de Brune dans la chaîne de mouvement du sol, qui sous-estimait les fréquences intermédiaires des grands séismes. (#R193) Le champ d'Okada est désormais sommé sur une grille de sous-failles 8 × 3 avec effilement, renormalisée pour que le moment sismique soit exactement celui qu'implique la magnitude.",
    "Kotani et al. (1998) — Manning roughness for tsunami run-up computation": "(#R193) Le coefficient de frottement de fond qu'utilise le modèle de propagation du tsunami (Manning n = 0,025 s·m^(−1/3) sur un fond océanique), la valeur avec laquelle les modèles japonais opérationnels d'ondes longues sont exécutés. Le frottement est négligeable en eau profonde (il varie comme la profondeur totale à la puissance −7/3) et c'est lui qui limite la vague sur un plateau continental : un modèle d'onde longue sans frottement surestime donc l'amplitude côtière.",
    ...
    "気象警報・注意報 — 気象庁 (Japan Meteorological Agency, bulletin list r8, by municipality)": "Lu en direct pour la couche d’alertes : la liste de bulletins de la JMA. L’état est le bulletin le plus récent par bureau, et le Japon est dessiné à la commune (class20).",
    ...
    "行政区域データ（市区町村界）— 国土交通省 国土数値情報 N03 (via smartnews-smri/japan-topography)": "Les limites communales du Japon, du ministère du Territoire. La couche d’alertes les relie par le code JIS — les cinq premiers chiffres d’un code class20 de la JMA.",
