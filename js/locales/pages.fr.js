...
,
  ...
  sourceUse: {
    ...
    "NASA GIBS / Worldview": "Température, précipitations, température de surface de la mer, concentration de glace de mer et anomalie de TSM, neige, indices d'aérosols et d'aérosols UV, monoxyde de carbone, humidité du sol, chlorophylle océanique, incendies, végétation (NDVI), température de surface et du sommet des nuages, couleurs naturelles et ombrage du relief",
    ...
    "Diplomatic missions — OpenStreetMap (amenity=embassy / office=diplomatic, Overpass API)": "Ambassades, consulats et autres missions diplomatiques d’OpenStreetMap, interrogés en direct pour la vue actuelle (ODbL). Chaque point affiche les étiquettes de l’objet et y renvoie ; rien n’est déduit",
    ...
    "Spaceports & satellite ground stations — OpenStreetMap (aeroway=spaceport, man_made=launch_pad/satellite_dish, Overpass API)": "Pas de tir, ports spatiaux, stations terriennes et radiotélescopes d’OpenStreetMap, en direct pour la vue actuelle (ODbL)",
