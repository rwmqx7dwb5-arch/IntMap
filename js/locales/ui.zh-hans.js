...
,
  ...
  /* (#R570) js/outbreaks.js — the WHO Disease Outbreak News layer. «Disease Outbreak News» is
     the name of a WHO publication, so it stays in the original. */
  "No outline on this map for": "此地图没有轮廓的国家：",   /* outbreaks.js (#R570) */
  "Time window": "期间",   /* outbreaks.js (#R570) */
  "1 year": "1 年",   /* outbreaks.js (#R570) */
  "5 years": "5 年",   /* outbreaks.js (#R570) */
  "90 days": "90 天",   /* outbreaks.js (#R570) */
  "all pathogens": "所有病原体",   /* outbreaks.js (#R570) */
  "Archive built": "存档建立于",   /* outbreaks.js (#R570) */
  "cases": "病例",   /* outbreaks.js (#R570) */
  "checked WHO for newer items": "已向 WHO 查询较新的公告",   /* outbreaks.js (#R570) */
  "Circle size = WHO notes in the window · colour = how recent the newest is.": "圆的大小＝期间内的 WHO 公告数 · 颜色＝最新一则有多新。",   /* outbreaks.js (#R570) */
  "Closed the outbreak layer.": "已关闭疾病爆发图层。",   /* outbreaks.js (#R570) */
  "could not check WHO for newer items": "无法向 WHO 查询较新的公告",   /* outbreaks.js (#R570) */
  "Could not load the outbreak archive.": "无法加载疾病爆发存档。",   /* outbreaks.js (#R570) */
  "Could not load the WHO outbreak archive.": "无法加载 WHO 的疾病爆发存档。",   /* outbreaks.js (#R570) */
  "Countries drawn": "已绘制的国家",   /* outbreaks.js (#R570) */
  "countries on the map": "个国家在地图上",   /* outbreaks.js (#R570) */
  "deaths": "死亡",   /* outbreaks.js (#R570) */
  "Disease outbreaks (WHO)": "疾病爆发（WHO）",   /* outbreaks.js (#R570) */
  "Everything up to this date": "到这一天为止的全部",   /* outbreaks.js (#R570) */
  "listed, not placed": "仅列于列表，未标于地图",   /* outbreaks.js (#R570) */
  "Most notes": "最多",   /* outbreaks.js (#R570) */
  "not extracted yet": "尚未撷取",   /* outbreaks.js (#R570) */
  "Not one country": "非单一国家",   /* outbreaks.js (#R570) */
  "not stated by WHO": "WHO 未载明",   /* outbreaks.js (#R570) */
  "Outbreak": "发生日",   /* outbreaks.js (#R570) */
  "Pathogen": "病原体",   /* outbreaks.js (#R570) */
  "Read the WHO item": "阅读 WHO 原文",   /* outbreaks.js (#R570) */
  "Reported": "通报数",   /* outbreaks.js (#R570) */
  "Source: WHO Disease Outbreak News": "来源：WHO Disease Outbreak News（世界卫生组织）",   /* outbreaks.js (#R570) */
  "Tap a circle for the items behind it.": "点按圆圈，即可看到其中的项目。",   /* outbreaks.js (#R570) */
  "WHO note": "WHO 公告",   /* outbreaks.js (#R570) */
  "WHO notes": "WHO 公告",   /* outbreaks.js (#R570) */
  "WHO published no Disease Outbreak News about that in this window.": "在这段期间内，WHO 没有就此发布 Disease Outbreak News。",   /* outbreaks.js (#R570) */
  "WHO published no Disease Outbreak News in this window.": "在这段期间内，WHO 没有发布 Disease Outbreak News。",   /* outbreaks.js (#R570) */
  "WHO published these about a region or the whole world, so they are listed and not placed.": "这些是 WHO 就某个区域或整个世界发布的，因此只列于列表，不标在地图上。",   /* outbreaks.js (#R570) */
  "Window ending": "期间结束于",   /* outbreaks.js (#R570) */
