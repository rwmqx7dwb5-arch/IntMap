...
window.IntMapLang.define('zh-hans', {
  ...
  ui: {
    ...
    "lyrGrpEconomy":"经济与贸易",   /* (#R259) */
    "lyrGrpSociety":"社会与教育",   /* (#R259) */
    "lyrGrpTransport":"交通与运输",   /* (#R259) */
    "lyrGrpAgri":"农业与粮食",   /* (#R259) */
    "lyrGrpHazard":"灾害与夜空",
    "lyrGrpIndic":"指标与叠图",
...
,
  ...
  inline: {
    ...
    "across": "／",   /* (#R259) */
    "Airport / airfield": "机场／飞行场",   /* (#R259) */
    "Airports & air infrastructure": "机场与航空设施",   /* (#R259) */
    "Airports, airfields, terminals, heliports and control towers mapped in OpenStreetMap for the current view. Click any point for its ICAO/IATA code, runway length and operator where the object carries them.": "目前显示范围内 OpenStreetMap 收录的机场、飞行场、航厦、直升机坪与塔台。点击任一点可查看 ICAO/IATA 代码、跑道长度与营运者（限该对象本身具备者）。",   /* (#R259) */
    "Ambulance station": "救护站",   /* (#R259) */
    "Battery, clearance and no-fly zones over the real terrain": "在真实地形上解算电池、离地高度与禁航区",   /* (#R259) */
    "Cancel — click the new site": "取消（点击新地点）",   /* (#R259) */
    "Capacity": "处理能力",   /* (#R259) */
    "Cargo / container terminal": "货柜／货运码头",   /* (#R259) */
    "Change the values and press Analyze to re-run at this site; “Move the site…” puts it somewhere else.": "变更数值后按「分析」可重算同一地点；「变更地点…」可移到别处。",   /* (#R259) */
    "Cleared. Press Analyze to re-run here, or “Move the site…” to place it somewhere else.": "已清除。按「分析」重算，或用「变更地点…」放到别处。",   /* (#R259) */
    "College": "学院",   /* (#R259) */
    "continuous": "持续",   /* (#R259) */
    "continuous (▶ pours these)": "持续（▶ 注水的是这些）",   /* (#R259) */
    "Control tower": "塔台",   /* (#R259) */
    "Counts and capacity are for what is on screen. A capacity is shown only where the operator or OpenStreetMap publishes one — nothing here is estimated. Tap a class to take it off the map.": "件数与容量为画面可见范围的统计。容量仅在营运者或 OpenStreetMap 公布时显示，绝不估算。点击分类可将该类自地图移除。",   /* (#R259) */
    "Crane": "装卸起重机",   /* (#R259) */
    "curated": "收录",   /* (#R259) */
    "Data centers & AI infrastructure": "数据中心与 AI 基础设施",   /* (#R259) */
    "Dish diameter": "天线直径",   /* (#R259) */
    "Drone flight planner": "无人机飞行规划",   /* (#R259) */
    "Earth replay (sun over time)": "地球回放（太阳运行）",   /* (#R259) */
    "Emergency services": "紧急应变据点（消防、警察、救护）",   /* (#R259) */
    "Ferry terminal": "渡轮码头",   /* (#R259) */
    "Fire station": "消防队",   /* (#R259) */
    "Fire stations, police stations, ambulance stations and mountain-rescue posts mapped in OpenStreetMap for the current view — how far help has to come from, which no national statistic answers.": "目前显示范围内 OpenStreetMap 收录的消防队、警察局、救护站与山难救助据点。「救援从哪里来」是国家统计答不出来的事。",   /* (#R259) */
    "Flood & tsunami hazard": "淹水与海啸风险",   /* (#R259) */
    "Harbour type": "港口类别",   /* (#R259) */
    "How far the timetable takes you, not the road": "能到多远取决于时刻表，而非道路",   /* (#R259) */
    "IATA code": "IATA 代码",   /* (#R259) */
    "ICAO code": "ICAO 代码",   /* (#R259) */
    "International airport": "国际机场",   /* (#R259) */
    "Largest published capacity in view": "显示范围内公布容量由大到小",   /* (#R259) */
    "Launch pad": "发射台",   /* (#R259) */
    "Launch pads, spaceports, satellite ground stations and radio telescopes mapped in OpenStreetMap for the current view — the ground half of everything the orbit layers show overhead.": "目前显示范围内 OpenStreetMap 收录的发射台、太空基地、卫星地面站与电波望远镜——轨道图层在头顶描绘之物的地面另一半。",   /* (#R259) */
    "Move the site…": "变更地点…",   /* (#R259) */
    "Next source": "下一个水源",   /* (#R259) */
    "No site in view publishes a capacity figure.": "显示范围内没有公布容量的设施。",   /* (#R259) */
    "Observatory": "天文台／观测站",   /* (#R259) */
    "of": "／全",   /* (#R259) */
    "On the map": "已配置",   /* (#R259) */
    "one shot": "单次",   /* (#R259) */
    "Only one-shot volumes are placed — add a continuous source to pour": "目前只放了单次水量，加入持续水源后才能注水",   /* (#R259) */
    "Police station": "警察局",   /* (#R259) */
    "Port / harbour": "港湾",   /* (#R259) */
    "Ports, harbours & terminals": "港湾与码头",   /* (#R259) */
    "Ports, harbours, ferry terminals, container and cargo terminals and cranes mapped in OpenStreetMap for the current view — where cargo physically changes vehicle.": "目前显示范围内 OpenStreetMap 收录的港湾、渔港、渡轮码头、货柜／货运码头与装卸起重机——货物实际换载的地方。",   /* (#R259) */
    "published capacity": "公布容量",   /* (#R259) */
    "Pumping station": "抽水站",   /* (#R259) */
    "Radio telescope": "电波望远镜",   /* (#R259) */
    "Rescue post": "救助据点",   /* (#R259) */
    "Research institute": "研究机构",   /* (#R259) */
    "Run the day and night round the planet": "让昼夜在地球上运行",   /* (#R259) */
    "Runway length": "跑道长度",   /* (#R259) */
    "Satellite ground station": "卫星地面站",   /* (#R259) */
    "Signal strength from a transmitter placed here": "此处发射机的收讯强度",   /* (#R259) */
    "sites in view": "件（显示范围内）",   /* (#R259) */
    "Spaceports & ground stations": "太空基地与地面站",   /* (#R259) */
    "Students": "学生人数",   /* (#R259) */
    "Substance": "处理对象",   /* (#R259) */
    "Terminal": "航厦",   /* (#R259) */
    "Transit reachability": "大众运输可达范围",   /* (#R259) */
    "Universities & research institutes": "大学与研究机构",   /* (#R259) */
    "Universities, colleges, research institutes, observatories and libraries mapped in OpenStreetMap for the current view — where teaching and research actually happen, beside the enrolment percentages.": "目前显示范围内 OpenStreetMap 收录的大学、学院、研究机构、天文台与图书馆——在就学率的数字旁，放上教学与研究实际发生的地方。",   /* (#R259) */
    "University": "大学",   /* (#R259) */
    "Wastewater treatment": "污水处理厂",   /* (#R259) */
    "Water & wastewater plant": "自来水与污水设施",   /* (#R259) */
    "Water tower / reservoir": "水塔／配水池",   /* (#R259) */
    "Water works": "净水场",   /* (#R259) */
    "Water works, wastewater treatment plants, pumping stations, water towers and reservoirs mapped in OpenStreetMap for the current view — the plant that makes safe water and sanitation real in a place, rather than the national percentage.": "目前显示范围内 OpenStreetMap 收录的净水场、污水处理厂、抽水站、水塔与配水池——不是各国普及率，而是让当地自来水与污水处理真正运作的设施本身。",   /* (#R259) */
    "What a given water level reaches from here": "某一水位从这里能淹到哪里",   /* (#R259) */
