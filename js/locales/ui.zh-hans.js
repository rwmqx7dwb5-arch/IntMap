...
window.IntMapLang.define('zh-hans', {
  ...
  inline: {
    ...
    'Tell me a start and destination — e.g. "directions from Tokyo to Osaka" or "电车で新宿から横浜".': "请告诉我起点与目的地 — 例如「东京到大阪的路线」或「电车で新宿から横浜」。",   /* atlas-console.js */
