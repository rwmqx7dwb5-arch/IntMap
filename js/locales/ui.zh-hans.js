...
,
  ...
  "UI / display": "界面／显示",
  "Aerosol optical depth — how much haze, smoke and dust dim sunlight in the air column.": "气溶胶光学厚度 — 大气中的霾、烟与塵埃遮蔽阳光的程度。",
  "Aerospace & Defense": "航太与国防",
  "Altitude limit": "高度上限",
  "Annual consumer-price inflation (%) — how fast prices are rising.": "年度消费者物价通膨率（%）— 物价上漲的速度。",
  ...
  "Australia & New Zealand": "澳洲与紐西蘭",
  "Average number of children a woman would have over her lifetime; about 2.1 keeps a population stable.": "婦女一生平均生育子女数；约 2.1 可维持人口稳定。",
  ...
  "Buddhism": "佛教",
  "Carbon-dioxide emissions per person per year (tonnes) — a country’s per-capita climate footprint.": "人均年二氧化碳排放量（公噸）— 每人的气候足迹。",
  "Caribbean": "加勒比地区",
  "Christianity": "基督宗教",
  "Climb rate": "爬升率",
  ...
  "Cool short summer — 1–3 months > 10 °C": "夏季短涼 — 高于 10 °C 者 1～3 个月",
  "Corruption (control, WGI)": "貪腐控制（WGI）",
  "Crosswind": "侧风",
  "Cruise power draw": "巡航耗电",
  "Cruise speed": "巡航速度",
  "Currency": "货币",
  "Deaths before age 5 per 1,000 live births.": "每千名活产中未满 5 歲死亡数。",
  "Defense budget as a share of the country’s GDP — its military burden on the economy.": "国防预算占 GDP 的比重 — 经济承擔的军事负擔。",
  "Descent rate": "下降率",
  "Desert (true arid)": "沙漠（真正干燥）",
  "Distinct ecological regions (WWF/RESOLVE) grouping similar species, climate and habitat.": "依相似物种、气候与棲地划分的生态区（WWF/RESOLVE）。",
  ...
  "EIU score (0–10) of elections, pluralism, civil liberties and governance. Higher = more democratic.": "EIU 对选舉、多元、公民自由与治理的评分（0～10）。愈高愈民主。",
  ...
  "EU members": "欧盟成员国",
  "Europe": "欧洲",
  "Exclusive Economic Zone — the sea a country controls for fishing & resources, out to 200 nautical miles.": "专属经济海域 — 国家可管理漁业与资源的海域，自岸起 200 海里。",
  "Female labor force %": "女性勞动参与率 %",
  "Financials": "金融",
  "Fiscal & trade": "財政与贸易",
  ...
  "Indonesian": "印尼语",
  "Industrials": "工业",
  "Infant deaths before age 1 per 1,000 live births — a core health/development indicator.": "每千名活产中未满 1 歲死亡数 — 核心健康与发展指标。",
  ...
  "Share of people living on less than ~$2.15 a day (extreme poverty).": "每日生活费低于约 2.15 美元的人口比例（极端貧窮）。",
  ...
  "Submarine fiber-optic cables carrying almost all intercontinental internet traffic.": "承载几乎所有洲际网络流量的海底光纖电缆。",
  "Technology": "科技",
  "Telecom": "电信",
  "Temperate — coldest month 0–18 °C": "温带 — 最冷月 0～18 °C",
  "Terrain": "地形",
  "Total annual defense budget in US$ billions.": "年度国防预算总额（十亿美元）。",
  "Transparency International score (0–100) of perceived public-sector corruption. Higher = cleaner.": "国际透明组織的公部门貪腐印象指数（0～100）。愈高愈清廉。",
  ...
  "No share-price history (snapshot figure only).": "无股价历史（仅有單点数值）。",
  "P/E ratio": "本益比",
  ...
  "JMA 7 (Kurihara, Miyagi)": "JMA 7（宮城县栗原）",
  ...
  "MMI XI (Anchorage · Valdez · Seward)": "MMI XI（安克拉治 · 瓦尔迪茲 · 蘇厄德）",
  "The second-largest earthquake ever instrumentally recorded.": "有仪器纪录以来第二大的地震。",
  "2004 Sumatra–Andaman (Indian Ocean)": "2004 蘇门答臘–安达曼（印度洋）",
  ...
  "The rupture ran ~300 km northeast along the Longmenshan thrust — strongly unilateral.": "破裂沿龍门山逆冲断层向东北延伸约 300 公里，具强烈單向性。",
  "2010 Haiti (Léogâne)": "2010 海地（萊奥甘）",
  "MMI IX (Port-au-Prince · Léogâne)": "MMI IX（太子港 · 萊奥甘）",
  ...
  "JMA 7 (Shika, Ishikawa); MMI IX": "JMA 7（石川县志賀町）；MMI IX",
  "A reverse-fault rupture on the peninsula’s north coast that lifted the coastline out of the sea — the ground itself rose, so several fishing harbours were left dry.": "半岛北岸的逆断层破裂使海岸线抬升出海面——地盘本身上升，数个漁港因而干涸。",
  "Light (< 7 t)": "轻型（< 7 噸）",
  ...
  "Parachutist": "跳傘者",
  "Ultralight / paraglider": "超轻型／飞行傘",
  "Unmanned aircraft": "无人航空器",
  "Space / trans-atmospheric": "太空／跨大气层飞行器",
  "Surface — emergency vehicle": "地面车輛（紧急）",
  "Surface — service vehicle": "地面车輛（勤务）",
  "Point obstacle": "点状障碍物",
  "Earth": "地球",
  "Pluto": "冥王星",
  "Ukraine frontline (DeepState)": "烏克蘭前线（DeepState）",
  "Ukraine frontline (live)": "烏克蘭前线（实时）",
