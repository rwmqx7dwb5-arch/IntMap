  ...
  ui: {
   ...
   "lyrContours":"等高线",
    ...
    "wsHint":"新闻、国家、地图、图层与 Atlas 各自成为独立窗口，可自由移动、调整大小、收合与堆叠。你的版面配置会被保存。",
      ...
      lyrEEZ:"专属经济海域／12海里", lyrShips:"实时船舶动态", lyrPlanes:"实时航班动态", lyrSats:"实时卫星", lyrThermal:"热异常（火点）", planesZoomHint:"放大以加载实时航班", planesAreaHint:"请放大 — 实时航班只涵盖画面中央区域", poiLabels:"地点、商家与设施", shipsZoomHint:"放大以加载实时船舶", aisNoKey:"实时船舶暂时无法显示 — 共用数据来源没有回应。", aisOutsideCoverage:"共用数据来源未涵盖这片海域 — 不是这里没有船，而是数据范围不到。在设置中填入你自己的 aisstream.io 密钥，即可看到全世界。", aisKeyLabel:"实时船舶动态（AISstream 密钥）", aisKeyHint:"选填。没有密钥也能从共用数据来源看到实时船舶。填入 aisstream.io 的免费密钥后，这个浏览器会直接接收全球实时串流，稍微更新一些。密钥仅保存在这个浏览器中。",
...
,
  ...
  "This is a Shapefile, but the module that reads it could not be loaded": "这是 Shapefile，但无法加载读取它的模块",   /* map-ui.js (#R576 → key restated #R738) */
  ...
  "International spread is weighted by population, land borders and airport capacity — not by flight routes or passenger numbers.": "国际传播的权重依人口、陆地边界与机场规模计算，而非依航线或旅客人数。",   /* playground.js (#R666) */
  "International spread is weighted by population and distance only — the border and airport tables did not load.": "国际传播的权重仅依人口与距离计算——边界与机场数据未能加载。",   /* playground.js (#R666) */
  ...
  /* js/elections.js — National elections (#R588) */
  "National elections": "议会选举",
  "Country or territory": "国家或地区",
  "Seats": "议席",
  "Share of the vote": "得票率",
  "district": "选区",
  "list": "政党名单",
  "Parties with no seat": "未取得议席的政党",
  "No result is recorded for this district.": "此选区没有记录的结果。",
  "The record does not carry a vote count for this district.": "记录中没有此选区的得票数。",
  "Colour = the party that won the district. The bars are the whole chamber, including the seats this map does not draw.": "颜色代表在该选区胜出的政党。条形图显示整个议会的组成，包括本地图未绘出的议席。",
  "No constituency boundaries have been published for this election, so the map stays empty. The chamber below is the recorded result.": "这次选举没有公布选区界线，因此地图维持空白。下方的议席是记录的结果。",
  "Day length": "昼长",
  "Map scale": "地图比例尺",
  "Calendar": "行事历",
  "Next new moon": "下一次新月",
  ...
  "source records": "笔原始记录",
  "are a place in its own right": "笔本身即为一个地点",
  "Records that GeoNames marks as a section of another place, or as historical, abandoned or destroyed, are not counted as a place": "GeoNames 标示为其他地点的一部分，或标示为历史上的、已废弃、已毁坏的记录，不计为地点",
  "a field of the source record, copied": "直接抄自来源记录字段的值",
  "Record type": "记录类型",
  "a grid sampled at this row coordinate": "在此坐标读取网格得到的值",
  "measured here from the published geometry": "依已发布的几何数据在此测得的值",
  "requested from the endpoint for this row": "为此列向端点查询取得的值",
  "looked up through the country this row is in": "以此列所属国家查得的值",
  ...
  "Advanced": "高级设置",
  "Base fatality": "基准致死率",
  "cumulative infections": "累计感染",
  "Global health emergency threshold reached — international spread is sustained.": "已达到国际公共卫生紧急事件门槛 — 国际间传播持续扩大。",
  "Immunity wanes": "免疫力会衰退",
  "Infected, not yet infectious": "已感染、尚未具传染性",
  "Infectious now": "目前具传染性",
  "Initial cases": "初始病例数",
  "Initial immunity": "初始免疫",
  "International spread is weighted by population, distance and airport capacity. The land-border table did not load.": "国际传播依人口、距离与机场运量加权。陆上边界数据未能加载。",
  "International spread is weighted by population, distance and land borders. The airport table did not load.": "国际传播依人口、距离与陆上边界加权。机场数据未能加载。",
  "Latent (d)": "潜隐期(日)",
  "Lifelong immunity": "终身免疫",
  "Loading the border and airport tables — the outbreak starts once the world is fixed.": "正在加载边界与机场数据——世界确定后才会开始爆发。",
  "No response": "无防疫措施",
  "Nobody is immune, and no vaccine or treatment exists yet.": "没有人具备免疫力，也还没有疫苗或治疗方法。",
  "Novel pathogen": "新型病原体",
  "Protected by vaccine now": "目前受疫苗保护",
  "Seasonality": "季节性",
  "Seed": "随机种子",
  "Seed an outbreak and watch a stochastic SEIR model carry it between real countries — vaccines, variants and lockdowns included.": "设置疫情起点，观看随机 SEIR 模型如何在真实国家之间扩散 — 含疫苗、变异株与封锁。",
  "Start month": "起始月份",
  "Strong": "严格防疫",
  "This figure is a case fatality ratio (deaths per detected case), but the model applies it to every infection — including undetected ones. Treat it as an assumed severity, not as an observed one.": "这个数字是病死率（每一名确诊病例的死亡数），但模型会把它应用到所有感染——包括未被侦测到的感染。请将它视为假设的严重程度，而非观测到的严重程度。",
  "Today's world": "现今世界",
  "Travel": "人员流动",
  "Uses the vaccines and treatments this disease really has in 2026, plus an ASSUMED level of starting immunity — one figure applied to every country and age.": "使用 2026 年这种疾病实际拥有的疫苗与治疗方法，初始免疫则是「假设」的数值——所有国家、所有年龄都应用同一个比例。",
  ...
  "Network reachability (measurement probes)": "网络可达性（测量探针）",
  "Could not load the internet-health data": "无法加载互联网健康状态数据",
  "All signals": "所有信号",
  "below its own recent normal": "低于自身近期常态",
  "{p}% below its own recent normal — {s} ({l})": "较自身近期常态低 {p}%——{s}（{l}）",
  "{a} ASNs, {b} IPv4 and {c} IPv6 prefixes visible in RIPE routing data ({d})": "RIPE 路由数据中可见 {a} 个 ASN、{b} 个 IPv4 前缀与 {c} 个 IPv6 前缀（{d}）",
  "showing {n} of {t} probes that report «{s}»": "显示回报「{s}」的 {t} 个探针中的 {n} 个",
  "The readings arrived but the map could not draw them": "已取得观测值，但地图无法绘制",
  "{a} alerts, {b} drawn, {c} not placed": "警报 {a} 件、已绘制 {b} 件、未定位 {c} 件",
  "No outage alerts in the last three hours": "过去三小时内没有中断警报",
  "This source does not publish that scope": "此数据来源不发布该范围",
  "The source could not be reached — this is not an all-clear": "无法连接到数据来源——这不代表一切正常",
  "Cultural": "文化遗产",
  "Natural": "自然遗产",
  "Mixed": "复合遗产",
  "In danger": "濒危遗产",
  "World Heritage": "世界遗产",
  "World Heritage (UNESCO)": "世界遗产（UNESCO）",
  "World Heritage — every UNESCO property": "世界遗产 — UNESCO 列入名录的全部遗产",
  "Could not load the World Heritage list": "无法加载世界遗产名录",
  "Inscribed {y}": "{y}年列入名录",
  "UNESCO page": "UNESCO 说明页面",
  "On the List in Danger": "已列入濒危名录",
  "On the List in Danger since {y}": "自 {y} 年列入濒危名录",
  "On the List of World Heritage in Danger": "已列入《濒危世界遗产名录》",
  "On the List of World Heritage in Danger since {y}": "自 {y} 年列入《濒危世界遗产名录》",
  "{s} inscribed properties, drawn as {p} component parts. {d} are on the List in Danger.": "已列入名录的 {s} 项遗产，以 {p} 处构成资产绘出，其中 {d} 项列入濒危名录。",
  "UNESCO publishes no coordinate for {n} of them, so they are not on the map.": "其中 {n} 项 UNESCO 未公布坐标，因此并未出现在地图上。",
  "UNESCO publishes the List in English, French, Spanish, Russian, Arabic, Chinese and Japanese only, so the names here are in English.": "UNESCO 仅以英文、法文、西班牙文、俄文、阿拉伯文、中文与日文公布名录，因此这里显示英文名称。",
  "Say what to narrow the World Heritage layer to: a category, or the List in Danger.": "请指定要以什么筛选世界遗产图层：区分，或濒危名录。",
  "Categories are: {c}": "区分为：{c}",
  "{n} World Heritage points shown": "显示世界遗产 {n} 处地点",
  "Name a World Heritage property.": "请指定世界遗产的名称。",
  ...
  "Significant wave height, with the mean wave direction animated over it.": "有效波高，并在其上以动画显示平均波向。",
  "Colours follow Windy’s wave scale.": "配色依循 Windy 的波浪色阶。",
  "Wave animation": "海浪动画",
  "Could not load the wave forecast": "无法加载海浪预报",
  "This renderer cannot draw the wave layer.": "此算绘引擎无法绘制海浪图层。",
  "no wave data": "没有海浪数据",
  "not a wave model": "不是海浪模式",
  /* ══ (#R585) MEASURED RADIATION — the ambient gamma dose rate layer ══ */
  "Measured radiation": "实测辐射",   /* map-ui.js (#R585) */
  "Measured radiation — ambient gamma dose rate": "实测辐射 — 周围γ剂量当量率",   /* beta-overlays.js radiation-layer.js (#R585) */
  "stations": "个测站",   /* radiation-layer.js (#R585) */
  "unavailable: ": "无法取得：",   /* atlas-controls.js (#R585) */
  "Loading history…": "正在加载历史数据…",   /* radiation-layer.js (#R585) */
  "No history published for this station.": "此测站未公开历史数据。",   /* radiation-layer.js (#R585) */
  "Could not reach the networks.": "无法连接至监测网。",   /* radiation-layer.js (#R585) */
  "Radiation measurements are unavailable right now.": "目前无法取得辐射实测值。",   /* beta-overlays.js (#R585) */
  "{n} stations within {k} km": "{k} 公里内 {n} 个测站",   /* atlas-controls.js (#R585) */
  "No monitoring station within {k} km publishes an open-licensed reading. That is a gap in coverage, not a statement about the radiation there.": "{k} 公里内没有任何监测站以开放授权公开量测值。这是监测网的覆盖空白，并非对当地辐射量的陈述。",   /* atlas-controls.js (#R585) */
  "Measured radiation on — {n} stations from {m} networks": "已开启实测辐射 — 来自 {m} 个监测网的 {n} 个测站",   /* atlas-controls.js (#R585) */
  "Measured radiation layer off.": "已关闭实测辐射图层。",   /* atlas-controls.js (#R585) */
  "Give a coordinate to measure around.": "请指定作为测量中心的坐标。",   /* atlas-controls.js (#R585) */
  "50–200 nSv/h is normal natural background almost everywhere. Rain alone can lift a station up to three times higher for a few hours, and most of these readings are published unvalidated — so one high station is not evidence of a release.": "50–200 nSv/h 在几乎所有地方都是正常的天然背景辐射。单是降雨就可能让某个测站的读数在数小时内升高到三倍，而且这些数值多半未经验证即予公开 — 因此单一测站数值偏高并不能证明发生了放射性物质释放。",   /* radiation-layer.js (#R585) */
  "{n} more stations publish a period average, not a current reading — set the clock to their year to see them.": "另有 {n} 个测站公布的是期间平均值，而非目前的量测值 — 将时钟调到该年份即可显示。",   /* radiation-layer.js (#R585) */
  "below this detector’s stated range": "低于此侦测器标示的量测范围",   /* radiation-layer.js (#R585) */
  "published average for a period — not a current reading": "公布的期间平均值 — 并非目前的量测值",   /* radiation-layer.js (#R585) */
  "still loading one network…": "仍在加载其中一个观测网…",   /* radiation-layer.js (#R585) */
  "Measured right now near the source": "目前在释放源附近的实测值",   /* atlas-console.js (#R585) */
  "That name also matches {o}; this run uses {u}.": "这个名称也符合 {o}；本次执行使用的是 {u}。",   /* atlas-console.js (#R585) */
  "These are observations, not part of the model above. 50–200 nSv/h is ordinary natural background, and rain alone can treble a station for a few hours.": "这些是观测值，并非上述模型的一部分。50–200 nSv/h 属于一般的天然背景辐射，单是降雨就可能让某个测站的数值在数小时内变为三倍。",   /* atlas-console.js (#R585) */
  "{c} approves a vaccine — rollout begins.": "{c} 核准疫苗——开始接种。",   /* playground.js (#R675) */
  "{c} enters lockdown.": "{c} 进入封锁。",   /* playground.js (#R675) */
  "{c} lifts its entry restrictions.": "{c} 解除入境限制。",   /* playground.js (#R675) */
  "{c} raises entry restrictions to their highest level.": "{c} 将入境限制提高到最高等级。",   /* playground.js (#R675) */
  "{n} mapped units with no measured population are not simulated.": "有 {n} 个地图单位没有实测人口，未纳入模拟。",   /* playground.js (#R675) */
  "Cases": "病例",   /* playground.js (#R675) */
  "Countries and territories reached": "曾波及的国家与地区",   /* playground.js (#R675) */
  "Countries and territories with cases now": "目前有病例的国家与地区",   /* playground.js (#R675) */
  "Day of the peak": "高峰日",   /* playground.js (#R675) */
  "deaths/day, peak": "每日死亡数，高峰",   /* playground.js (#R675) */
  "Disease": "疾病",   /* playground.js (#R675) */
  "Dominant variant": "主流变异株",   /* playground.js (#R675) */
  "Each curve is scaled to its own peak, so their shapes can be compared but their heights cannot.": "每条曲线都以各自的高峰标准化，因此可比较形状，但不能比较高度。",   /* playground.js (#R675) */
  "entry restricted": "入境受限",   /* playground.js (#R675) */
  "Entry rules": "入境规定",   /* playground.js (#R675) */
  "Entry rules and lockdowns are decided by governments: {a} places follow the government of another, and {b} have none recorded and make no policy of their own.": "入境规定与封锁由政府决定：{a} 个地方依循其他政府的决定，{b} 个没有记录到政府，不制定自己的政策。",   /* playground.js (#R675) */
  "Entry rules and lockdowns here are decided by {c}.": "此地的入境规定与封锁由 {c} 决定。",   /* playground.js (#R675) */
  "Event log": "事件纪录",   /* playground.js (#R675) */
  "Events in this run": "本次执行的事件",   /* playground.js (#R675) */
  "ever reached": "累计波及",   /* playground.js (#R675) */
  "Every mapped unit sets its own entry rules in this run — the table of governments did not load.": "本次执行中，每个地图单位各自定义定入境规定——政府对照表未能加载。",   /* playground.js (#R675) */
  "First case arrived": "首例出现",   /* playground.js (#R675) */
  "governments restricting entry": "实施入境限制的政府",   /* playground.js (#R675) */
  "highest restrictions": "最高等级限制",   /* playground.js (#R675) */
  "Hospital pressure": "医疗负荷",   /* playground.js (#R675) */
  "How much of this is chance?": "这个结果有多少是偶然？",   /* playground.js (#R675) */
  "Immune (recovered)": "具免疫力（已康复）",   /* playground.js (#R675) */
  "in lockdown": "封锁中",   /* playground.js (#R675) */
  "Lockdown": "封锁",   /* playground.js (#R675) */
  "median, then the 10th to 90th percentile, over {n} runs": "中位数，以及第 10 至第 90 百分位数，共 {n} 次执行",   /* playground.js (#R675) */
  "Never left the first country": "从未离开最初的国家",   /* playground.js (#R675) */
  "new infections/day, peak": "每日新增感染，高峰",   /* playground.js (#R675) */
  "New variant ({g}) detected in {c} — more transmissible. It is only there, for now.": "在 {c} 侦测到新变异株（{g}）——传播力更强。目前仅出现在当地。",   /* playground.js (#R675) */
  "New variant ({g}) detected in {c}. It is only there, for now.": "在 {c} 侦测到新变异株（{g}）。目前仅出现在当地。",   /* playground.js (#R675) */
  "No seat of government is recorded here, so this place makes no policy of its own in the model.": "此地未记录政府所在地，因此在模型中不会自行制定政策。",   /* playground.js (#R675) */
  "none yet": "尚未出现",   /* playground.js (#R675) */
  "Older entries are not shown.": "更早的纪录不予显示。",   /* playground.js (#R675) */
  "open": "无限制",   /* playground.js (#R675) */
  "original": "原始病原体",   /* playground.js (#R675) */
  "Outbreak has reached 10 countries and territories.": "疫情已扩散至 10 个国家与地区。",   /* playground.js (#R675) */
  "Peak infectious": "具传染性人数的高峰",   /* playground.js (#R675) */
  "R₀ here (with variants)": "此地的 R₀（含变异株）",   /* playground.js (#R675) */
  "Rₑ (effective)": "Rₑ（有效再生数）",   /* playground.js (#R675) */
  "Rₑ = R₀ × season ({s}) × behaviour and lockdown ({b}) × susceptible share ({u})": "Rₑ = R₀ × 季节（{s}）× 行为与封锁（{b}）× 易感人口比例（{u}）",   /* playground.js (#R675) */
  "Ran its course and ended": "疫情完整流行后结束",   /* playground.js (#R675) */
  "Response": "应对",   /* playground.js (#R675) */
  "ring = entry restrictions (yellow → orange → red), blue core = lockdown": "外环＝入境限制（黄 → 橙 → 红），蓝色核心＝封锁",   /* playground.js (#R675) */
  "Run": "执行",   /* playground.js (#R675) */
  "Running {a} of {b}": "执行第 {a} 次，共 {b} 次",   /* playground.js (#R675) */
  "Runs the same disease, the same world and the same first outbreak again with different random draws. The map keeps showing the single run you are watching.": "以相同的疾病、相同的世界与相同的最初疫情，改用不同的随机抽样重新执行。地图仍会显示你正在观看的那一次执行。",   /* playground.js (#R675) */
  "screening on arrival": "入境时检疫",   /* playground.js (#R675) */
  "Simplified educational model (stochastic SEIR, one well-mixed compartment set per country or territory, and one run out of many possible ones). Not a forecast.": "简化的教学用模型（随机 SEIR，每个国家或地区一组均匀混合的隔室，而且只是众多可能结果中的一次执行）。这不是预测。",   /* playground.js (#R675) */
  "Spread": "扩散",   /* playground.js (#R675) */
  "Still circulating at the time limit": "在时间上限时仍在流行",   /* playground.js (#R675) */
  "Stop the runs": "停止执行",   /* playground.js (#R675) */
  "Susceptible": "易感（未感染）",   /* playground.js (#R675) */
  "Tap any country for its own numbers.": "点击任一国家即可查看该国的数字。",   /* playground.js (#R675) */
  "treatment available": "有治疗方法",   /* playground.js (#R675) */
  "Sources and assumptions": "出处与假设",   /* playground.js (#R678) */
  "Disease parameters": "疾病参数",   /* playground.js (#R678) */
  "How fast it spreads": "传播速度",   /* playground.js (#R678) */
  "How deadly it is": "致死率",   /* playground.js (#R678) */
  "How long immunity lasts": "免疫持续时间",   /* playground.js (#R678) */
  "Vaccine": "疫苗",   /* playground.js (#R678) */
  "Treatment": "治疗",   /* playground.js (#R678) */
  "Starting immunity": "初始免疫",   /* playground.js (#R678) */
  "No named source in this table": "本表未载明出处者",   /* playground.js (#R678) */
  "The world this run uses": "本次模拟所用的世界",   /* playground.js (#R678) */
  "Land borders and capitals": "陆上国界与首都",   /* playground.js (#R678) */
  "Airport capacity": "机场容量",   /* playground.js (#R678) */
  "Airline route network": "航空航线网",   /* playground.js (#R678) */
  "June 2014 snapshot, no longer updated": "2014 年 6 月的快照，已不再更新",   /* playground.js (#R678) */
  "How many travellers arrive in each country": "各国入境旅客人数",   /* playground.js (#R678) */
  "Medical capacity, emergency response, vaccine delivery": "医疗量能、紧急应变、疫苗供应",   /* playground.js (#R678) */
  "Where the case dots are drawn": "病例点的绘制位置",   /* playground.js (#R678) */
  "Assumptions, not measurements": "这是假设，不是测量值",   /* playground.js (#R678) */
  "Route counts stand in for passenger flows": "以航线数代替旅客流量",   /* playground.js (#R678) */
  "No open, current bilateral passenger matrix exists. Part of each origin's air weight comes from the 2014 route network and the rest from a distance model, which is also how a country with no direct flight is still reachable.": "并不存在公开且现行的国对国旅客矩阵。各出发国航空权重的一部分来自 2014 年的航线网，其余来自距离模型；没有直航的国家仍可能被波及，也是因为如此。",   /* playground.js (#R678) */
  "Case dots sit on cities, not on a population surface": "病例点落在城市上，而非人口分布面上",   /* playground.js (#R678) */
  "Dots are shared out between a country's places in proportion to how many people live in each. A city gazetteer knows where towns are, not where the countryside is.": "点会依各地居住人数的比例分配到该国各处。城市地名数据库知道的是城镇的位置，而不是乡间的分布。",   /* playground.js (#R678) */
  "Measles starts from WHO/UNICEF first-dose coverage per country. That is childhood coverage read as whole-population immunity: this model has no age structure.": "麻疹以 WHO/UNICEF 各国第一剂接种率为起点。那是把儿童接种率当成全人口免疫来读，本模型没有年龄结构。",   /* playground.js (#R678) */
  "One assumed figure for every country and every age. Nobody publishes per-country protection against infection, so this is the coarsest shape a one-compartment immunity can take — not an estimate anyone made.": "对所有国家、所有年龄都应用同一个假设值。没有机构公布各国对感染的防护比例，这是只有单一免疫区间的模型所能呈现最粗略的形式，并非任何人的估计值。",   /* playground.js (#R678) */
  "Severity is applied to every infection": "严重度会应用到每一起感染",   /* playground.js (#R678) */
  "Presets whose severity is a CFR have a smaller denominator than an IFR does, and this model has no detection layer to tell them apart. The setting shows which metric a preset uses so it can be lowered.": "以 CFR 作为严重度的病种设置，其分母小于 IFR，而本模型没有侦测层可以区分两者。设置画面会显示所采用的是哪一种指标，以便读者调低。",   /* playground.js (#R678) */
  "Medical capacity": "医疗量能",   /* playground.js (#R678) */
  "Emergency response": "紧急应变",   /* playground.js (#R678) */
  "Vaccine delivery": "疫苗供应",   /* playground.js (#R678) */
  "estimated from GDP per head — this country is not in the WHO or World Bank table": "由人均 GDP 推估——本国不在 WHO 或世界银行的表中",   /* playground.js (#R678) */
  "loaded": "已加载",   /* playground.js (#R678) */
  "loaded for some countries": "仅部分国家已加载",   /* playground.js (#R678) */
  "did not load": "未能加载",   /* playground.js (#R678) */
  "still loading": "加载中",   /* playground.js (#R678) */
  ...
  /* ── js/atlas-progress.js (#R723) — 作业纪录。Atlas 回答期间逐行显示「现在正在做什么」，
     所以这些是进行中的动作短语，不是分类名称。语气比照上方既有的「思考中」／「正在读取图片」／
     「验证中」。⚠ 简体版由 scripts/zh-hans.mjs 由本档产生，请勿手改 ui.zh-hans.js。 */
  "Writing the answer": "正在撰写回答",
  "Drawing on the map": "正在地图上绘制",
  "Switching layers": "正在切换图层",
  "Moving the view": "正在移动视角",
  "Opening a panel": "正在开启面板",
  "Looking up data": "正在查询数据",
  "Researching": "研究中",
  "Changing a setting": "正在变更设置",
  "Running a simulation": "正在执行模拟",
  "Working out a route": "正在计算路线",
  "Setting the clock": "正在设置时间",
  "Checking the app": "正在检查应用",
  "Adjusting the interface": "正在调整界面",
  "Asking you": "正在向您提问",
  "Matching the photo": "正在比对照片",
  "Working": "处理中",
  "1 step": "1 个步骤",
  "{n} steps": "{n} 个步骤",
  ...
  "A setting is not a value this step can use": "有一个参数的值不是这个步骤能使用的",
  "A setting this step needs has not been filled in": "这个步骤需要的参数尚未填写",
  "Add a condition": "新增条件",
  "An earlier step failed, so this one was never run": "先前的步骤失败，因此这个步骤并未执行",
  "Analysis step": "分析步骤",
  "Choose a dataset for input": "请选择输入的数据集",
  "Choose an input dataset first": "请先选择输入的数据集",
  "Could not open the data panel": "无法开启数据面板",
  "Data and analysis": "数据与分析",
  "datasets": "个数据集",
  "Datasets": "数据集",
  "Delete this dataset?": "要删除这个数据集吗？",
  "Deleting this also deletes what was made from it": "删除它，也会一并删除由它产生的成果",
  "Draw again": "重新绘制",
  "Draw on the map": "绘制到地图",
  "Drawn on the map": "已显示于地图",
  "empty": "空值",
  "expected": "需要",
  "Failed": "失败",
  "feature": "要素",
  "From and to, both ends included": "起与迄，两端都包含",
  "Give the project a name first": "请先为项目命名",
  "given": "指定",
  "has": "实际",
  "Imported": "导入",
  "Input": "输入",
  ...
  "Made": "已建立",
  "needs": "需要",
  "no choices declared": "未定义选项",
  "no geometry": "无几何",
  "No saved projects yet": "尚无已保存的项目",
  "No steps are registered": "没有注册任何步骤",
  "Nothing here yet. Drop a file on the map, or run a step below.": "这里还没有东西。把文件拖到地图上，或执行下方的步骤。",
  "Open": "开启",
  "Origin not stated": "未记载来源",
  "Produces": "输出",
  "Project": "项目",
  "Project name": "项目名称",
  "Project opened": "已开启项目",
  "Project saved": "已保存项目",
  "Reading the saved projects…": "正在读取已保存的项目…",
  "Rebuilt": "已重新计算",
  ...
  "Showing": "显示",
  "That analysis step is not registered": "那个分析步骤未注册",
  "That column is not in the input dataset": "输入数据集中没有这个字段",
  "That comparison is not one this filter knows": "这个比较运算不是筛选所支持的",
  "That dataset is not registered any more": "那个数据集已不在注册之列",
  ...
  "The input dataset is gone": "输入的数据集已不存在",
  "The layer is removed from the import list on the map, not from here": "图层要从地图上的导入列表移除，而不是从这里",
  "The map is not ready to take a layer yet": "地图尚未准备好接收图层",
  "The project module has not loaded, so nothing can be saved or reopened": "项目模块尚未加载，因此无法保存或重新开启",
  "The result could not be registered as a dataset": "无法将结果注册为数据集",
  "the same geometry as the input": "与输入相同的几何类型",
  "The second input holds no polygon to clip with": "第二个输入没有可用来裁剪的多边形",
  "The step could not be run": "无法执行这个步骤",
  "The step stopped part way through": "步骤中途停止了",
  "The store could not be read": "无法读取保存空间",
  "The store could not be written to": "无法写入保存空间",
  "There is no dataset to run this on yet": "还没有可供执行这个步骤的数据集",
  "This browser is not letting the page store anything, so projects cannot be saved": "这个浏览器不允许页面保存数据，因此无法保存项目",
  "This dataset came from a file, not from a step, so it has no settings to change": "这个数据集来自文件而非某个步骤，因此没有可变更的参数",
  "This dataset carries no attribute columns": "这个数据集没有属性字段",
  "This step needs a different geometry": "这个步骤需要不同的几何类型",
  "This step takes a different number of inputs": "这个步骤接受的输入数量不同",
  "This step takes no settings": "这个步骤没有参数",
  "Type:": "类型:",
  "Upstream draws this shape without giving it a name": "上游绘制了这个形状，却没有给它名称",
  "Upstream states nothing further about this shape — not what it is, and not how precisely its boundary is drawn.": "上游对这个形状没有更多说明——既没说它是什么，也没说它的边界画得多精确。",
  "Where this came from": "这是从哪里来的",
  ...
  /* ══ (#R735) numeric grids (rasters), the spatial index, the time window and «take from the map»
     — js/gis-panel.js. GIS wording as the rest of this table already writes it: a grid is 网格, a
     pixel 像素, sampling 采样, a feature 要素, registering a dataset 注册. The refusals say what the
     reader can CHANGE, so none of them is shortened into a bare error. */
  "That layer is switched off, so it has no values to give — turn it on first": "那个图层未开启，因此没有值可以提供——请先把它开启",
  "That layer answers with text rather than numbers, so it cannot become a grid": "那个图层回答的是文字而不是数值，因此无法变成网格",
  "Stopped before it finished, so nothing was registered": "在完成之前就中止了，因此没有注册任何东西",
  "The grid module is not loaded, so this step was not run at all": "网格计算模块尚未加载，因此这个步骤根本没有执行",
  "This step needs the other kind of data in that slot — features where it was given a grid, or the other way round": "这个步骤在那个输入需要另一种数据——给了网格的地方需要要素，反之亦然",
  "That grid has no band of that name": "那个网格没有这个名称的波段",
  "That grid does not describe a grid: one of its size or spacing fields is missing or not a positive number": "那份描述并不构成一个网格：它的大小或间距字段有一项缺漏，或不是正数",
  "This browser could not allocate a grid that size": "这个浏览器无法配置那么大的网格",
  "That grid has fewer bands than the one asked for": "那个网格的波段数少于所指定的编号",
  "The grid handed back samples that do not match the size it declares": "网格传回的采样数，与它宣告的大小不符",
  "That point is not on this grid": "那个地点不在这个网格的范围内",
  "That position is not a pair of finite coordinates": "那个位置不是一组有限的经纬度坐标",
  "That row is outside the grid": "那一笔数据在网格之外",
  "That is not a sampling method this build knows": "那不是这个版本所知的采样方式",
  "A zone has to be an area: a point or a line has no inside for the grid to be counted in": "区域必须是面：点或线没有内部，网格无法计入其中",
  "That zone wraps the whole world, which leaves no inside and no outside — split it into two halves": "那个区域绕了整个地球一圈，因而分不出内外——请把它切成东西两半",
  "That zone encloses no area at all": "那个区域完全没有围出任何面积",
  "Areas per class need a grid of codes, and this one holds measurements — rounding them would invent classes nobody defined": "各类别的面积需要代码网格，而这个网格存放的是量测值——把它四舍五入，会凭空造出没有人定义过的类别",
  "Those two grids are not the same grid, and a difference is not computed by quietly resampling one of them": "那两个并不是同一个网格，而差值不会靠悄悄把其中一个重新采样来计算",
  "That test cannot be read as a comparison against a number": "那个条件无法解读为与某个数值的比较",
  "That comparison is not one the grid filter knows": "这个比较运算不是网格筛选所支持的",
  "The description of the grid to bake is incomplete: it needs a window, a size and something that answers for a point": "要产生的网格指定不完整：它需要范围、大小，以及一个能对单一地点作答的来源",
  "The grid step stopped without naming a reason": "网格的步骤停止了，却没有说明原因",
  "This dataset does not state which of its columns is time, so it cannot be narrowed to a period": "这个数据集没有说明哪一个字段是时间，因此无法依期间筛选",
  "bands": "个波段",
  "pixels": "个像素",
  "Take from the map": "从地图取得",
  "No layer on the map is handing features over right now. Switch one on, or move to where its data is.": "目前地图上没有任何图层能交出要素。请开启一个图层，或移动到有其数据的地方。",
  "Only what is in view": "仅限目前显示范围",
  "Stop sampling": "中止采样",
  "features": "个要素",
  "map source": "地图来源",
  "Use as dataset": "作为数据集使用",
  "Registered": "已注册",
  "Sample into a grid": "采样成网格",
  "Reading the layer": "正在读取图层",

  /* ══ (#R738) the attribute table, the calculated column, the join, the colouring and the time
     declaration — js/gis-panel.js, js/map-ui.js, plus the Shapefile / GeoPackage readers whose
     refusals surface there. 字段 for a column, 数据列 for a row, 运算式 for an expression, 着色 for
     colouring, 分级 for a class break — the wording this table already uses above. The refusals name
     what the reader can CHANGE, so none of them is shortened into a bare error.
     ⚠ ui.zh-hans.js is GENERATED from this file by scripts/zh-hans.mjs — never edit it by hand. */
  "A column in the .dbf is of a type this reader will not guess at": ".dbf 中有一个字段的型别，是这个读取器不会擅自推测的",
  "A column of that name is already there": "已经有同名的字段了",
  "A dataset this was built from has been edited since, so this still holds the answer to the earlier values — recompute it": "产生它的来源数据集之后被编辑过，因此这里仍保留先前数值的结果——请重新计算",
  "A geometry in this GeoPackage is not in the format the standard defines": "这个 GeoPackage 中有一个几何不符合标准所定义的格式",
  "A grid has no rows to carry a time column, so only a time for the whole dataset can apply": "网格没有可以承载时间字段的数据列，因此只能应用整个数据集共用的时间",
  "A grid holds pixels, not attributes, so there is nothing here to edit": "网格存放的是像素而不是属性，因此这里没有可编辑的东西",
  "A ladder of numbers": "数值分级",
  "A per-position time axis has to be a list of times running alongside the positions": "逐点的时间轴必须是一份与各位置并列的时间列表",
  "A row has to be named by its position": "数据列必须以它的位置来指定",
  "A table definition in this GeoPackage could not be read, and it was not guessed at": "这个 GeoPackage 中有一个数据表的定义无法读取，而且不会擅自推测",
  "A time for the whole dataset was declared without a readable start or end": "宣告了整个数据集共用的时间，却没有可读取的起始或结束",
  "A unit has to be written as text": "单位必须以文字书写",
  "Add a column": "新增字段",
  "Added to the map, but the analysis module did not load — this file cannot be analysed": "已加入地图，但分析模块未加载——这个文件无法进行分析",
  "Added to the map, but the data panel did not accept this file — it cannot be analysed": "已加入地图，但数据面板未接受这个文件——它无法进行分析",
  "Another dataset was built from this one, and it may be reading that column — delete the results first, or keep the column": "有另一个数据集是由它产生的，可能正在读取那个字段——请先删除那些成果，或保留该字段",
  "Arithmetic was asked of a value that is text — use concat() to join text": "对文字值要求了算术运算——连接文字请使用 concat()",
  "Back to one colour": "回到单一颜色",
  "categories": "分类",
  "Chosen": "已选",
  "Classes": "分级数",
  "Click a cell in the table above to change its value": "点击上方表格中的保存格即可修改其值",
  "Colour it": "应用着色",
  "Colour the map by a column": "依字段为地图着色",
  "Columns": "字段",
  "Declare": "宣告",
  "declared": "已宣告",
  "Delete this column": "删除这个字段",
  "Edit the attributes": "编辑属性",
  "equal intervals": "等距",
  "Graduated colours need a column whose every value is a number": "分级着色需要每一个值都是数值的字段",
  "Leave the number of classes empty to use the map’s own": "分级数留空即采用地图本身的设置",
  "measured": "量测",
  "Name of a new column": "新字段的名称",
  "New name for this column": "这个字段的新名称",
  "No changes were given": "没有提供任何变更",
  "No column was chosen": "未选择字段",
  "No column was named": "未指定字段名称",
  "No value": "无值",
  "No value was given — to empty a cell, give it an empty text": "没有提供值——要清空保存格，请提供空白文字",
  "Nothing ticked means every column of that input": "未勾选任何项目，即表示该输入的所有字段",
  "Nothing was declared about that column — give it a type, a unit, or both": "对那个字段没有宣告任何事——请给它型别、单位，或两者皆给",
  "One colour per value": "每个值一种颜色",
  "position": "位置",
  "quantiles": "分位",
  "Redo": "重做",
  "Something in the expression is left open — a quote or a bracket is never closed": "运算式中有东西没有收尾——引号或括号始终没有闭合",
  "Stop this run": "中止这次执行",
  "That change cannot be undone from what was recorded, so it was left alone rather than half-applied": "依所记录的内容无法复原这项变更，因此保持原状，而不是只应用一半",
  "That column already exists — choose another name, or say explicitly that it should be replaced": "那个字段已经存在——请改用其他名称，或明确表示要取代它",
  'That column is the dataset\'s time axis — removing or renaming it would leave the declaration naming a column that is not there': "那个字段是数据集的时间轴——删除或重新命名它，会让宣告指向一个不存在的字段",
  "That expression tree is not one this evaluator can read": "那个运算式结构不是这个运算器能解读的",
  "That function was given the wrong number of arguments": "那个函数收到的引数数量不正确",
  "That imported layer is no longer on the map": "那个导入的图层已不在地图上",
  "That input is a table: it has rows but no shapes, so a step that measures places cannot use it": "那个输入是表格：它有数据列却没有形状，因此需要量测地点的步骤无法使用它",
  "That is not a column type this layer knows": "那不是这个图层所知的字段型别",
  "That is not a shape of time axis this layer knows": "那不是这个图层所知的时间轴形式",
  "That kind of Shapefile geometry is not one this reader handles": "那种 Shapefile 几何类型不是这个读取器能处理的",
  "That table holds map tiles rather than features or values": "那个数据表存放的是地图瓦片，而不是要素或数值",
  "The analysis module did not load, so this column cannot be read": "分析模块未加载，因此无法读取这个字段",
  "The archive has no .shp file in it": "这个压缩档中没有 .shp 档",
  "The archive holds more than one Shapefile — unzip it and add the one you want": "这个压缩档中有多个 Shapefile——请先解压，再加入您要的那一个",
  "The column the time declaration names is not in the data": "时间宣告所指的字段不在数据中",
  "The column this GeoPackage names as its geometry is not in the table": "这个 GeoPackage 指定为几何的字段不在数据表中",
  "The expression could not be read here": "这里的运算式无法解读",
  "The expression failed on a row for a reason it could not name": "运算式在某一列失败了，却说不出原因",
  "The expression is empty": "运算式是空的",
  "The expression module is not loaded, so this step was not run at all": "运算式模块尚未加载，因此这个步骤根本没有执行",
  "The GeoPackage ends or breaks part-way through, so the rest cannot be read": "这个 GeoPackage 在中途结束或损毁，因此其余部分无法读取",
  "The list of times is not the same length as the positions, so every time after the gap would describe the wrong point": "时间列表的长度与位置数不一致，因此缺口之后的每一个时间都会指到错误的地点",
  "The map could not apply this colouring": "地图无法应用这个着色",
  'The page size in this file\'s header is not one SQLite defines': "这个文件标头中的页面大小不是 SQLite 所定义的值",
  "The registry that decides what counts as a number is not loaded, and this expression will not guess": "判定什么算是数值的登录表尚未加载，而这个运算式不会擅自推测",
  "The same code appears more than once in the table, so each match would be ambiguous — say which row to take, or make the codes unique": "同一个代码在表格中出现不只一次，因此每次比对都会有歧义——请指定要取哪一列，或让代码保持唯一",
  "The Shapefile ends earlier than its own header says it should": "这个 Shapefile 比它自己的标头所宣告的长度更早结束",
  "The shapes and the attribute rows are different in number, so the attributes would be attached to the wrong shapes": "形状的数量与属性数据列的数量不一致，属性会被接到错误的形状上",
  "The table brings a column the target already has — give the joined columns a prefix, or choose fewer of them": "这个表格带来的字段，目标中已经有了——请为结合进来的字段加上前缀，或少选一些",
  "The time declaration does not say which column holds the time": "时间宣告没有说明哪一个字段存放时间",
  "The time declaration is not in a form this layer can read": "时间宣告的形式不是这个图层能解读的",
  "The values in that column do not all read as that type, so the declaration was refused rather than written down as a fact": "那个字段中的值并非全部都能解读为该型别，因此这项宣告被拒绝，而不是被当作事实记录下来",
  "The values in that column do not read as times, so the declaration was refused rather than believed": "那个字段中的值无法解读为时间，因此这项宣告被拒绝，而不是照单全收",
  "There is no function by that name": "没有这个名称的函数",
  "There is no readable table of that name in this GeoPackage": "这个 GeoPackage 中没有这个名称且可读取的数据表",
  "There is no row at that position": "那个位置上没有数据列",
  "There is nothing left to undo": "没有可以复原的操作了",
  "There is nothing to redo": "没有可以重做的操作",
  "This column could not be coloured": "无法依这个字段着色",
  "This column has no values to colour by": "这个字段没有可用来着色的值",
  "This dataset is the result of a step, and its values are what that step produces — edit the imported data, or make a copy to edit": "这个数据集是某个步骤的结果，它的值就是该步骤产生的内容——请编辑导入的数据，或复制一份再编辑",
  "This GeoPackage holds nothing this map can read": "这个 GeoPackage 中没有这张地图能读取的内容",
  "This GeoPackage holds several tables — say which one to read": "这个 GeoPackage 中有多个数据表——请指定要读取哪一个",
  "This GeoPackage stores its text in an encoding this reader will not guess at": "这个 GeoPackage 以某种编码存放文字，而这个读取器不会擅自推测",
  "This GeoPackage uses a geometry type this reader does not draw": "这个 GeoPackage 使用了这个读取器不会绘制的几何类型",
  "This GeoPackage was left with a write-ahead log, and the log is not in the file — reopen and close it in the program that wrote it": "这个 GeoPackage 留有先行写入日志（WAL），而日志不在文件中——请用写出它的程序重新开启并关闭一次",
  "This is a SQLite database, but it holds no GeoPackage contents table": "这是一个 SQLite 数据库，但其中没有 GeoPackage 的内容数据表",
  "This is not a SQLite file, so it is not a GeoPackage": "这不是 SQLite 文件，因此它不是 GeoPackage",
  "This layer holds no features to colour": "这个图层没有可着色的要素",
  "This turn reached its working limit, so the answer above may be incomplete — anything asked for that is not described above was not done. Ask again for the missing part on its own.": "这一轮已达到作业上限，因此上方的回答可能并不完整——凡是上方未描述到的要求，都没有执行。请就缺少的部分单独再问一次。",
  "Tied values merged classes": "同值过多，分级已合并",
  "Time axis": "时间轴",
  "Unit": "单位",
  ...
  /* ══ (#R749) the GeoTIFF / raster reader, the warp and the two-grid align — js/map-ui.js,
     js/gis-panel.js. Same wording the GIS rows above already use: 网格 for a grid, 像素 for a
     pixel, 波段 for a band, 采样 for sampling, 坐标系 for a CRS. The format words a GIS reader
     looks for stay in the Latin the file itself writes them in — TIFF, BigTIFF, Deflate,
     DecompressionStream, nearest — because they are what the reader must change in their export
     dialogue. ⚠ Each refusal NAMES what cannot be handled; none is flattened into 「无法读取」.
     ⚠ ui.zh-hans.js is GENERATED from this file by scripts/zh-hans.mjs — never edit it by hand. */
  "Band": "波段",
  "converted from": "转换自",
  "drawn resampled": "重新采样后绘制",
  "Every cell of this grid holds the same value, so there is no scale to draw": "这个网格的每一格都是相同的值，因此没有可绘制的分级尺度",
  "nearest neighbour": "最近邻",
  "No object on the map has that id — it may already be gone": "地图上没有具有那个 id 的对象——它可能已经不在了",
  "Recomputed by a different version of the engine than the one that saved it, so these results can differ": "重新计算时所用的引擎版本，与当初保存它的版本不同，因此这些结果可能有所差异",
  "Say how the grid should be resampled — an interpolation nobody named is an answer nobody made": "请指定网格要如何重新采样——没有人指名的内插方式，就是没有人给出的答案",
  "Say which of the two grids the result should follow — the finer one, the coarser one, or the first": "请指定结果要依循两个网格中的哪一个——较细的、较粗的，或是第一个",
  "Say which values are the categories — this reader will not guess them from the numbers": "请指定哪些值是类别——这个读取器不会从数值中擅自推测",
  "Some column types or units you had declared no longer hold for this data and were not restored": "您先前宣告的部分字段型别或单位，对这份数据已不成立，因此没有被还原",
  "Stopped before it finished": "在完成之前就中止了",
  "That grid is not in lon/lat yet — convert it first, then put the two on one grid": "那个网格还不是经纬度——请先转换，再把两者放到同一个网格上",
  "That is not a way of colouring a grid": "那不是为网格着色的方式",
  "That layer is switched off, so it answered with nothing — turn it on and try again": "那个图层未开启，因此它什么也没有回答——请把它开启后再试一次",
  "The area this grid covers could not be worked out in lon/lat — it wraps the world, or collapses to nothing": "无法以经纬度求出这个网格所涵盖的范围——它绕了地球一圈，或是缩成了没有面积",
  "The coordinate-conversion library did not load, so this grid was not converted — nothing was guessed at": "坐标转换函数库未加载，因此这个网格并未转换——也没有做任何推测",
  "the file states no coordinate system; read as lon/lat": "文件没有说明坐标系，因此以经纬度读取",
  "The grid asked for is not a grid: one of its size or spacing values is missing or not positive": "所指定的网格并不构成一个网格：它的大小或间距有一项缺漏，或不是正数",
  "The grid handed back nothing when its values were asked for": "向网格索取数值时，它什么也没有交回",
  "The grid module is not loaded, so this file was not read at all": "网格计算模块尚未加载，因此这个文件根本没有被读取",
  "The grid was not measured, so it cannot be drawn": "这个网格尚未经过统计量测，因此无法绘制",
  "The pixel data in this TIFF does not decode — the file is damaged": "这个 TIFF 的像素数据无法解码——文件已经损毁",
  "These two grids do not overlap anywhere, so there is no common grid to put them on": "这两个网格没有任何重叠之处，因此没有可以共同放置它们的网格",
  "This band holds categories, not measurements — interpolating them would invent categories nobody defined; use nearest": "这个波段存放的是类别而不是量测值——对它们做内插，会凭空造出没有人定义过的类别；请改用最近邻（nearest）",
  "This browser cannot decompress the TIFF (no DecompressionStream)": "这个浏览器无法解压这个 TIFF（没有 DecompressionStream）",
  "This file is a grid, and the module that reads grids did not load": "这个文件是网格，而读取网格的模块未加载",
  "This file is not a TIFF": "这个文件不是 TIFF",
  "This grid could not be drawn": "无法绘制这个网格",
  ...
  "This TIFF does not say where on Earth its pixels are, so it cannot be placed on the map": "这个 TIFF 没有说明它的像素位于地球上的何处，因此无法放到地图上",
  "This TIFF ends part way through its pixels — the file is incomplete": "这个 TIFF 在像素读到一半时就结束了——文件并不完整",
  "This TIFF holds JPEG-compressed tiles, which this reader does not decode — export it uncompressed or as Deflate": "这个 TIFF 存放的是 JPEG 压缩的瓦片，这个读取器不会解码——请改以无压缩或 Deflate 导出",
  "This TIFF is compressed in a way this reader does not decode": "这个 TIFF 的压缩方式，是这个读取器不会解码的",
  "This TIFF stores its numbers in a form this reader does not read": "这个 TIFF 以这个读取器不会读取的形式存放数值",
  }
});
