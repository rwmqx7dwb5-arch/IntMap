...
window.IntMapLang.define('zh-hans', {
  ...
  ui: {
      ...
      docDesc:"IntMap 是一款交互式世界地图，可探索地理、气候、历史、人口与全球时事等，并支持由 Atlas 提供的自然语言操作。",
    ...
    "blueberryBtn":"支持",
    "blueberryGo":"选择金额 ↗",
    "blueberryNote":"将打开外部页面（Stripe）。",
    "blueberryTitle":"支持 IntMap",
    "climAt":"气候区",
    "engineActive":"目前运行于：",
    "engineCesium":"Cesium — 具真实地形的立体地球仪",
    "engineFellBack":"Cesium 无法启动，因此本次会话改用 MapLibre。",
    "engineHint":"Cesium 在每个缩放层级都把地球算成真正的椭球体，使用相同的卫星图像与相同的高程数据。它只在被选用时才下载，切换时会重新加载页面。等高线与封闭立体工具仍仅限 MapLibre。",
    ...
    "newsCountriesHint":"从你选择的国家媒体截取标题（可复选）。",
    ...
    "newsSourcesHint":"只显示你勾选的媒体的标题。列表依你目前数据源实际包含的媒体创建。",
    "nightSideOff":"关闭 — 整颗地球均匀照亮",
    "nightSideOn":"打开（默认）— 让夜侧变暗并显示城市灯光",
    "optBaroque":"巴洛克（欧洲）",
    "optClassic":"大航海时代",
    "optCyber":"赛博终端",
    "optDark":"深色",
    ...
    "proModalSub":"超越实时地图 — 深度历史文档与一手来源情报。",
    "proModalTitle":"解锁 IntMap Pro",
    "proSection":"高级功能",
    "reportBugBtn":"🐞 回报错误",
    "screenshotBtn":"地图屏幕截取（隐藏控制项，保留图例）",
    "screenshotBusy":"截取中…",
    "screenshotSaved":"已保存屏幕截取 ✓",
    "sendFeedbackBtn":"⭐ 发送意见回馈",
    "shareView":"分享此画面（拷贝链接）",
    "showRankOff":"关闭",
    "showRankOn":"打开（默认）",
    ...
    "sortLife":"平均寿命",
    "sortTfr":"生育率",
    "srcModalSub":"IntMap 汇整以下第三方数据、图像与 API。所有商标均属各自所有人。",
    "srcModalTitle":"数据来源与出处",
    "tickerOff":"关闭（默认）",
    "tickerOn":"打开 — 地图下方的细长条",
    ...
    "viewSourcesPage":"打开数据来源页面 ↗",
    "worldExplorerBtn":"🌍 卫星空降",
    "wsHint":"新闻、国家、地图、图层与 Atlas 各自成为独立窗口，可自由移动、调整大小、收合与堆栈。你的版面配置会被保存。",
    "wsOff":"关闭（默认）",
    "wsOn":"打开 — 可自由浮动、可调整大小的窗口",
      ...
      viewMap:"地图", viewSat:"卫星图像", settings:"设置", modalTitle:"设置", close:"关闭",
      ...
      setSecAppearance:"外观", setSecLayout:"版面与面板", setSecMap:"地图操作", setSecUnits:"单位与时间", setSecNews:"新闻与跑马灯", setSecAI:"AI", setSecKeys:"集成与密钥", setSecAbout:"关于与支持",
      ...
      measureHint:"点击以添加点・双击结束", areaHint:"添加 3 点以上围成范围・双击结束", radiusHint:"点击地图放置圆形。可放置多个。",
      ...
      satCtrlTitle:"卫星图像", satProvider:"提供者", satDate:"拍摄日期", satLatest:"最新可用", satMosaicSuffix:"无云镶嵌图像", satLocked:"需 API 密钥", satPrevDay:"前一天", satNextDay:"后一天", satKeysTitle:"卫星图像（自备密钥）", satKeyHint:"输入 API 密钥即可在卫星面板中使用这些提供者。密钥仅保存在这个浏览器中。", satKeyConnected:"已连接", satKeyNone:"无密钥", satErrAuth:"{provider}：验证失败 — 请检查 API 密钥", satErrTiles:"{provider}：图像无法取得 — 已切换为替代来源",
      aiSecTitle:"AI 功能", aiSecHint:"内置 AI — 登录用户免费（每日最多 10 次），不需要 API 密钥。",
      aiProvider:"AI 提供者", aiModel:"模型", aiApiKey:"API 密钥", aiKeyConnected:"已连接", aiKeyNone:"无密钥", aiGetKey:"取得密钥 ↗", aiOnDevice:"在 Chrome 上本机运行 — 不需要 API 密钥。",
      aiTest:"测试连接", aiTesting:"测试中…", aiTestOk:"连接正常 ✓",
      aiNoKey:"请先在「设置 → AI 功能」中添加 AI API 密钥。", aiNoVision:"这个模型无法读取图像。请改用 GPT-4o、Claude 3.5 Sonnet 或 Gemini 1.5 Pro。",
      aiChromeUnavail:"此处无法使用 Chrome 内置 AI。请使用 Chrome 127 以上并激活本机 AI，或改选其他提供者。",
      aiThinking:"AI 分析中…", aiError:"AI 请求失败", aiCopy:"拷贝", aiCopied:"已拷贝 ✓", aiClose:"关闭", aiRetry:"重试",
      ...
      lblNewsLang:"新闻语言", newsLangUi:"仅目前语言", newsLangMulti:"所有语言（自动翻译标题）", lblAiLocate:"AI 位置分析", aiLocManual:"手动（按钮）", aiLocAuto:"所有新闻自动运行",
      aiTranslate:"翻译", aiShowOriginal:"原文", aiTransNoText:"没有可翻译的内文 — 请改用网页查看。",
      aiSumBtn:"以 AI 摘要这个区域", popInArea:"此区域人口", popCalcing:"正在计算人口…", popFail:"人口查找失败 — 请再试一次。", newsInArea:"此区域的新闻", elevProfile:"高程剖面", finalizeMeas:"保留在地图上", aiSumTitle:"区域演示文稿", aiSumSub:"所选区域内有 {n} 个新闻图钉", aiSumNoArea:"请先画出范围或放置圆形。", aiSumNoNews:"此区域内没有新闻图钉。",
      aiViewSumBtn:"摘要目前画面", aiViewSumTitle:"画面上正在发生什么",
      aiVisHead:"AI 变化侦测", aiVisBtn:"侦测变化", aiVisTitle:"卫星图像变化报告", aiVisSub:"比较 {a} → {b}", aiVisBefore:"之前", aiVisAfter:"之后", aiVisCapturing:"正在截取图像…", aiVisPickDates:"请选择两个日期进行比较。", aiVisNeedsDated:"请在卫星模式中改用可选日期的提供者（MODIS／VIIRS／Sentinel-2）。", aiVisCapFail:"无法截取地图图像。" 
,
      tabMonitors:"监控",
    },
  ...
  inline: {
    ...
    '◎ places the epicenter · ◇ adds a place.': "◎ 放置震央・◇ 添加地点。",   /* seismic.js */
    ...
    'A custom score needs at least two indicators (components)': "自定义评分至少需要两项指针（成分）",   /* atlas-console.js */
    ...
    'Add a place': "添加地点",   /* seismic.js */
    'Add a stop': "添加停靠点",   /* routing.js */
    ...
    'Add on map': "在地图上添加",   /* drone-nav.js */
    ...
    'ago': "前",   /* monitors.js */
    'AI failed (data kept)': "AI 运行失败（数据已保留）",   /* monitors.js */
    ...
    'All indicators': "所有指针",   /* stats-compare.js */
    ...
    'Already running — it’s in progress.': "已在运行中 — 正在进行。",   /* monitors.js */
    'Already running on': "已在运行于",   /* atlas-console.js */
    ...
    'amber = Fresnel-obstructed': "琥珀色＝受菲涅耳区屏蔽",   /* viewshed.js */
    ...
    'Anyone who opens this link sees the map exactly as you do now.': "任何打开此链接的人，看到的地图都与你现在的画面完全相同。",   /* map-ui.js */
    ...
    'Attach a file': "附加文档",   /* atlas-console.js */
    'Attach a file (image or text)': "附加文档（图片或文字）",   /* atlas-console.js */
    ...
    'Building the 360° horizon and stepping a year…': "正在创建 360° 地平线并推进一年…",   /* sims.js */
    ...
    'City/population query failed (Overpass busy) — population context unavailable': "城市／人口查找失败（Overpass 忙碌）— 无法提供人口背景",   /* atlas-console.js */
    ...
    'Click the map to add an observation point.': "点击地图以添加观测地点。",   /* seismic.js */
    ...
    'Copied': "已拷贝",   /* atlas-reply.js */
    'Copied!': "已拷贝！",   /* map-ui.js */
    'Copy': "拷贝",   /* atlas-console.js atlas-reply.js map-ui.js */
    'Copy message': "拷贝消息",   /* atlas-console.js */
    ...
    'Could not build that historical map — try naming the war/year more specifically': "无法创建该历史地图 — 请更明确指出战争或年份",   /* atlas-console.js */
    ...
    'Could not confirm the layer actually painted on the map (its data may still be loading or its source may be down) — check the map; toggling it again may help': "无法确认图层是否真的画在地图上（数据可能仍在加载，或来源已脱机）— 请检查地图，重新切换一次或许有帮助",   /* atlas-console.js */
    'Could not create the monitor.': "无法创建监看。",   /* atlas-console.js monitors.js */
    ...
    'Could not run the map self-check for this answer.': "无法对这个回答运行地图自我检查。",   /* atlas-console.js */
    ...
    'Country comparison opened': "已打开国家比较",   /* atlas-console.js */
    'Country info': "国家信息",   /* atlas-console.js */
    'Country not found': "找不到国家",   /* atlas-console.js */
    'Country outlines are not loaded yet — open the Countries tab once and try again.': "国界轮廓尚未加载 — 请先打开一次「国家」分页再试。",   /* routing.js */
    ...
    'covered': "已涵盖",   /* sims.js */
    'CRASHED': "坠毁",   /* flight-sim.js */
    'Create monitor': "创建监看",   /* monitors.js */
    ...
    'Drone planner open': "已打开无人机规划器",   /* atlas-console.js */
    'Drone planner unavailable': "无人机规划器无法使用",   /* atlas-console.js */
    'due now': "现已到期",   /* monitors.js */
    'Duration': "持续时间",   /* satellite-detail.js */
    'each indicator’s value for this year, by its own source': "各指针当年的数值，依其各自来源",   /* stats-compare.js */
    'Each point is added to the table below. Press the button again to turn this off.': "添加的地点会列在下方表格中。再次按下按钮即可关闭。",   /* seismic.js */
    ...
    'gaps': "缺口",   /* viewshed.js */
    'GDP & population: Maddison Project (real GDP, 2011 int$). Other indicators: World Bank aggregate of the successor states.': "GDP 与人口：Maddison Project（实质 GDP，2011 年国际元）。其他指针：世界银行对继承国的合计。",   /* countries-ui.js */
    ...
    'Hide (reopen from the dock)': "隐藏（可从停靠列重新打开）",   /* workspace.js */
    ...
    'Includes: position, zoom, projection, base map, every active layer, time-travel & compare state.': "包含：位置、缩放、投影、底图、所有激活的图层、时光机与比较状态。",   /* map-ui.js */
    'Indicated airspeed': "指示空速",   /* aircraft-detail.js */
    'Indicators': "指针",   /* stats-compare.js */
    'Industry': "产业",   /* industry-web.js */
    'Industry web': "产业关系网",   /* industry-web.js */
    'Inflow (m³/s)': "入流量（m³/s）",   /* terrain-water.js */
    'Integrated analysis': "集成分析",   /* atlas-console.js */
    ...
    'Live satellites on': "已打开实时卫星",   /* atlas-console.js */
    ...
    'Location is blocked for this site. Turn it on in your browser (tap the lock/permissions icon in the address bar), then ask me again.': "本网站的定位权限已被封锁。请在浏览器中打开（点网址列的锁头／权限图标），然后再问我一次。",   /* atlas-console.js */
    'Location permission was denied. Re-enable it in your browser settings, then ask again.': "定位权限遭拒。请在浏览器设置中重新激活，然后再问一次。",   /* atlas-console.js */
    ...
    'Log in to create and view area monitors.': "请登录以创建与查看区域监看。",   /* monitors.js */
    'Log in to run monitors.': "请登录以运行监看。",   /* monitors.js */
    'Log in to use monitors.': "请登录以使用监看功能。",   /* atlas-console.js */
    'long-run estimates for this year — World Bank / IMF annual series begin in 1960': "该年份的长期推估值 — 世界银行／IMF 年度串行自 1960 年开始",   /* stats-compare.js */
    ...
    'Manage every pin, drawing, radius, route, uploaded layer and reachable-area here — rename, recolor, hide or delete.': "在这里管理每一个图钉、绘图、半径、路线、上传的图层与可达范围 — 可重命名、换色、隐藏或删除。",   /* atlas-console.js */
    ...
    'Map lookup was unavailable — places could not be verified on the map right now.': "地图查找无法使用 — 目前无法在地图上验证这些地点。",   /* atlas-verify.js */
    ...
    'Merge': "合并",   /* routing.js */
    'Messages': "消息",   /* aircraft-detail.js */
    ...
    'Monitor created': "已创建监看",   /* atlas-console.js */
    'Monitor created.': "已创建监看。",   /* monitors.js */
    'Monitor not found.': "找不到监看。",   /* monitors.js */
    'Monitor ran: ': "监看已运行：",   /* monitors.js */
    ...
    'news · imagery · quakes time-traveled to this date': "新闻・图像・地震皆已时空跳跃到此日期",   /* sims.js */
    ...
    'no data for this metric': "此指针没有数据",   /* atlas-console.js */
    ...
    'No matching countries / metric unavailable.': "没有符合的国家／该指针无法使用。",   /* atlas-reply.js */
    'No matching monitor found.': "找不到符合的监看。",   /* atlas-console.js */
    'No monitors yet. Set a radius, draw an area, or resolve a region, then create a monitor to watch it for changes.': "尚无监看。请先设置半径、画出范围或指定地区，再创建监看以追踪其变化。",   /* monitors.js */
    'No objects on the map.': "地图上没有对象。",   /* atlas-console.js */
    'No objects yet. Drop a pin, draw, add a radius, upload GeoJSON, or make a route — they all show up here to manage in one place.': "尚无对象。放置图钉、绘图、加入半径、上传 GeoJSON 或创建路线 — 全都会出现在这里统一管理。",   /* map-tools.js */
    ...
    'No readable data on the active layers here. Turn a data layer on first.': "此处激活中的图层没有可读取的数据。请先打开一个数据图层。",   /* atlas-console.js */
    ...
    'No time-series available': "没有时间串行可用",   /* stats-compare.js */
    ...
    'Not an available indicator': "不是可用的指针",   /* atlas-console.js */
    'Not enough countries have both values.': "同时具备两项数值的国家不足。",   /* analysis-panels.js */
    'Not enough data for this metric': "此指针的数据不足",   /* atlas-console.js */
    'Not enough usable indicators': "可用的指针不足",   /* atlas-console.js */
    ...
    'Nothing is drawn — this is a failed query, not an industry with no companies.': "没有绘制任何内容 — 这是查找失败，并不代表这个产业没有企业。",   /* industry-web.js */
    ...
    'Open in Google Maps': "在 Google 地图打开",   /* street-view.js */
    'Open Monitors': "打开监看",   /* atlas-console.js */
    'open my monitors': "打开我的监看",   /* atlas-console.js */
    'Open the tsunami simulator': "打开海啸模拟器",   /* seismic.js */
    'Opened': "已打开",   /* atlas-console.js */
    'Opened the radioactive-fallout model.': "已打开放射性沉降模型。",   /* sims.js */
    'Opens the full radioactive-fallout model (source term, isotope, wind).': "打开完整的放射性沉降模型（源项、同位素、风场）。",   /* sims.js */
    ...
    'Place names are drawn on a body — open one from the list': "地名是画在天体上的 — 请从列表打开一个天体",   /* space.js */
    ...
    'Please wait a moment before running again.': "请稍候再重新运行。",   /* monitors.js */
    ...
    'previous run': "上次运行",   /* monitors.js */
    'Primary energy': "一次能源",   /* world-packs.js */
    'Prison': "监狱",   /* drone-ops.js */
    'Propagator branch': "外推方法分支",   /* satellite-detail.js */
    'Public-transit routing (Transitous / MOTIS) — includes REAL-TIME updates for this trip (live departures / delays where the operator publishes them).': "大众运输路径规划（Transitous／MOTIS）— 本进程含实时更新（营运者有公布时的实时发车／误点）。",   /* atlas-console.js */
    'Public-transit routing (Transitous / MOTIS) — timetable-based (no real-time data for this trip).': "大众运输路径规划（Transitous／MOTIS）— 以时刻表为准（本进程无实时数据）。",   /* atlas-console.js */
    'Publisher pins': "媒体所在地图钉",   /* atlas-console.js */
    'Publishers': "媒体",   /* monitors.js */
    'QNH': "修正海平面气压",   /* aircraft-detail.js */
    'Querying Wikidata…': "正在查找 Wikidata…",   /* industry-web.js */
    ...
    'Read and analyze this image. If it is a document, a maths/science problem, a table or text, transcribe it accurately and solve or explain it.': "请阅读并分析这张图片。若是文档、数学／科学题目、表格或文字，请正确转录并加以解答或说明。",   /* atlas-console.js */
    ...
    'related indicators (all countries)': "相关指针（所有国家）",   /* atlas-console.js */
    ...
    'Run history': "运行纪录",   /* monitors.js */
    'Run now': "立即运行",   /* monitors.js */
    'Run this request again': "重新运行这个请求",   /* atlas-console.js */
    'Running…': "运行中…",   /* monitors.js */
    ...
    'Satellite': "卫星图像",   /* atlas-console.js workspace.js */
    ...
    'Select at least one indicator.': "请至少选择一项指针。",   /* stats-compare.js */
    ...
    'Street View mode — the light-blue lines are Google\'s real coverage; click one to open its panorama': "街景模式 — 浅蓝色线是 Google 的实际涵盖范围；点一条即可打开其全景",   /* street-view.js */
    'Street View mode on — the light-blue lines are Google\'s real coverage; click one to open its panorama': "已打开街景模式 — 浅蓝色线是 Google 的实际涵盖范围；点一条即可打开其全景",   /* atlas-console.js */
    ...
    'Sunlight hours & shade': "日照时数与屏蔽",   /* tool-panel.js */
    'Sunlight hours & terrain shade': "日照时数与地形屏蔽",   /* atlas-console.js */
    ...
    'Switch the map click to “Add a place” to add rows here.': "请把地图点击切换为「添加地点」以在此加入列。",   /* seismic.js */
    ...
    'The brief came back empty': "演示文稿回传为空",   /* atlas-console.js */
    'The bundled current data could not be read.': "无法读取内置的海流数据。",   /* ocean-currents.js */
    'the current view': "目前画面",   /* atlas-console.js */
    'The dispersion simulation could not run (map still loading)': "扩散模拟无法运行（地图仍在加载）",   /* atlas-console.js */
    ...
    'The monitor runs on our servers even when this page is closed. A report is generated only when a meaningful change is detected — every claim links to its source.': "即使关闭这个页面，监看仍会在我们的服务器上运行。只有侦测到有意义的变化时才会产生报告 — 每一项主张都会链接到其来源。",   /* monitors.js */
    ...
    'The ownership statements could not be fetched this time, so no lines are drawn. That is a failed query, not an absence of ownership.': "这次无法取得持股关系的叙述，因此没有画出任何连接。这是查找失败，并不代表没有持股关系。",   /* industry-web.js */
    ...
    'The previous run': "上次运行",   /* monitors.js */
    'the query took longer than 45 s': "查找超过 45 秒",   /* industry-web.js */
    ...
    'The run failed.': "运行失败。",   /* atlas-console.js */
    ...
    'This browser cannot run the solver in a background thread, so the propagation model is unavailable here.': "这个浏览器无法在背景线程中运行求解器，因此此处无法使用传播模型。",   /* tsunami.js */
    'This camera is momentarily offline.': "这台摄影机暂时脱机。",   /* cameras.js */
    ...
    'This monitor can’t run right now.': "这个监看目前无法运行。",   /* monitors.js */
    'This monitor is paused — resume it to run.': "这个监看已暂停 — 请先恢复再运行。",   /* monitors.js */
    ...
    'Time — tap to add/remove (max 3)': "时间 — 点击可添加／移除（最多 3 个）",   /* map-tools.js */
    ...
    'Time-series': "时间串行",   /* atlas-console.js stats-compare.js */
    ...
    'Uncertain in the image': "图像中无法确定",   /* atlas-console.js */
    ...
    'Up to 4 files per message': "每则消息最多 4 个文档",   /* atlas-console.js */
    'Up to 4 images per message': "每则消息最多 4 张图片",   /* atlas-console.js */
    ...
    'Use:': "使用：",   /* routing.js */
    'Using the current map view — pan/zoom before creating, or close and set a radius, draw an area or resolve a region for a tighter watch.': "使用目前的地图画面 — 创建前可先平移或缩放，或关闭后改以半径、绘制范围或指定地区来更精准地监看。",   /* monitors.js */
    ...
    'View': "查看",   /* cameras.js workspace.js */
    'View report': "查看报告",   /* monitors.js */
    'Viewing the past': "正在查看过去",   /* news-timeline.js */
    'Viewing the past · tap': "正在查看过去・点击",   /* news-timeline.js */
    ...
    'Wikidata’s public endpoint is rate-limiting this browser — wait a moment and switch the layer on again': "Wikidata 的公开端点正在限制这个浏览器的请求频率 — 请稍候再重新打开图层",   /* industry-web.js */
    ...
    'Winter-solstice shade': "冬至日的屏蔽",   /* sims.js */
    ...
    'Workspace mode on — News, Countries, the map, layers and Atlas are now free-floating windows': "已打开工作区模式 — 新闻、国家、地图、图层与 Atlas 现在都是可自由移动的窗口",   /* atlas-console.js */
    'World Bank annual series begin in 1960 — latest available': "世界银行年度串行自 1960 年开始 — 显示最新可得值",   /* stats-compare.js */
    ...
    'ρ = Spearman rank correlation, r = Pearson (log scale where the metric is log-distributed). Correlation is NOT causation — third factors (income, region) can drive both sides; the listed exception countries are good places to test any explanation.': "ρ＝斯皮尔曼等级相关，r＝皮尔森相关（指针呈对数分布时使用对数尺度）。相关不等于因果 — 第三因素（所得、地区）可能同时影响双方；列出的例外国家很适合用来检验任何解释。",   /* atlas-console.js */
    ...
    '📖 Reader': "📖 阅读器",
    '🔒 Only <b>Pro</b> users can add their own satellite imagery services (API integrations).': "🔒 只有 <b>Pro</b> 用户才能加入自己的卫星图像服务（API 集成）。",
    '2022 UNDP': "2022 联合国开发计划署",
    '2022 World Bank': "2022 世界银行",
    '32 members': "32 个成员国",
    'A satellite where-am-I geography game — dropped somewhere on Earth, guess your location.': "卫星图像猜位置的地理游戏 — 被丢到地球上的某处，猜猜你在哪里。",
    ...
    'Could not extract text — use “🌐 Web” above to open the page.': "无法截取内文 — 请用上方的「🌐 网页」打开页面。",
    ...
    'Location blocked — enable it in your browser settings.': "定位被封锁 — 请在浏览器设置中打开。",
    ...
    'Log out': "注销",
    'Log out of your account?': "要注销账号吗？",
    'Logged out': "已注销",
    'Maritime zones': "海域划界",
    ...
    'Night lights': "夜间灯光",
    'No bio yet.': "尚未填写自我介绍。",
    'No layers are on': "没有打开任何图层",
    'None selected': "未选取",
    'Only visible from here': "仅从此处可见",
    'Open in new tab': "在新分页打开",
    'Open original': "打开原文",
    ...
    'This site blocks embedding. Try “📖 Reader” or open it in a new tab.': "这个网站禁止内嵌。请改用「📖 阅读器」或在新分页打开。",
    'Top depth': "顶部深度",
    'Total fertility rate': "总生育率",
    'Tropic of Cancer (23.4°N)': "北回归线（23.4°N）",
    'Tutorial — layer showcase': "教学 — 图层导览",
    'Type': "类型",
    'Ukraine frontline on — pan to Ukraine to see it': "已打开乌克兰前线 — 请平移到乌克兰查看",
    'Units': "单位",
    'Update failed: ': "更新失败：",
    'Upload image': "上传图片",
    'USD, nominal': "美元，名目值",
  ...
  "Contour lines": "等高线",
  "Corruption indicator": "贪腐指针",
  "Current account (% GDP)": "经常帐（占GDP）",
  "Daily satellite (true color)": "每日卫星图像（真实色彩）",
  ...
  "Surface soil moisture — drought & agriculture (AMSR2)": "表层土壤水分——干旱与农业指针（AMSR2）",
  ...
  "As of: ": "更新：",
  "Could not load — toggle again later.": "无法加载——请稍后再打开一次。",
  ...
  "Sending…": "发送中…",
  "Could not send — please try again later.": "无法发送——请稍后再试。",
  ...
  "Submit report": "送出回报",
  "Copy report to clipboard": "拷贝回报内容到剪贴板",
  "Copied.": "已拷贝。",
  "Could not copy.": "无法拷贝。",
  ...
  "Saved on this device and copied to your clipboard (offline).": "已脱机保存在此设备并拷贝到剪贴板。",
  ...
  "World Bank WGI “Control of Corruption” score (0–100, higher = cleaner) — the open-API counterpart of TI’s CPI.": "世界银行 WGI「贪腐控制」分数（0–100，愈高愈清廉）——相当于 TI 贪腐印象指数的开放 API 指针。",
  ...
  "End tour": "结束",
  "Experimental interactive modes built on real data.": "以真实数据打造的实验性交互模式。",
  ...
  "Weather at your location (asks for location permission when added)": "目前位置的天气（添加时会要求位置权限）",
  "FX rate": "汇率",
  ...
  "Edit": "编辑",
  "Add widget": "添加小工具",
  "Add a widget…": "要添加的小工具…",
  "Available widgets": "可添加的小工具",
  "as of ": "更新于 ",
  ...
  "Source: National Archives · American Presidency Project": "来源：美国国家文档馆 · American Presidency Project",
  ...
  "Sentinel Hub instance ID": "Sentinel Hub 运行个体 ID",
  "Sentinel-2 cloudless (EOX)": "Sentinel-2 无云图像（EOX）",
  "Shona": "绍纳",
  ...
  "UI / display": "界面／显示",
  "Aerosol optical depth — how much haze, smoke and dust dim sunlight in the air column.": "气溶胶光学厚度 — 大气中的霾、烟与尘埃屏蔽阳光的程度。",
  ...
  "Armed forces": "军队人数",
  "Artificial light at night, from satellite — a proxy for urbanization and economic activity.": "卫星观测的夜间人造光 — 都市化与经济活动的替代指针。",
  ...
  "Human Development Index — a 0–1 blend of life expectancy, schooling and income. Higher = more developed.": "人类发展指数 — 由平均寿命、教育与所得合成的 0～1 指针。愈高愈发展。",
  "Ice cap — every month < 0 °C": "冰原 — 各月皆低于 0 °C",
  "Indonesian": "印尼语",
  "Industrials": "工业",
  "Infant deaths before age 1 per 1,000 live births — a core health/development indicator.": "每千名活产中未满 1 岁死亡数 — 内核健康与发展指针。",
  ...
  "Physicians per 1,000 people — a measure of healthcare capacity.": "每千人医师数 — 医疗量能的指针。",
  ...
  "Public webcams worldwide, loaded live from OpenStreetMap for the current view — pan/zoom for more. Click a point: YouTube/image/panorama cams play in the popup, others open the operator page.": "全球公开网络摄影机，依目前画面范围自 OpenStreetMap 实时加载（平移或缩放可加载更多）。点击一个点：YouTube、图像与全景会在窗口中播放，其余则打开营运者页面。",
  ...
  "No data for the selected metrics.": "所选指针没有数据。",
  "no history": "无历史数据",
  ...
  "P/E ratio": "本益比",
  "Pick at least one metric above.": "请在上方至少选择一项指针。",
  "reported": "申报",
  "Sector": "产业",
  "Share price": "股价",
