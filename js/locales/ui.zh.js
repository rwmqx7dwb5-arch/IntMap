  ...
  ui: {
   ...
   "lyrContours":"等高線",
    ...
    "wsOn":"開啟 — 可自由浮動、可調整大小的視窗",
      ...
      aiGeoBtn:"✨ 以 AI 定位所有新聞", aiGeoBtnSub:"✨ 以 AI 定位事件地", aiTranslateTitles:"翻譯標題", aiGeoBusy:"定位中…", aiGeoNone:"沒有可定位的項目。", aiGeoDone:"已定位 {n} 則報導", aiGeoErr:"地理編碼失敗", aiTransBusy:"翻譯中…", aiTransDone:"已翻譯 {n} 則標題", aiTransNone:"標題已是你的語言。",
...
,
  ...
  "Wind particles over the gust layer": "陣風圖層上的風場粒子",   /* atlas-console.js (#R438) */
  "Wind particles over the pressure layer": "氣壓圖層上的風場粒子",   /* atlas-console.js (#R438) */
  "sea-level pressure switched on": "已開啟海平面氣壓",   /* atlas-console.js (#R438) */
  ...
  "No volcano called “{q}” is in the Holocene catalog.": "全新世目錄中沒有名為「{q}」的火山。",
