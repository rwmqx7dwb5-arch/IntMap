  ...
  ui: {
   ...
   "lyrContours":"等高線",
    ...
    "wsHint":"新聞、國家、地圖、圖層與 Atlas 各自成為獨立視窗，可自由移動、調整大小、收合與堆疊。你的版面配置會被儲存。",
      ...
      lyrEEZ:"專屬經濟海域／12浬", lyrShips:"即時船舶動態", lyrPlanes:"即時航班動態", lyrSats:"即時衛星", lyrThermal:"熱異常（火點）", planesZoomHint:"放大以載入即時航班", planesAreaHint:"請放大 — 即時航班只涵蓋畫面中央區域", poiLabels:"地點、商家與設施", shipsZoomHint:"放大以載入即時船舶", aisNoKey:"即時船舶暫時無法顯示 — 共用資料來源沒有回應。", aisOutsideCoverage:"共用資料來源未涵蓋這片海域 — 不是這裡沒有船，而是資料範圍不到。在設定中填入你自己的 aisstream.io 金鑰，即可看到全世界。", aisKeyLabel:"即時船舶動態（AISstream 金鑰）", aisKeyHint:"選填。沒有金鑰也能從共用資料來源看到即時船舶。填入 aisstream.io 的免費金鑰後，這個瀏覽器會直接接收全球即時串流，稍微更新一些。金鑰僅儲存在這個瀏覽器中。",
...
,
  ...
  "columns": "欄位",   /* map-ui.js (#R576) */
  "skipped": "已略過",   /* map-ui.js (#R576) */
  "No latitude/longitude columns found": "找不到緯度／經度欄位",   /* map-ui.js (#R576) */
  "This is a Shapefile, but the module that reads it could not be loaded": "這是 Shapefile，但無法載入讀取它的模組",   /* map-ui.js (#R576 → key restated #R738) */
  "File is too large to read": "檔案太大，無法讀取",   /* map-ui.js (#R576) */
  "Too many features to draw": "地物太多，無法繪製",   /* map-ui.js (#R576) */
  "No usable coordinates in this file": "這個檔案沒有可用的座標",   /* map-ui.js (#R576) */
  "The file has no map features": "這個檔案沒有可繪製的地物",   /* map-ui.js (#R576) */
  "This KML only links to data held elsewhere": "這個 KML 只連結到外部資料",   /* map-ui.js (#R576) */
  "This JSON is not GeoJSON": "這個 JSON 不是 GeoJSON",   /* map-ui.js (#R576) */
  "Unsupported XML format": "不支援的 XML 格式",   /* map-ui.js (#R576) */
  "Unsupported file format": "不支援的檔案格式",   /* map-ui.js (#R576) */
  ...
  "National elections": "議會選舉",
  "Country or territory": "國家或地區",
  "Seats": "議席",
  "Share of the vote": "得票率",
  "district": "選區",
  "list": "政黨名單",
  "Parties with no seat": "未取得議席的政黨",
  "No result is recorded for this district.": "此選區沒有記錄的結果。",
  "The record does not carry a vote count for this district.": "記錄中沒有此選區的得票數。",
  "Colour = the party that won the district. The bars are the whole chamber, including the seats this map does not draw.": "顏色代表在該選區勝出的政黨。長條圖顯示整個議會的組成，包括本地圖未繪出的議席。",
  "No constituency boundaries have been published for this election, so the map stays empty. The chamber below is the recorded result.": "這次選舉沒有公布選區界線，因此地圖維持空白。下方的議席是記錄的結果。",
  "Day length": "晝長",
  "Map scale": "地圖比例尺",
  "Calendar": "行事曆",
  "Next new moon": "下一次新月",
  ...
  "3D terrain, real imagery, and time travel back to AD 1": "3D 地形、實拍影像，時光可回到西元 1 年",
  ...
  'The map was not drawing — IntMap is in the background, so the view could not move. Bring IntMap to the front and ask again.': '地圖當時沒有在繪製 — IntMap 沒有顯示在最前面，所以畫面無法移動。請把 IntMap 切換到最前面，再問一次。',   /* atlas-results.js (#R768) atlas.code.not_rendering */
  ...
  "GVP records {n} volcano(es) as erupting in {y}. The record reaches further back than the clock does, so the card shows every eruption in it.": "GVP 記錄中，{y} 年正在噴發的火山有 {n} 座。記錄比時鐘回溯得更早，因此卡片會顯示記錄中的所有噴發。",
  ...
  "source records": "筆原始記錄",
  "are a place in its own right": "筆本身即為一個地點",
  "Records that GeoNames marks as a section of another place, or as historical, abandoned or destroyed, are not counted as a place": "GeoNames 標示為其他地點的一部分，或標示為歷史上的、已廢棄、已毀壞的記錄，不計為地點",
  "a field of the source record, copied": "直接抄自來源記錄欄位的值",
  "Record type": "記錄類型",
  "a grid sampled at this row coordinate": "在此座標讀取網格得到的值",
  "measured here from the published geometry": "依已發布的幾何資料在此測得的值",
  "requested from the endpoint for this row": "為此列向端點查詢取得的值",
  "looked up through the country this row is in": "以此列所屬國家查得的值",
  ...
  "No outline on this map for": "此地圖沒有輪廓的國家：",   /* outbreaks.js (#R650) */
  "Time window": "期間",   /* outbreaks.js (#R650) */
  "1 year": "1 年",   /* outbreaks.js (#R650) */
  "5 years": "5 年",   /* outbreaks.js (#R650) */
  "90 days": "90 天",   /* outbreaks.js (#R650) */
  "all pathogens": "所有病原體",   /* outbreaks.js (#R650) */
  "Archive built": "存檔建立於",   /* outbreaks.js (#R650) */
  "cases": "病例",   /* outbreaks.js (#R650) */
  "checked WHO for newer items": "已向 WHO 查詢較新的公告",   /* outbreaks.js (#R650) */
  "Circle size = WHO notes in the window · colour = how recent the newest is.": "圓的大小＝期間內的 WHO 公告數 · 顏色＝最新一則有多新。",   /* outbreaks.js (#R650) */
  "Closed the outbreak layer.": "已關閉疾病爆發圖層。",   /* outbreaks.js (#R650) */
  "could not check WHO for newer items": "無法向 WHO 查詢較新的公告",   /* outbreaks.js (#R650) */
  "Could not load the outbreak archive.": "無法載入疾病爆發存檔。",   /* outbreaks.js (#R650) */
  "Could not load the WHO outbreak archive.": "無法載入 WHO 的疾病爆發存檔。",   /* outbreaks.js (#R650) */
  "Countries drawn": "已繪製的國家",   /* outbreaks.js (#R650) */
  "countries on the map": "個國家在地圖上",   /* outbreaks.js (#R650) */
  "deaths": "死亡",   /* outbreaks.js (#R650) */
  "Disease outbreaks (WHO)": "疾病爆發（WHO）",   /* outbreaks.js (#R650) */
  "Everything up to this date": "到這一天為止的全部",   /* outbreaks.js (#R650) */
  "listed, not placed": "僅列於清單，未標於地圖",   /* outbreaks.js (#R650) */
  "Most notes": "最多",   /* outbreaks.js (#R650) */
  "not extracted yet": "尚未擷取",   /* outbreaks.js (#R650) */
  "Not one country": "非單一國家",   /* outbreaks.js (#R650) */
  "not stated by WHO": "WHO 未載明",   /* outbreaks.js (#R650) */
  "Outbreak": "發生日",   /* outbreaks.js (#R650) */
  "Pathogen": "病原體",   /* outbreaks.js (#R650) */
  "Read the WHO item": "閱讀 WHO 原文",   /* outbreaks.js (#R650) */
  "Reported": "通報數",   /* outbreaks.js (#R650) */
  "Source: WHO Disease Outbreak News": "來源：WHO Disease Outbreak News（世界衛生組織）",   /* outbreaks.js (#R650) */
  "Tap a circle for the items behind it.": "點按圓圈，即可看到其中的項目。",   /* outbreaks.js (#R650) */
  "WHO note": "WHO 公告",   /* outbreaks.js (#R650) */
  "WHO notes": "WHO 公告",   /* outbreaks.js (#R650) */
  "WHO published no Disease Outbreak News about that in this window.": "在這段期間內，WHO 沒有就此發布 Disease Outbreak News。",   /* outbreaks.js (#R650) */
  ...
  "Infected, not yet infectious": "已感染、尚未具傳染性",
  "Infectious now": "目前具傳染性",
  "Initial cases": "初始病例數",
  "Initial immunity": "初始免疫",
  "International spread is weighted by population, distance and airport capacity. The land-border table did not load.": "國際傳播依人口、距離與機場運量加權。陸上邊界資料未能載入。",
  "International spread is weighted by population, distance and land borders. The airport table did not load.": "國際傳播依人口、距離與陸上邊界加權。機場資料未能載入。",
  "Latent (d)": "潛隱期(日)",
  "Lifelong immunity": "終身免疫",
  "Loading the border and airport tables — the outbreak starts once the world is fixed.": "正在載入邊界與機場資料——世界確定後才會開始爆發。",
  "No response": "無防疫措施",
  "Nobody is immune, and no vaccine or treatment exists yet.": "沒有人具備免疫力，也還沒有疫苗或治療方法。",
  "Novel pathogen": "新型病原體",
  "Protected by vaccine now": "目前受疫苗保護",
  "Seasonality": "季節性",
  "Seed": "隨機種子",
  ...
  "Today's world": "現今世界",
  "Travel": "人員流動",
  "Uses the vaccines and treatments this disease really has in 2026, plus an ASSUMED level of starting immunity — one figure applied to every country and age.": "使用 2026 年這種疾病實際擁有的疫苗與治療方法，初始免疫則是「假設」的數值——所有國家、所有年齡都套用同一個比例。",
  ...
  "In danger": "瀕危遺產",
  "World Heritage": "世界遺產",
  "World Heritage (UNESCO)": "世界遺產（UNESCO）",
  "World Heritage — every UNESCO property": "世界遺產 — UNESCO 列入名錄的全部遺產",
  "Could not load the World Heritage list": "無法載入世界遺產名錄",
  "Inscribed {y}": "{y}年列入名錄",
  "UNESCO page": "UNESCO 說明頁面",
  "On the List in Danger": "已列入瀕危名錄",
  "On the List in Danger since {y}": "自 {y} 年列入瀕危名錄",
  "On the List of World Heritage in Danger": "已列入《瀕危世界遺產名錄》",
  "On the List of World Heritage in Danger since {y}": "自 {y} 年列入《瀕危世界遺產名錄》",
  "{s} inscribed properties, drawn as {p} component parts. {d} are on the List in Danger.": "已列入名錄的 {s} 項遺產，以 {p} 處構成資產繪出，其中 {d} 項列入瀕危名錄。",
  "UNESCO publishes no coordinate for {n} of them, so they are not on the map.": "其中 {n} 項 UNESCO 未公布座標，因此並未出現在地圖上。",
  "UNESCO publishes the List in English, French, Spanish, Russian, Arabic, Chinese and Japanese only, so the names here are in English.": "UNESCO 僅以英文、法文、西班牙文、俄文、阿拉伯文、中文與日文公布名錄，因此這裡顯示英文名稱。",
  "Say what to narrow the World Heritage layer to: a category, or the List in Danger.": "請指定要以什麼篩選世界遺產圖層：區分，或瀕危名錄。",
  "Categories are: {c}": "區分為：{c}",
  "{n} World Heritage points shown": "顯示世界遺產 {n} 處地點",
  "Name a World Heritage property.": "請指定世界遺產的名稱。",
  "No World Heritage property called “{q}” is on the List this map carries.": "本地圖收錄的世界遺產名錄中沒有「{q}」。",
  "UNESCO publishes no coordinate for “{q}”, so it is inscribed but cannot be put on the map.": "UNESCO 未公布「{q}」的座標，因此雖已列入名錄，卻無法標示在地圖上。",
  "{n} component parts are drawn for it.": "已為此遺產繪出 {n} 處構成資產。",
  ...
  "Release height (m)": "釋放高度（公尺）",
  "Very heavy deposition": "極高沉降",
  "Heavy deposition": "高度沉降",
  "Moderate deposition": "中度沉降",
  "Light deposition": "輕度沉降",
  "Sr-90: mandatory resettlement (UA)": "Sr-90：無條件（強制）遷離——烏克蘭法",
  "Sr-90: guaranteed voluntary resettlement (UA)": "Sr-90：保證自願遷離——烏克蘭法",
  "Sr-90: enhanced radioecological control (UA)": "Sr-90：加強放射生態管制——烏克蘭法",
  "Final ground deposition — statutory zones": "最終地面沉降——法定分區",
  "Final ground deposition — density only (this nuclide has no statutory zoning)": "最終地面沉降——僅沉降密度（此核種沒有法定分區）",
  "too few particles reached this cell to quote a value": "到達此格點的粒子太少，無法給出數值",
  "first year": "第一年",
  "external dose from this deposit is minor — Sr-90/Y-90 are beta emitters, and the hazard is ingestion, not ground shine": "此沉降造成的外部劑量很小——Sr-90／Y-90 是β放射核種，危害在於攝入，而非地表輻射",
  ...
  "Measured radiation": "實測輻射",   /* map-ui.js (#R585) */
  "Measured radiation — ambient gamma dose rate": "實測輻射 — 周圍γ等效劑量率",   /* beta-overlays.js radiation-layer.js (#R585) */
  "stations": "個測站",   /* radiation-layer.js (#R585) */
  "unavailable: ": "無法取得：",   /* atlas-controls.js (#R585) */
  "Loading history…": "正在載入歷史資料…",   /* radiation-layer.js (#R585) */
  "No history published for this station.": "此測站未公開歷史資料。",   /* radiation-layer.js (#R585) */
  "Could not reach the networks.": "無法連線至監測網。",   /* radiation-layer.js (#R585) */
  "Radiation measurements are unavailable right now.": "目前無法取得輻射實測值。",   /* beta-overlays.js (#R585) */
  "{n} stations within {k} km": "{k} 公里內 {n} 個測站",   /* atlas-controls.js (#R585) */
  "No monitoring station within {k} km publishes an open-licensed reading. That is a gap in coverage, not a statement about the radiation there.": "{k} 公里內沒有任何監測站以開放授權公開量測值。這是監測網的覆蓋空白，並非對當地輻射量的陳述。",   /* atlas-controls.js (#R585) */
  "Measured radiation on — {n} stations from {m} networks": "已開啟實測輻射 — 來自 {m} 個監測網的 {n} 個測站",   /* atlas-controls.js (#R585) */
  "Measured radiation layer off.": "已關閉實測輻射圖層。",   /* atlas-controls.js (#R585) */
  "Give a coordinate to measure around.": "請指定作為測量中心的座標。",   /* atlas-controls.js (#R585) */
  "50–200 nSv/h is normal natural background almost everywhere. Rain alone can lift a station up to three times higher for a few hours, and most of these readings are published unvalidated — so one high station is not evidence of a release.": "50–200 nSv/h 在幾乎所有地方都是正常的天然背景輻射。單是降雨就可能讓某個測站的讀數在數小時內升高到三倍，而且這些數值多半未經驗證即予公開 — 因此單一測站數值偏高並不能證明發生了放射性物質釋放。",   /* radiation-layer.js (#R585) */
  "{n} more stations publish a period average, not a current reading — set the clock to their year to see them.": "另有 {n} 個測站公布的是期間平均值，而非目前的量測值 — 將時鐘調到該年份即可顯示。",   /* radiation-layer.js (#R585) */
  "below this detector’s stated range": "低於此偵測器標示的量測範圍",   /* radiation-layer.js (#R585) */
  "published average for a period — not a current reading": "公布的期間平均值 — 並非目前的量測值",   /* radiation-layer.js (#R585) */
  "still loading one network…": "仍在載入其中一個觀測網…",   /* radiation-layer.js (#R585) */
  ...
  "Source boundary precision: approximate": "來源的邊界精度分類：概略",
  "Source boundary precision: moderately precise": "來源的邊界精度分類：中等精度",
  ...
  "A dataset with that id is already registered": "已經有相同 ID 的資料集註冊在案",
  "A filter with no condition is refused, because it would say nothing about the data": "沒有條件的篩選不會對資料說明任何事，因此不予執行",
  "A project saves the steps, and no step has been run yet": "專案儲存的是處理步驟，而目前還沒有執行過任何步驟",
  "A setting is not a value this step can use": "有一個參數的值不是這個步驟能使用的",
  "A setting this step needs has not been filled in": "這個步驟需要的參數尚未填寫",
  "Add a condition": "新增條件",
  "An earlier step failed, so this one was never run": "先前的步驟失敗，因此這個步驟並未執行",
  "Analysis step": "分析步驟",
  "Choose a dataset for input": "請選擇輸入的資料集",
  "Choose an input dataset first": "請先選擇輸入的資料集",
  "Could not open the data panel": "無法開啟資料面板",
  "Data and analysis": "資料與分析",
  "datasets": "個資料集",
  "Datasets": "資料集",
  "Delete this dataset?": "要刪除這個資料集嗎？",
  "Deleting this also deletes what was made from it": "刪除它，也會一併刪除由它產生的成果",
  "Draw again": "重新繪製",
  "Draw on the map": "繪製到地圖",
  "Drawn on the map": "已顯示於地圖",
  "empty": "空值",
  "expected": "需要",
  "Failed": "失敗",
  "feature": "要素",
  "From and to, both ends included": "起與迄，兩端都包含",
  "Give the project a name first": "請先為專案命名",
  "given": "指定",
  "has": "實際",
  "Imported": "匯入",
  "Input": "輸入",
  ...
  "Made": "已建立",
  "needs": "需要",
  "no choices declared": "未定義選項",
  "no geometry": "無幾何",
  "No saved projects yet": "尚無已儲存的專案",
  "No steps are registered": "沒有註冊任何步驟",
  "Nothing here yet. Drop a file on the map, or run a step below.": "這裡還沒有東西。把檔案拖到地圖上，或執行下方的步驟。",
  "Open": "開啟",
  "Origin not stated": "未記載來源",
  "Produces": "輸出",
  "Project": "專案",
  "Project name": "專案名稱",
  "Project opened": "已開啟專案",
  "Project saved": "已儲存專案",
  "Reading the saved projects…": "正在讀取已儲存的專案…",
  "Rebuilt": "已重新計算",
  "Remove this condition": "刪除這個條件",
  "required": "必填",
  "rows": "筆",
  "Run a step": "執行步驟",
  "Separate the values with commas": "多個值請以逗號分隔",
  "Settings of this step": "這個步驟的參數",
  "Showing": "顯示",
  "That analysis step is not registered": "那個分析步驟未註冊",
  "That column is not in the input dataset": "輸入資料集中沒有這個欄位",
  "That comparison is not one this filter knows": "這個比較運算不是篩選所支援的",
  "That dataset is not registered any more": "那個資料集已不在註冊之列",
  "That project is not in the store any more": "那個專案已不在儲存空間中",
  "That would make a step depend on its own result": "這樣會讓步驟依賴自己的結果",
  "The analysis module is not loaded, so the steps cannot be run again": "分析模組尚未載入，因此無法重新執行這些步驟",
  "The dataset registry is not loaded, so nothing can be read or written": "資料集註冊表尚未載入，因此無法讀取或寫入",
  "The distance and area library this step needs has not loaded": "這個步驟需要的距離與面積計算程式庫尚未載入",
  "The input already has a column of that name, and the result would overwrite it": "輸入中已有同名欄位，結果會將它覆蓋",
  "The input dataset is gone": "輸入的資料集已不存在",
  "The layer is removed from the import list on the map, not from here": "圖層要從地圖上的匯入清單移除，而不是從這裡",
  "The map is not ready to take a layer yet": "地圖尚未準備好接收圖層",
  "The project module has not loaded, so nothing can be saved or reopened": "專案模組尚未載入，因此無法儲存或重新開啟",
  "The result could not be registered as a dataset": "無法將結果註冊為資料集",
  "the same geometry as the input": "與輸入相同的幾何類型",
  "The second input holds no polygon to clip with": "第二個輸入沒有可用來裁剪的多邊形",
  "The step could not be run": "無法執行這個步驟",
  "The step stopped part way through": "步驟中途停止了",
  "The store could not be read": "無法讀取儲存空間",
  "The store could not be written to": "無法寫入儲存空間",
  "There is no dataset to run this on yet": "還沒有可供執行這個步驟的資料集",
  "This browser is not letting the page store anything, so projects cannot be saved": "這個瀏覽器不允許頁面儲存資料，因此無法儲存專案",
  "This dataset came from a file, not from a step, so it has no settings to change": "這個資料集來自檔案而非某個步驟，因此沒有可變更的參數",
  "This dataset carries no attribute columns": "這個資料集沒有屬性欄位",
  "This step needs a different geometry": "這個步驟需要不同的幾何類型",
  "This step takes a different number of inputs": "這個步驟接受的輸入數量不同",
  "This step takes no settings": "這個步驟沒有參數",
  "Type:": "類型:",
  "Upstream draws this shape without giving it a name": "上游繪製了這個形狀，卻沒有給它名稱",
  "Upstream states nothing further about this shape — not what it is, and not how precisely its boundary is drawn.": "上游對這個形狀沒有更多說明——既沒說它是什麼，也沒說它的邊界畫得多精確。",
  "Where this came from": "這是從哪裡來的",
  "a low pass, unlikely to be visible": "過境仰角低，肉眼不易看見",   /* #R726 */
  "Base display": "基本顯示",   /* #R726 */
  "elevation seen from": "仰角",   /* #R726 */
  "feels like": "體感",   /* #R726 */
  "gusts": "陣風",   /* #R726 */
  "humidity": "濕度",   /* #R726 */
  "in progress now": "正在過境",   /* #R726 */
  "in the next 24 h": "（未來 24 小時內）",   /* #R726 */
  ...
  "rain chance": "降雨機率",   /* #R726 */
  "satellite card": "衛星卡片",   /* #R726 */
  "The base display presets are unavailable.": "基本顯示的預設組合無法使用。",   /* #R726 */
  "the chosen point": "指定地點",   /* #R726 */
  "the map center": "地圖中心",   /* #R726 */
  "The preset did not apply": "預設組合未能套用",   /* #R726 */
  "Unknown base display preset": "未知的基本顯示預設組合",   /* #R726 */
  "Upstream draws this shape without giving it a name": "上游繪製了這個形狀，但未給它名稱",   /* #R726 */
  ...
  "Atlas ran its tools but did not write an answer this time — what they returned is shown above; ask again or narrow the question.": "Atlas 已執行工具，但這次沒有寫出回答——工具傳回的內容顯示在上方；請再問一次或縮小問題範圍。",   /* #R731 */
  ...
  "A negative radius shrinks a shape inwards, and points and lines have no inside to shrink": "半徑為負值會把圖形向內縮，而點與線沒有可以內縮的內部",
  "containing": "包含",
  "CRS not stated by the file": "檔案未載明座標系",
  "inside": "在內部",
  "Lines and areas keep their own shape here — every spatial test is measured on it. The single coordinate shown for such a row is the centre of its bounding box, and nothing is measured from that point.": "線與面在這裡保留自身的形狀，所有空間判定都以該形狀來量測。這類資料列所顯示的單一座標是其外接矩形的中心，不會從該點量測任何東西。",
  "Out of date": "已過期",
  "overlapping": "重疊",
  "rows carry neither a shape nor a coordinate, so this condition could not be asked about them and they are not below": "筆資料既無形狀也無座標，因此無法對它們檢驗這個條件，下方也未列出",
  "Rows tested spatially": "已做空間判定的筆數",
  'target shapes, measured against the candidates\' own geometry (not their pins)': "個目標形狀，以各候選項本身的形狀（而非其圖釘位置）進行判定",
  "That input holds nothing this step can work on": "那個輸入中沒有這個步驟能處理的要素",
  "That step is declared but has no implementation in this build": "那個步驟雖已宣告，但這個版本中沒有它的實現",
  'The coordinate is the centre of this row\'s bounding box, computed here; the row\'s own shape is what every spatial test used': "這個座標是此資料列外接矩形的中心，由這裡計算得出；所有空間判定使用的是該列本身的形狀",
  "The file does not say which coordinate system it uses, and its numbers are not degrees": "這個檔案沒有說明它使用哪個座標系，其數值也不是經緯度",
  "The map is not ready, so its layers cannot be handed over as data": "地圖尚未準備好，因此無法將它的圖層當作資料交出",
  "The second input holds no polygon to overlay with": "第二個輸入沒有可用來疊合的多邊形",
  "The shape engine could not be fetched, so this step was not run at all — this is not an empty result": "無法取得圖形運算模組，因此這個步驟根本沒有執行——這不是空的結果",
  "The shape engine this step needs is not loaded": "這個步驟需要的圖形運算模組尚未載入",
  "There is no layer or map source by that name": "沒有這個名稱的圖層或地圖來源",
  "This file uses a coordinate system this map cannot convert from": "這個檔案使用的座標系，是這張地圖無法換算的",
  "This input is out of date: a recomputation above it failed, so it still holds the earlier answer": "這個輸入已過期：上游的重新計算失敗，因此它仍保留先前的結果",
  "within km of": "距…公里內",

  /* ══ (#R735) numeric grids (rasters), the spatial index, the time window and «take from the map»
     — js/gis-panel.js. GIS wording as the rest of this table already writes it: a grid is 網格, a
     pixel 像素, sampling 取樣, a feature 要素, registering a dataset 註冊. The refusals say what the
     reader can CHANGE, so none of them is shortened into a bare error. */
  "That layer is switched off, so it has no values to give — turn it on first": "那個圖層未開啟，因此沒有值可以提供——請先把它開啟",
  "That layer answers with text rather than numbers, so it cannot become a grid": "那個圖層回答的是文字而不是數值，因此無法變成網格",
  "Stopped before it finished, so nothing was registered": "在完成之前就中止了，因此沒有註冊任何東西",
  ...
  "The grid handed back samples that do not match the size it declares": "網格傳回的取樣數，與它宣告的大小不符",
  "That point is not on this grid": "那個地點不在這個網格的範圍內",
  "That position is not a pair of finite coordinates": "那個位置不是一組有限的經緯度座標",
  "That row is outside the grid": "那一筆資料在網格之外",
  "That is not a sampling method this build knows": "那不是這個版本所知的取樣方式",
  "A zone has to be an area: a point or a line has no inside for the grid to be counted in": "區域必須是面：點或線沒有內部，網格無法計入其中",
  "That zone wraps the whole world, which leaves no inside and no outside — split it into two halves": "那個區域繞了整個地球一圈，因而分不出內外——請把它切成東西兩半",
  "That zone encloses no area at all": "那個區域完全沒有圍出任何面積",
  "Areas per class need a grid of codes, and this one holds measurements — rounding them would invent classes nobody defined": "各類別的面積需要代碼網格，而這個網格存放的是量測值——把它四捨五入，會憑空造出沒有人定義過的類別",
  "Those two grids are not the same grid, and a difference is not computed by quietly resampling one of them": "那兩個並不是同一個網格，而差值不會靠悄悄把其中一個重新取樣來計算",
  "That test cannot be read as a comparison against a number": "那個條件無法解讀為與某個數值的比較",
  "That comparison is not one the grid filter knows": "這個比較運算不是網格篩選所支援的",
  "The description of the grid to bake is incomplete: it needs a window, a size and something that answers for a point": "要產生的網格指定不完整：它需要範圍、大小，以及一個能對單一地點作答的來源",
  "The grid step stopped without naming a reason": "網格的步驟停止了，卻沒有說明原因",
  "This dataset does not state which of its columns is time, so it cannot be narrowed to a period": "這個資料集沒有說明哪一個欄位是時間，因此無法依期間篩選",
  "bands": "個波段",
  "pixels": "個像素",
  "Take from the map": "從地圖取得",
  "No layer on the map is handing features over right now. Switch one on, or move to where its data is.": "目前地圖上沒有任何圖層能交出要素。請開啟一個圖層，或移動到有其資料的地方。",
  "Only what is in view": "僅限目前顯示範圍",
  "Stop sampling": "中止取樣",
  "features": "個要素",
  "map source": "地圖來源",
  "Use as dataset": "作為資料集使用",
  "Registered": "已註冊",
  "Sample into a grid": "取樣成網格",
  "Reading the layer": "正在讀取圖層",
  ...
  /* ══ (#R738) the attribute table, the calculated column, the join, the colouring and the time
     ...
     refusals surface there. 欄位 for a column, 資料列 for a row, 運算式 for an expression, 著色 for
     colouring, 分級 for a class break — the wording this table already uses above. The refusals name
  ...
  "A column in the .dbf is of a type this reader will not guess at": ".dbf 中有一個欄位的型別，是這個讀取器不會擅自推測的",
  "A column of that name is already there": "已經有同名的欄位了",
  "A dataset this was built from has been edited since, so this still holds the answer to the earlier values — recompute it": "產生它的來源資料集之後被編輯過，因此這裡仍保留先前數值的結果——請重新計算",
  "A geometry in this GeoPackage is not in the format the standard defines": "這個 GeoPackage 中有一個幾何不符合標準所定義的格式",
  "A grid has no rows to carry a time column, so only a time for the whole dataset can apply": "網格沒有可以承載時間欄位的資料列，因此只能套用整個資料集共用的時間",
  "A grid holds pixels, not attributes, so there is nothing here to edit": "網格存放的是像素而不是屬性，因此這裡沒有可編輯的東西",
  "A ladder of numbers": "數值分級",
  "A per-position time axis has to be a list of times running alongside the positions": "逐點的時間軸必須是一份與各位置並列的時間清單",
  "A row has to be named by its position": "資料列必須以它的位置來指定",
  "A table definition in this GeoPackage could not be read, and it was not guessed at": "這個 GeoPackage 中有一個資料表的定義無法讀取，而且不會擅自推測",
  "A time for the whole dataset was declared without a readable start or end": "宣告了整個資料集共用的時間，卻沒有可讀取的起始或結束",
  "A unit has to be written as text": "單位必須以文字書寫",
  "Add a column": "新增欄位",
  "Added to the map, but the analysis module did not load — this file cannot be analysed": "已加入地圖，但分析模組未載入——這個檔案無法進行分析",
  "Added to the map, but the data panel did not accept this file — it cannot be analysed": "已加入地圖，但資料面板未接受這個檔案——它無法進行分析",
  "Another dataset was built from this one, and it may be reading that column — delete the results first, or keep the column": "有另一個資料集是由它產生的，可能正在讀取那個欄位——請先刪除那些成果，或保留該欄位",
  "Arithmetic was asked of a value that is text — use concat() to join text": "對文字值要求了算術運算——連接文字請使用 concat()",
  "Back to one colour": "回到單一顏色",
  "categories": "分類",
  "Chosen": "已選",
  "Classes": "分級數",
  "Click a cell in the table above to change its value": "點選上方表格中的儲存格即可修改其值",
  "Colour it": "套用著色",
  "Colour the map by a column": "依欄位為地圖著色",
  "Columns": "欄位",
  "Declare": "宣告",
  "declared": "已宣告",
  "Delete this column": "刪除這個欄位",
  "Edit the attributes": "編輯屬性",
  "equal intervals": "等距",
  "Graduated colours need a column whose every value is a number": "分級著色需要每一個值都是數值的欄位",
  "Leave the number of classes empty to use the map’s own": "分級數留空即採用地圖本身的設定",
  "measured": "量測",
  "Name of a new column": "新欄位的名稱",
  "New name for this column": "這個欄位的新名稱",
  "No changes were given": "沒有提供任何變更",
  "No column was chosen": "未選擇欄位",
  "No column was named": "未指定欄位名稱",
  "No value": "無值",
  "No value was given — to empty a cell, give it an empty text": "沒有提供值——要清空儲存格，請提供空白文字",
  "Nothing ticked means every column of that input": "未勾選任何項目，即表示該輸入的所有欄位",
  "Nothing was declared about that column — give it a type, a unit, or both": "對那個欄位沒有宣告任何事——請給它型別、單位，或兩者皆給",
  "One colour per value": "每個值一種顏色",
  "position": "位置",
  "quantiles": "分位",
  "Redo": "重做",
  "Something in the expression is left open — a quote or a bracket is never closed": "運算式中有東西沒有收尾——引號或括號始終沒有閉合",
  "Stop this run": "中止這次執行",
  "That change cannot be undone from what was recorded, so it was left alone rather than half-applied": "依所記錄的內容無法復原這項變更，因此保持原狀，而不是只套用一半",
  "That column already exists — choose another name, or say explicitly that it should be replaced": "那個欄位已經存在——請改用其他名稱，或明確表示要取代它",
  'That column is the dataset\'s time axis — removing or renaming it would leave the declaration naming a column that is not there': "那個欄位是資料集的時間軸——刪除或重新命名它，會讓宣告指向一個不存在的欄位",
  "That expression tree is not one this evaluator can read": "那個運算式結構不是這個運算器能解讀的",
  "That function was given the wrong number of arguments": "那個函式收到的引數數量不正確",
  "That imported layer is no longer on the map": "那個匯入的圖層已不在地圖上",
  "That input is a table: it has rows but no shapes, so a step that measures places cannot use it": "那個輸入是表格：它有資料列卻沒有形狀，因此需要量測地點的步驟無法使用它",
  "That is not a column type this layer knows": "那不是這個圖層所知的欄位型別",
  "That is not a shape of time axis this layer knows": "那不是這個圖層所知的時間軸形式",
  "That kind of Shapefile geometry is not one this reader handles": "那種 Shapefile 幾何類型不是這個讀取器能處理的",
  "That table holds map tiles rather than features or values": "那個資料表存放的是地圖圖磚，而不是要素或數值",
  "The analysis module did not load, so this column cannot be read": "分析模組未載入，因此無法讀取這個欄位",
  "The archive has no .shp file in it": "這個壓縮檔中沒有 .shp 檔",
  "The archive holds more than one Shapefile — unzip it and add the one you want": "這個壓縮檔中有多個 Shapefile——請先解壓縮，再加入您要的那一個",
  "The column the time declaration names is not in the data": "時間宣告所指的欄位不在資料中",
  "The column this GeoPackage names as its geometry is not in the table": "這個 GeoPackage 指定為幾何的欄位不在資料表中",
  "The expression could not be read here": "這裡的運算式無法解讀",
  "The expression failed on a row for a reason it could not name": "運算式在某一列失敗了，卻說不出原因",
  "The expression is empty": "運算式是空的",
  "The expression module is not loaded, so this step was not run at all": "運算式模組尚未載入，因此這個步驟根本沒有執行",
  "The GeoPackage ends or breaks part-way through, so the rest cannot be read": "這個 GeoPackage 在中途結束或損毀，因此其餘部分無法讀取",
  "The list of times is not the same length as the positions, so every time after the gap would describe the wrong point": "時間清單的長度與位置數不一致，因此缺口之後的每一個時間都會指到錯誤的地點",
  "The map could not apply this colouring": "地圖無法套用這個著色",
  'The page size in this file\'s header is not one SQLite defines': "這個檔案標頭中的頁面大小不是 SQLite 所定義的值",
  "The registry that decides what counts as a number is not loaded, and this expression will not guess": "判定什麼算是數值的登錄表尚未載入，而這個運算式不會擅自推測",
  "The same code appears more than once in the table, so each match would be ambiguous — say which row to take, or make the codes unique": "同一個代碼在表格中出現不只一次，因此每次比對都會有歧義——請指定要取哪一列，或讓代碼保持唯一",
  "The Shapefile ends earlier than its own header says it should": "這個 Shapefile 比它自己的標頭所宣告的長度更早結束",
  "The shapes and the attribute rows are different in number, so the attributes would be attached to the wrong shapes": "形狀的數量與屬性資料列的數量不一致，屬性會被接到錯誤的形狀上",
  "The table brings a column the target already has — give the joined columns a prefix, or choose fewer of them": "這個表格帶來的欄位，目標中已經有了——請為結合進來的欄位加上前綴，或少選一些",
  "The time declaration does not say which column holds the time": "時間宣告沒有說明哪一個欄位存放時間",
  "The time declaration is not in a form this layer can read": "時間宣告的形式不是這個圖層能解讀的",
  "The values in that column do not all read as that type, so the declaration was refused rather than written down as a fact": "那個欄位中的值並非全部都能解讀為該型別，因此這項宣告被拒絕，而不是被當作事實記錄下來",
  "The values in that column do not read as times, so the declaration was refused rather than believed": "那個欄位中的值無法解讀為時間，因此這項宣告被拒絕，而不是照單全收",
  "There is no function by that name": "沒有這個名稱的函式",
  "There is no readable table of that name in this GeoPackage": "這個 GeoPackage 中沒有這個名稱且可讀取的資料表",
  "There is no row at that position": "那個位置上沒有資料列",
  "There is nothing left to undo": "沒有可以復原的操作了",
  "There is nothing to redo": "沒有可以重做的操作",
  "This column could not be coloured": "無法依這個欄位著色",
  "This column has no values to colour by": "這個欄位沒有可用來著色的值",
  "This dataset is the result of a step, and its values are what that step produces — edit the imported data, or make a copy to edit": "這個資料集是某個步驟的結果，它的值就是該步驟產生的內容——請編輯匯入的資料，或複製一份再編輯",
  "This GeoPackage holds nothing this map can read": "這個 GeoPackage 中沒有這張地圖能讀取的內容",
  "This GeoPackage holds several tables — say which one to read": "這個 GeoPackage 中有多個資料表——請指定要讀取哪一個",
  "This GeoPackage stores its text in an encoding this reader will not guess at": "這個 GeoPackage 以某種編碼存放文字，而這個讀取器不會擅自推測",
  "This GeoPackage uses a geometry type this reader does not draw": "這個 GeoPackage 使用了這個讀取器不會繪製的幾何類型",
  "This GeoPackage was left with a write-ahead log, and the log is not in the file — reopen and close it in the program that wrote it": "這個 GeoPackage 留有先行寫入日誌（WAL），而日誌不在檔案中——請用寫出它的程式重新開啟並關閉一次",
  "This is a SQLite database, but it holds no GeoPackage contents table": "這是一個 SQLite 資料庫，但其中沒有 GeoPackage 的內容資料表",
  "This is not a SQLite file, so it is not a GeoPackage": "這不是 SQLite 檔案，因此它不是 GeoPackage",
  "This layer holds no features to colour": "這個圖層沒有可著色的要素",
  "This turn reached its working limit, so the answer above may be incomplete — anything asked for that is not described above was not done. Ask again for the missing part on its own.": "這一輪已達到作業上限，因此上方的回答可能並不完整——凡是上方未描述到的要求，都沒有執行。請就缺少的部分單獨再問一次。",
  "Tied values merged classes": "同值過多，分級已合併",
  "Time axis": "時間軸",
  "Unit": "單位",
  ...
  "This map view could not draw those shapes — switch to the flat map and try again": "此地圖檢視無法繪製那些圖形——請切換到平面地圖後再試一次",
  "The GIS engine could not be loaded.": "無法載入 GIS 引擎。",
  "The geometry could not be computed, so this result would have been smaller than the answer": "無法計算幾何運算，因此這個結果會比真正的答案更少",
  "That spatial relation is declared but not wired to a test": "該空間關係已宣告，但尚未接上判定",   /* gis-panel.js (#R739) */

  /* ══ (#R749) the GeoTIFF / raster reader, the warp and the two-grid align — js/map-ui.js,
     js/gis-panel.js. Same wording the GIS rows above already use: 網格 for a grid, 像素 for a
     pixel, 波段 for a band, 取樣 for sampling, 座標系 for a CRS. The format words a GIS reader
     ...
     dialogue. ⚠ Each refusal NAMES what cannot be handled; none is flattened into 「無法讀取」.
     ⚠ ui.zh-hans.js is GENERATED from this file by scripts/zh-hans.mjs — never edit it by hand. */
  "Band": "波段",
  "converted from": "轉換自",
  "drawn resampled": "重新取樣後繪製",
  "Every cell of this grid holds the same value, so there is no scale to draw": "這個網格的每一格都是相同的值，因此沒有可繪製的分級尺度",
  "nearest neighbour": "最近鄰",
  "No object on the map has that id — it may already be gone": "地圖上沒有具有那個 id 的物件——它可能已經不在了",
  "Recomputed by a different version of the engine than the one that saved it, so these results can differ": "重新計算時所用的引擎版本，與當初儲存它的版本不同，因此這些結果可能有所差異",
  "Say how the grid should be resampled — an interpolation nobody named is an answer nobody made": "請指定網格要如何重新取樣——沒有人指名的內插方式，就是沒有人給出的答案",
  "Say which of the two grids the result should follow — the finer one, the coarser one, or the first": "請指定結果要依循兩個網格中的哪一個——較細的、較粗的，或是第一個",
  "Say which values are the categories — this reader will not guess them from the numbers": "請指定哪些值是類別——這個讀取器不會從數值中擅自推測",
  "Some column types or units you had declared no longer hold for this data and were not restored": "您先前宣告的部分欄位型別或單位，對這份資料已不成立，因此沒有被還原",
  "Stopped before it finished": "在完成之前就中止了",
  "That grid is not in lon/lat yet — convert it first, then put the two on one grid": "那個網格還不是經緯度——請先轉換，再把兩者放到同一個網格上",
  "That is not a way of colouring a grid": "那不是為網格著色的方式",
  "That layer is switched off, so it answered with nothing — turn it on and try again": "那個圖層未開啟，因此它什麼也沒有回答——請把它開啟後再試一次",
  "The area this grid covers could not be worked out in lon/lat — it wraps the world, or collapses to nothing": "無法以經緯度求出這個網格所涵蓋的範圍——它繞了地球一圈，或是縮成了沒有面積",
  "The coordinate-conversion library did not load, so this grid was not converted — nothing was guessed at": "座標轉換函式庫未載入，因此這個網格並未轉換——也沒有做任何推測",
  "the file states no coordinate system; read as lon/lat": "檔案沒有說明座標系，因此以經緯度讀取",
  "The grid asked for is not a grid: one of its size or spacing values is missing or not positive": "所指定的網格並不構成一個網格：它的大小或間距有一項缺漏，或不是正數",
  "The grid handed back nothing when its values were asked for": "向網格索取數值時，它什麼也沒有交回",
  "The grid module is not loaded, so this file was not read at all": "網格計算模組尚未載入，因此這個檔案根本沒有被讀取",
  "The grid was not measured, so it cannot be drawn": "這個網格尚未經過統計量測，因此無法繪製",
  "The pixel data in this TIFF does not decode — the file is damaged": "這個 TIFF 的像素資料無法解碼——檔案已經損毀",
  "These two grids do not overlap anywhere, so there is no common grid to put them on": "這兩個網格沒有任何重疊之處，因此沒有可以共同放置它們的網格",
  "This band holds categories, not measurements — interpolating them would invent categories nobody defined; use nearest": "這個波段存放的是類別而不是量測值——對它們做內插，會憑空造出沒有人定義過的類別；請改用最近鄰（nearest）",
  "This browser cannot decompress the TIFF (no DecompressionStream)": "這個瀏覽器無法解壓縮這個 TIFF（沒有 DecompressionStream）",
  "This file is a grid, and the module that reads grids did not load": "這個檔案是網格，而讀取網格的模組未載入",
  "This file is not a TIFF": "這個檔案不是 TIFF",
  "This grid could not be drawn": "無法繪製這個網格",
  ...
  "This TIFF does not say where on Earth its pixels are, so it cannot be placed on the map": "這個 TIFF 沒有說明它的像素位於地球上的何處，因此無法放到地圖上",
  "This TIFF ends part way through its pixels — the file is incomplete": "這個 TIFF 在像素讀到一半時就結束了——檔案並不完整",
  "This TIFF holds JPEG-compressed tiles, which this reader does not decode — export it uncompressed or as Deflate": "這個 TIFF 存放的是 JPEG 壓縮的圖磚，這個讀取器不會解碼——請改以無壓縮或 Deflate 匯出",
  "This TIFF is compressed in a way this reader does not decode": "這個 TIFF 的壓縮方式，是這個讀取器不會解碼的",
  "This TIFF stores its numbers in a form this reader does not read": "這個 TIFF 以這個讀取器不會讀取的形式存放數值",
  }
});
