...
window.IntMapModules.layerRegistry=function(HOST){
 const GE=()=>window.IntMapGeoEngine;   /* (#R178) the renderer, through the contract — never the raw handle */
  ...
  window.IntMapLayers=(function(){
    ...
    /* ⚠⚠ (#R572) IT READ EVERY VERTEX OF EVERY SHAPE, EVERY TIME. Five call sites share this one
    ...
    /* ⚠ A SHAPE WITH ONE UNUSABLE COORDINATE GETS NO BOX AT ALL — `{bad:1}`, and the old full walk decides.
       MEASURED by tests/r572 ① against the naive walk: a ring containing [NaN,NaN] (or [null,null], which
