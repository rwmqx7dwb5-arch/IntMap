...
window.IntMapHistScale = (function () {
  ...
  function ohmFilter(lo, hi, t) {
    return ['all',
      ...
      /* ══ ⚠⚠⚠ (#R721) A RECORD THAT STATES NO START IS NOT A RECORD OF EVERY YEAR ═══════════
  ...
  function inForce(props, lo, hi, t) {
    ...
    /* (#R721) the same start rule the expression above carries: a record states a start, or it is
