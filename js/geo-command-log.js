...
/* ⚠⚠⚠ (#R572) COUNTING AND DESCRIBING ARE TWO SWITCHES, AND ONE URL USED TO ASK FOR BOTH.
...
/* ⚠ (#R572) AND THIS ONE IS DELIBERATELY NOT CAPPED — the reason, so the next round does not add a
...
/* ⚠⚠ (#R572) THE PER-ID AND PER-PHASE TABLES HAVE A CEILING, because they had none and their keys
  ...
  return {
    ...
    read() {
      ...
      if (CMD.detail) {
        ...
        /* (#R572) what the cap cost this reading — calls that got no row of their own. Zero is the
