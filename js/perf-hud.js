 ...
 *
 *  ══ ⚠⚠⚠ (#R566) AND AN INSTRUMENT THAT COSTS WHAT IT MEASURES IS NOT AN INSTRUMENT ══════════════
...
window.IntMapPerfHud = (function () {
  ...
  /* ⚠⚠ (#R566) THE «app layers» SWITCH IS AN UNDO, AND IT USED TO BE A BLANKET SHOW. It collected
  ...
  /* ⚠ (#R566) A QUANTITY THIS INSTRUMENT COULD NOT OBTAIN IS PRINTED AS `n/a`, NEVER AS 0. The tile
  ...
  /* (#R566) what the DEM tile store is holding, published by js/app-body.js. A shell that does not
  ...
  everyTick('perf-hud:readout', 1000, () => {
    ...
    rows.textContent =
      ...
      /* (#R566) THE OTHER RETAINED THING. The renderer's tile count says nothing about the DEM tile
