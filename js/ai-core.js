...
window.IntMapModules.aiCore=function(HOST){
  ...
  /* ══ (#R348) EVERY CALL CARRIES ITS OWN ID ══════════════════════════════════════════════════
  ...
  return { _aiLangLine, _aiLangName, aiDev, aiEsc, aiFetchUsage, aiGate, aiLimitMsg, aiLoginMsg, aiParseJSON, aiReady, aiRenderSettings, aiReport, aiSaveSettings, aiSetBtnBusy, aiSyncFeatureButtons, aiToast, aiToday, aiUsesLeft, aiVisionReady, aiWaitMapIdle, askAI, askAIEnvelope, askAIJSON, askAIJSONEnvelope };   /* (#R348) askAIEnvelope was DEFINED in #R132 and never exported, so the only way an analysis could read its own meta was the global a concurrent call overwrites */
};
