 ...
 const GE=()=>window.IntMapGeoEngine;   /* (#R178) the renderer, through the contract — never the raw handle */
  ...
  return (function(){
    ...
    /* (#R349) 1815 and 1880 are new. The clock's floor moved to 1850 (js/chronos.js) and CShapes —
       ...
       (data/hist-borders.js, `hbFC` below — and #R690 widened that bundle down to 1689), so these
    ...
    /* ══ (#R518) …AND BELOW CShapes, THE SAME MACHINERY ON A SECOND RECORD ═════════════════════════
       ...
       ══ ⚠⚠⚠ (#R690) …AND THE RECORD WAS NEVER A 19th-CENTURY ONE. THE WINDOW WAS. ═════════════════
    ...
    /* ══ (#R520) 一国につき一つ — THE ERA NAMES GET THEIR OWN POINT SOURCE ══════════════════════
       ...
       gave 1850–1885 and #R690 widened to 1689–1885, is worse:
