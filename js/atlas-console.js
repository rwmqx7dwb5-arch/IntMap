  ...
  return (function(){
    ...
    async function dispatch(a,dctx){ if(!a||!a.type) return R(true,''); switch(a.type){
        ...
        case 'drawLine': case 'line': { /* (#R72) free line drawing — AI-supplied coordinates or place names */
          ...
          if(_lnSame){ _lnSame.color=col||undefined; _lnSame.w=(a.width!=null&&isFinite(+a.width))?+a.width:3; if(String(a.label||'')) _lnSame.name=String(a.label||''); }
          else _hlLines.push({geo:{type:'LineString',coordinates:pts},color:col||undefined,w:(a.width!=null&&isFinite(+a.width))?+a.width:3,name:String(a.label||'')});
