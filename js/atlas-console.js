...
window.IntMapModules.atlasConsole=function(HOST){
  ...
  return (function(){
    ...
    async function dispatch(a,dctx){ if(!a||!a.type) return R(true,''); switch(a.type){
        ...
        case 'undo': case 'undoTurn': case 'undoLast': case 'revertTurn': { const u=await ASTATE.undo((dctx&&dctx.turnId!=null)?dctx.turnId:null,{turn:(a.turn!=null&&a.turn!=='')?+a.turn:null});
