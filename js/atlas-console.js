...
window.IntMapModules.atlasConsole=function(HOST){
  ...
  return (function(){
    ...
    const OVL_OF={ highlight:'highlight', mapMetric:'choropleth', choropleth:'choropleth', poi:'poi', elevationBelow:'elevation', belowSeaLevel:'elevation', elevationHighlight:'elevation', elevationScan:'elevation',
      ...
      isochrone:'isochrone', reach:'isochrone', reachability:'isochrone', reachable:'isochrone', catchment:'isochrone', compose:'compose', mapCompose:'compose', composeMap:'compose', explainOnMap:'compose', shakemap:'shakemap', shakeMap:'shakemap', groundShaking:'shakemap', intensityMap:'shakemap', outbreaks:'outbreaks', diseaseOutbreaks:'outbreaks', outbreakLayer:'outbreaks', epidemics:'outbreaks', whoOutbreaks:'outbreaks', diseaseMap:'outbreaks' };   /* (#R511) (#R570) */
