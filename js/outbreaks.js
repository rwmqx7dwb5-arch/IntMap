/* ============================================================================
 *  IntMap · DISEASE OUTBREAKS — window.IntMapOutbreaks  (#R570)
 * ----------------------------------------------------------------------------
...
window.IntMapModules.outbreaks = function (HOST) {
  ...
  window.IntMapOutbreaks = (function () {
    ...
    /* ══ ⚠⚠⚠ (#R570) ONE SNAPSHOT, READ BY BOTH THE MAP AND THE PANEL ═════════════════════════════
       ...
       tests/r570.spec.js ①: the map carried 18 countries from the 110 m outlines while the panel's
    ...
    function collection() {
      ...
      byIso.forEach((evs, i) => {
        ...
        /* ══ ⚠⚠ (#R570) A COUNTRY THE MAP HAS NO OUTLINE FOR IS A FOURTH STATE, AND IT IS SAID ═════
    ...
    /* ── the switch ──────────────────────────────────────────────────────────────────────────────*/
    /* ══ ⚠⚠⚠ (#R570) THE OUTLINES ARRIVE OVER THE NETWORK, AND THE FIRST DRAW HAD NOT WAITED ═══════
       ...
       window buttons and a restyle. MEASURED by tests/r570.spec.js ①: 0 features with two playwright
    ...
    function toggle(v) {
      ...
      /* ⚠⚠⚠ THE BUNDLE DRAWS FIRST, AND THE TAIL ONLY EVER ADDS. The first version chained
         ...
         lands. tests/r570.spec.js ① is what caught it — the gate saw 0 features for 1.6 s. */
