...
window.IntMapRefData=(function(){
  ...
  const DATA_SOURCES=[
    ...
    /* (#R585) MEASURED RADIATION — the national gamma dose-rate networks. Attribution is a LICENCE
    ...
    /* ⚠ (#R667) AND WHERE OHM IS SILENT, THE MAP SAYS WHOSE RECORD IT USED INSTEAD. Measured
