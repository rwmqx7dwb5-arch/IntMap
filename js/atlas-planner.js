/* ============================================================================
 *  IntMap · ATLAS — the PLAN: its schema, its validation, its goal, its execution  (#R315)
 * ----------------------------------------------------------------------------
 ...
 *     finally complete. tests/r315-checks.test.mjs re-derives that byte-identity from both files.
 *
