/* ============================================================================
 *  IntMap · ATLAS — the PLAN: its schema, its validation, its goal, its execution  (#R314)
 * ----------------------------------------------------------------------------
 ...
 *     finally complete. tests/r314-checks.test.mjs re-derives that byte-identity from both files.
 *
