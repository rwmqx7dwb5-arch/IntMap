...
window.IntMapGazetteer=(function(){
  ...
  function _rowsFrom(doc){
    ...
    for(const r of (doc&&doc.rows)||[]){
      ...
      /* (#R620) v3 tail. A v2 file — a warmed cache from before the rebuild — has none of these,
      ...
      /* ⚠ (#R620) …AND FOUR MORE, APPENDED FOR THE SAME REASON THE SEVENTH AND EIGHTH WERE.
  ...
  /* ══ (#R620) TWO VIEWS OVER ONE LIST, BECAUSE THEY ARE TWO DIFFERENT QUESTIONS ════════════════
