 ...
 * ==========================================================================*/
import { makeViewGround } from './atlas-view-ground.js';   /* (#R587) the coordinate precision the zoom actually earns — see the note at the state line below */
  ...
  return (function () {
    ...
    API.renderPrompt = function (snap, opts) {
      ...
      if (cam && isFinite(cam.lat) && isFinite(cam.lng) && isFinite(cam.zoom)) {
        /* ⚠⚠⚠ (#R587) NOT toFixed(2) — AND THIS IS THE COPY THAT GOES INTO EVERY TURN. Two decimals is
      ...
      /* ⚠⚠ (#R587) same derivation as 'Map center' above, for the same reason: this line claims to state
