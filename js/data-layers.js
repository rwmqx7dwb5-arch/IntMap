    ...
    window.reorganizeLayerPanel=function(){
      ...
      try{
        ...
        const GROUPS=[
          ...
          ['lyrGrpHazard',['alerts','eq','volc2','thermal','osmemg','radobs'],3],   /* (#R578) +measured radiation — docs/RADIATION.md */   /* (#R270) +emergency response bases — see the note below */   /* (#R273) +live weather & disaster warnings — one national agency per country, GDACS removed */   /* (#R232) the flat 'night' disc row became the day/night SHADING switch */
