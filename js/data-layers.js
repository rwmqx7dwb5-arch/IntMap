...
/* (#R40) Spanish layer-group names */
    ...
    style.textContent=`
      ...
      /* ══ ⚠⚠⚠ (#R438) THE MODEL PICKER HAD NO CSS AT ALL ═══════════════════════════════════════
      ...
      /* (#R438) the isobar switch, beside the wind-particle switch it is modelled on */
      ...
      /* ⚠ (#R438) «box-sizing:border-box». MEASURED in the browser while fixing the model picker:
         ...
         control along. The whole legend is now asserted as a rectangle (tests/r438.spec.js ①),
    ...
    window.reorganizeLayerPanel=function(){
      ...
      try{
        ...
        const GROUPS=[
          ...
          /* ══ ⚠⚠ (#R438) FOUR ECMWF ROWS PROMOTED OUT OF 「その他 (beta)」 ═══════════════════════
        ...
        /* (#R438) −ec-precip −ec-dew −ec-slp (promoted to 気候・気象, see the GROUPS note) and
