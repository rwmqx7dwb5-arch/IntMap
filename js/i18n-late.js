...
export function makeI18nLate(HOST, CTX) {
  ...
  Object.assign(i18n.en,{ favLayers:"Favorite layers", uploadGeoJSON:"Upload GeoJSON", screenshotBtn:"Screenshot (hides controls, keeps legends)",
    ...
    lblDataSources:"Data & attribution", viewDataSources:"View all data sources ↗", lblScience:"Science & logic", viewScience:"How every simulation works ↗", srcModalTitle:"Data sources & attribution", srcModalSub:"IntMap aggregates the following third-party data, imagery and APIs. All trademarks belong to their owners.",
  ...
  Object.assign(i18n.jp,{ favLayers:"お気に入りレイヤー", uploadGeoJSON:"GeoJSONを読み込む", screenshotBtn:"スクリーンショット（操作ボタンを隠し凡例は残す）",
    ...
    lblDataSources:"データと出典", viewDataSources:"すべてのデータ出典を見る ↗", lblScience:"科学的根拠とロジック", viewScience:"各機能の計算方法を見る ↗", srcModalTitle:"データ出典・帰属表示", srcModalSub:"IntMapは以下の第三者のデータ・画像・APIを利用しています。各商標は権利者に帰属します。",
