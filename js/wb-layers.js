...
window.IntMapModules.wbLayers=function(map,HOST){
  ...
  (function(){
    ...
    const WB=[
      ...
      {id:'wbflfp', code:'SL.TLF.CACT.FE.ZS', n:{en:'Female labour participation %',jp:'女性労働参加率 %',de:'Frauenerwerbsquote %',ru:'Участие женщин в раб. силе %'}, ramp:[15,'#a50026',30,'#f46d43',45,'#fee08b',60,'#a6d96a',80,'#1a9850'], unit:'%'},
