  ...
  return (function () {
    ...
    function fetchModule(name) {
      switch (name) {
        ...
        case 'routeUi': return import('./routing-ui.js');   case 'photoGeo': return import('./photo-geo.js');   case 'shakeMap': return import('./shakemap.js');   case 'radiationLayer': return import('./radiation-layer.js');   /* (#R578) same line, same reason */   case 'netHealthLive': return import('./net-health-live.js');   /* (#R565) same line, same reason */   /* (#R527) same line, same reason */
    ...
    function mount(name) {
      ...
      switch (name) {
        ...
        case 'routeUi': window.IntMapRouteUI=window.IntMapModules.routeUi(IM_HOST); return true;   case 'photoGeo': window.IntMapPhotoGeo=window.IntMapModules.photoGeo(IM_HOST); return true;   case 'shakeMap': window.IntMapShakeMap=window.IntMapModules.shakeMap(IM_HOST); return true;   case 'radiationLayer': window.IntMapRadiationObs=window.IntMapModules.radiationLayer(IM_HOST); return true;   /* (#R578) */   case 'netHealthLive': window.IntMapModules.netHealthLive(IM_HOST); return true;   /* (#R565) publishes window.__imNetHealth from inside its own factory, like warLayer */   /* (#R527) */
