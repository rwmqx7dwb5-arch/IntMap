...
export function makeLazyModules(HOST) {
  return (function () {
    ...
    const PUBLISHES = {
      ...
      routingTraffic: 'IntMapRouteTraffic', newsEvents: 'IntMapNewsEvents',   /* (#R384) 出来事単位の News — News タブを開くまで 1 バイトも降ってこない（docs/NEWS-EVENTS.md §12） */
    };
