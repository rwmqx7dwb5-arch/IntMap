...
export function makeViewCapture(deps) {
  ...
  /* ══ THE FRAME LEDGER — captureFrame / urls / promptBlock / reset / SENT ═══════════════════════
    ...
    /* ── (#R589) WHAT OPENSTREETMAP SAYS IS IN THE FRAME ──────────────────────────────────────────
    ...
    async function captureFrame(a) {
      ...
      /* ⚠⚠⚠ (#R589) ASK THE MAP WHAT IS THERE — the step whose absence produced 「八田フランテ館」.
    ...
    function promptBlock() {
      ...
      take.forEach(function (fr, i) {
        var f = fr.facts, bits = [];
        /* ⚠⚠⚠ (#R589) NOT toFixed(2). Two decimals is 1.1 km square at this latitude, so at the zoom
        ...
        /* ⚠⚠⚠ (#R589) THE GROUND TRUTH FOR THIS FRAME — what the map can actually say is in it, and
