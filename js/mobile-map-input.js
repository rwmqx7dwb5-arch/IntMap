/* ============================================================================
 *  IntMap · THE MOBILE MAP INPUT SURFACE — long-press, crosshair, centre readout  (#R498)
 * ----------------------------------------------------------------------------
 *  Moved out of js/app-body.js VERBATIM, together with the two ⚠ boxes #R498 wrote into them. Not
...
window.IntMapModules.mobileMapInput=function(HOST){
  ...
  (function(){
    /* ══ ⚠⚠⚠ (#R498) getBoundingClientRect() ON EVERY SINGLE touchmove ═══════════════════════════
  ...
  /* ══ ⚠⚠⚠ (#R498) THE TWO READS INSIDE THIS FUNCTION RAN ON EVERY CAMERA FRAME ═════════════════
  ...
  /* ⚠ (#R498) SPLIT ALONG THE RUNTIME'S OWN SEAM. js/runtime.js runs every phase:'read' entry
