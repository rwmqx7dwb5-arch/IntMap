...
export function makeAtlasCapabilities(HOST) {
  return (function () {
    ...
    /* ══ index() — WHAT INTMAP CAN DO, AT THE MOMENT ATLAS DECIDES  (#R581) ══════════════════════
       ...
       MEASURED (#R581): 「エンゲルス空軍基地からナッシュビルまでICBM」 was answered with a refusal
       ...
       be wrong»), which is .agents/rules/no-ad-hoc-hardcoding.md §2.4. tests/r581-checks.test.mjs
