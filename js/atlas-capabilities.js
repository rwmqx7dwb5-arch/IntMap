...
export function makeAtlasCapabilities(HOST) {
  return (function () {
    ...
    /* ══ index() — WHAT INTMAP CAN DO, AT THE MOMENT ATLAS DECIDES  (#R577) ══════════════════════
       ...
       MEASURED (#R577): 「エンゲルス空軍基地からナッシュビルまでICBM」 was answered with a refusal
       ...
       be wrong»), which is .agents/rules/no-ad-hoc-hardcoding.md §2.4. tests/r577-checks.test.mjs
