/* ============================================================================
 *  IntMap · THE CAPABILITY REGISTRY  (#R314)   window.IntMapCapabilities
 * ----------------------------------------------------------------------------
...
export function makeAtlasCapabilities(HOST) {
  return (function () {
    ...
    var VERB_HINTS = {
      /* nine languages, one canonical category each. This is the table §16 asks for: a request in
         Korean or French reaches the same capability as the same request in English. */
