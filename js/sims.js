...
window.IntMapModules.radiation=function(HOST){
  ...
  window.IntMapRadiation=(function(){
    ...
    /* ══ (#R578) THE NUCLEAR REGISTRY — DISCOVERED, NOT TYPED ═══════════════════════════════════
    ...
    /* THE FLOOR. Observation (2026-09-09): over the 638-site registry, the twelve spellings the old
       ...
       floor. CANONICAL: this constant and tests/r578-npp-checks.test.mjs. */
    ...
    return { run, clear, isOpen, openPanel, closePanel,
      ...
      plants, nearestPlant, observedAround,   /* (#R578) the registry and the measured-radiation join; resolveSite is on the line above and is now async */
