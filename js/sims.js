...
window.IntMapModules.radiation=function(HOST){
  ...
  window.IntMapRadiation=(function(){
    ...
    /* ══ (#R585) THE NUCLEAR REGISTRY — DISCOVERED, NOT TYPED ═══════════════════════════════════
    ...
    return { run, clear, isOpen, openPanel, closePanel,
      ...
      plants, nearestPlant, observedAround,   /* (#R585) the registry and the measured-radiation join; resolveSite is on the line above and is now async */
