...
window.IntMapLegalPage = (function () {
  ...
  function render() {
    ...
    var picker = document.getElementById('pg-lang-select');   /* (#R459) named in the reader's language */
    /* ⚠ (#R459) FROM `S` ABOVE, NOT FROM `IntMapLang.t(…)`. MEASURED in the browser: this page
