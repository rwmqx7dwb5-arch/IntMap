...
window.IntMapModules.seismic=function(HOST){
  ...
  window.IntMapSeismic=(function(){
    ...
    /* (#R572) THE PIN THIS BUILD HOLDS ON THE DEM STORE. #R221 pinned into one global Set that one
    ...
    async function buildField(){
      ...
      try{
        ...
        prog(100);
      } finally { try{ HOST.releaseDEMHold(fldLease||undefined); }catch(_){} fldLease=null;   /* (#R221) the pin is for THIS build only — (#R572) and for this build ALONE */
