...
window.IntMapRouteCards = (function () {
  ...
  function note(kind, o) {
    ...
    var M = {
      ...
      /* ⚠ (#R347) §43 — a fallback that lost a capability must SAY it lost it. Without this the
         reader gets a duration that looks exactly like a traffic-aware one and is not. */
      trafficDropped: L('Traffic data was unavailable — this is the standard travel time.', '交通情報を取得できなかったため、標準の所要時間です。', 'Keine Verkehrsdaten — dies ist die Standardfahrzeit.', 'Данные о пробках недоступны — это обычное время в пути.', 'Sin datos de tráfico — este es el tiempo de viaje estándar.'),
