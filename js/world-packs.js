...
window.IntMapModules.worldPacks=function(HOST){
  ...
  window.IntMapWorld=(function(){
    ...
    function centroidOf(iso3){
      ...
      /* ⚠ (#R570) A MISS IS NOT CACHED. `hiResCountries()` swaps the collection for the detailed
    ...
    /* (#R570) …and `centroidOf`, because js/outbreaks.js anchors a WHO Disease Outbreak News item
