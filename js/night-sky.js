...
window.IntMapNightSky = (function () {
  ...
  function ensureDOM() {
    ...
    panel.innerHTML =
      ...
      + '<input class="ns-when" type="datetime-local" step="60" aria-label="' + L('Date and time', '日時') + '" style="background:#1b2233;color:#e8eef8;border:1px solid rgba(255,255,255,.18);border-radius:8px;padding:4px 6px;font:inherit;">'
      ...
      + '<select class="ns-rate" aria-label="' + L('Playback speed', '再生速度') + '" style="background:#1b2233;color:#e8eef8;border:1px solid rgba(255,255,255,.18);border-radius:8px;padding:4px 6px;font:inherit;">'
