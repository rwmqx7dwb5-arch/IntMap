...
window.IntMapModules.timeAdmin1 = function (HOST) {
  ...
  return (function () {
    ...
    function makeTier(cfg) {
      ...
      function load() {
        ...
        _P = new Promise(res => {
          ...
          /* == (#R667) THE SUBDIVISIONS UPSTREAM DOES NOT HOLD, SPLICED INTO THE SAME RECORD =======
      ...
      /* (!) (#R667) A UNIT WITH NO UPSTREAM RELATION HAS NO UPSTREAM LINE EITHER. The era line is
      ...
      function ensure() {
        try {
          ...
          /* (#R667) …and the same paint again for the units upstream does not hold, so that WHICH
    ...
    window._applyAdmin1 = function () {
      try {
        ...
        for (const t of TIERS) {
          ...
          /* (!) (#R667) NOT gated on `stand`. The tiles being alive is exactly why the bundle line is
    ...
    function note() {
      ...
      /* ⚠ (#R667) The derived provinces are COUNTED, not spelled out. data/hist-kuni.js exists
    ...
    /* ══ ⚠⚠⚠ (#R667) …AND AT THE LINE'S OWN RESOLUTION, WHICH THE BUNDLE CANNOT GIVE ═════════════
