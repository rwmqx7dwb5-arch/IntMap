...
window.IntMapRouteGeocode = (function () {
  ...
  /* ══ ⚠⚠⚠ (#R799) THIS FIELD NEVER ASKED WHETHER A ROW WAS WHAT THE READER TYPED ══════════════
  ...
  async function nominatim(q, signal, Rp) {
    ...
    /* ⚠ (#R799) `namedetails=1` costs nothing and is what lets an English query agree with a feature
  ...
  async function suggest(q, o) {
    ...
    var Rp = placeRules();   /* (#R799) started here, awaited beside the network below */
    ...
    /* (#R799) the macro-region store, on the same terms as the station registry above: local, free,
