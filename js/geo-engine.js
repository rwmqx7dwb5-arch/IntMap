...
function _m(){ return window.__imap||null; }
  ...
  return { id:'maplibre', capabilities:MAPLIBRE_CAPS,
    ...
    _hoverHub(){
      ...
      /* ══ ⚠⚠ (#R496) THE LIST OF LAYERS TO ASK IS NOT A PROPERTY OF THE POINTER EITHER ═══════════
      ...
      /* ⚠ (#R496) …AND A POINTER THAT REPORTS FASTER THAN THE DISPLAY CANNOT QUEUE MORE THAN ONE OF
