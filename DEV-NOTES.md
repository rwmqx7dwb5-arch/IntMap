...
- **Still sequenced (not this round — each is a large feature; cramming would re-introduce facades):** universal object list, multi-point route optimisation (TSP), unified disaster simulator, slope/aspect analysis, sun/shadow, RF/coverage, Earth Replay.
